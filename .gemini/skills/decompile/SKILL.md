...
No external API keys needed - Gemini does everything natively.
...
When generating C++, Gemini should follow these rules:
...
Gemini: Decompiling test_program with objdump feedback...
