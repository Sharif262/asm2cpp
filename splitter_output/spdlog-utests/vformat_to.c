               ...
               undefined8 param_6)
{
  ...
  if ((long)param_4 < 0) {
    if ((int)(uint)param_4 < 1) goto LAB_10009cf24;
    uVar1 = param_5[4];
    ...
    if ((param_4 & 0xf) == 0) goto LAB_10009cf24;
    uVar3 = *(undefined8 *)(param_5 + 2);
    uVar2 = *param_5;
  }
  local_30 = param_1;
  if (uVar1 - 1 < 0xf) {
                    /* WARNING: Could not recover jumptable at 0x00010009cd9c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&UNK_10009cda0 + (ulong)(byte)(&DAT_100106090)[uVar1 - 1] * 4))(uVar3,param_1,uVar2);
    return;
  }
LAB_10009cf24:
