/* std::shared_ptr<spdlog::async_logger>
   spdlog::async_factory_impl<(spdlog::async_overflow_policy)0>::create<spdlog::sinks::ansicolor_stdout_sink<spdlog::details::console_mutex>,
          ...
          undefined4 *param_3)
{
  ...
  if (local_68 != (registry *)0x0) goto LAB_1000937c4;
...
LAB_100093978:
    ...
    prVar1 = local_68;
    plVar4 = local_60;
    if (local_60 != (long *)0x0) goto LAB_100093978;
  }
  local_78 = local_68;
  local_70 = local_60;
...
LAB_1000937c4:
  ...
  *plVar3 = (long)&PTR____shared_ptr_emplace_10012eb38;
  ...
  local_88 = spdlog::sinks::ansicolor_sink<spdlog::details::console_mutex>::ansicolor_sink
                       (plVar3 + 3,*(undefined8 *)PTR____stdoutp_10012c5d0,*param_3);
  plVar3[3] = (long)(PTR_vtable_10012ca28 + 0x10);
  local_8c = 0;
  local_80 = plVar3;
  std::
