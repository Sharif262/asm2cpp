/* fmt::v12::detail::write<char, fmt::v12::basic_appender<char>, 0>(fmt::v12::basic_appender<char>,
   ...
   fmt::v12::detail::write_codepoint<4ul, char, fmt::v12::detail::write<char,
          ...
          (detail *this,long param_2,undefined1 param_3,ulong param_4)
{
  ...
  builtin_strncpy(local_34,"0000",4);
  lVar3 = 3;
  do {
    local_34[lVar3] = "0123456789abcdef"[param_4 & 0xf];
    lVar3 = lVar3 + -1;
    uVar4 = (uint)param_4;
