/* std::shared_ptr<spdlog::logger>
   ...
   spdlog::sinks::daily_filename_calculator>, std::string&, int, int>(std::string, std::string&,
   int&&, int&&) */

void __thiscall
spdlog::synchronous_factory::
create<spdlog::sinks::daily_file_sink<std::mutex,spdlog::sinks::daily_filename_calculator>,std::string&,int,int>
          (undefined8 *param_1,synchronous_factory *this,string *param_3,int *param_4,int *param_5)
{
  ...
  plVar4[2] = 0;
  *plVar4 = (long)&PTR____shared_ptr_emplace_10012d048;
  plVar4[1] = 0;
  std::
  allocator<spdlog::sinks::daily_file_sink<std::mutex,spdlog::sinks::daily_filename_calculator>>::
