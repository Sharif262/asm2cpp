/* Catch::Detail::unique_ptr<Catch::CumulativeReporterBase::SectionNode>*
   std::vector<Catch::Detail::unique_ptr<Catch::CumulativeReporterBase::SectionNode>,
   std::allocator<Catch::Detail::unique_ptr<Catch::CumulativeReporterBase::SectionNode> >
   >::__emplace_back_slow_path<Catch::Detail::unique_ptr<Catch::CumulativeReporterBase::SectionNode>
   >(Catch::Detail::unique_ptr<Catch::CumulativeReporterBase::SectionNode>&&) */
           ...
           *this,unique_ptr *param_1)
{
  ...
  *(undefined8 *)param_1 = 0;
  if (puVar12 == puVar2) goto LAB_1000aff9c;
...
LAB_1000aff60:
    ...
    if (uVar8 != uVar10) goto LAB_1000aff60;
  }
  do {
    if ((SectionNode *)*puVar12 != (SectionNode *)0x0) {
      pvVar4 = (void *)Catch::CumulativeReporterBase::SectionNode::~SectionNode
                                 ((SectionNode *)*puVar12);
