/* std::unique_ptr<spdlog::pattern_formatter, std::default_delete<spdlog::pattern_formatter> >
   ...
   spdlog::pattern_time_type&>(std::string&&, spdlog::pattern_time_type&) */

void __thiscall
spdlog::details::make_unique<spdlog::pattern_formatter,std::string,spdlog::pattern_time_type&>
          (details *this,string *param_1,pattern_time_type *param_2)
{
  undefined8 *puVar1;
  ...
  *(undefined8 *)(this + 0x10) = 0;
  ...
  local_80 = (void *)0x0;
  local_70 = 0x3f800000;
  pattern_formatter::pattern_formatter(ppVar2,&local_50,*(undefined4 *)param_1,&local_68,&local_90);
  *in_x8 = ppVar2;
  puVar1 = local_80;
