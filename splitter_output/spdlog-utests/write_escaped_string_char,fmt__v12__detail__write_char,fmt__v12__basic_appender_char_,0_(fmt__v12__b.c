                 ...
                 (detail *param_1,long param_2,byte *param_3,long param_4)
{
  ...
  uVar10 = _UNK_100106018;
  uVar9 = _DAT_100106010;
  uVar8 = _UNK_100106008;
  uVar7 = _DAT_100106000;
  ...
  do {
    ...
    if ((3 < uVar12) && (pbVar15 = param_3, param_3 < param_3 + (uVar12 - 3))) {
      do {
        ...
        lVar13 = (long)(char)(&DAT_100106c04)[uVar14];
        bVar2 = pbVar15[1];
        uVar3 = ((*(uint *)(&DAT_100106bb4 + lVar13 * 4) & (uint)*pbVar15) << 0x12 |
                 (bVar2 & 0x3f) << 0xc | (pbVar15[2] & 0x3f) << 6 | pbVar15[3] & 0x3f) >>
                (ulong)(*(uint *)(&DAT_100106bdc + lVar13 * 4) & 0x1f);
        uVar4 = ((pbVar15[2] >> 4 & 0xc | bVar2 >> 2 & 0x30 | (uint)(pbVar15[3] >> 6) |
                  (uint)(uVar3 < *(uint *)(&DAT_100106bc8 + lVar13 * 4)) << 6 |
                  (uint)(0x10ffff < uVar3) << 8 | (uint)((uVar3 & 0x7ffff800) == 0xd800) << 7) ^
                0x2a) >> (ulong)(*(uint *)(&DAT_100106bf0 + lVar13 * 4) & 0x1f);
        if (uVar4 != 0) {
          uVar3 = 0xffffffff;
        }
...
LAB_1000a80b8:
        ...
        if (uVar12 != uVar14) goto LAB_1000a80fc;
      }
      else {
...
LAB_1000a8418:
        ...
        if (uVar3 >> 0x10 == 0) {
          ...
          do {
            ...
            break;
            uVar22 = (ulong)((int)uVar11 + (uint)(byte)(&DAT_100106163)[lVar19 * 2]);
            if (uVar3 >> 8 == (uint)(byte)(&is_printable(unsigned_int)::singletons0)[lVar19 * 2] &&
                (byte)(&DAT_100106163)[lVar19 * 2] != 0) {
              do {
                if ((uint)(byte)(&is_printable(unsigned_int)::singletons0_lower)[uVar11] ==
                    (uVar3 & 0xff)) goto LAB_1000a8418;
                uVar11 = uVar11 + 1;
              } while (uVar11 < uVar22);
            }
            lVar19 = lVar19 + 1;
          ...
          do {
            ...
            if ((char)(&is_printable(unsigned_int)::normal0)[uVar11] < '\0') {
              uVar22 = uVar11 + 1;
              uVar21 = (uint)(byte)(&DAT_1001063d2)[uVar11] | (uVar21 & 0x7f) << 8;
            }
...
LAB_1000a83e4:
          ...
          if (uVar3 >> 0x11 == 0) {
            ...
            do {
              ...
              uVar22 = (ulong)((int)uVar11 + (uint)(byte)(&DAT_1001062d7)[lVar19 * 2]);
              if (uVar21 == (byte)(&is_printable(unsigned_int)::singletons1)[lVar19 * 2] &&
                  (byte)(&DAT_1001062d7)[lVar19 * 2] != 0) {
                do {
            ...
            do {
              ...
              if ((char)(&is_printable(unsigned_int)::normal1)[uVar11] < '\0') {
                uVar22 = uVar11 + 1;
                uVar21 = (uint)(byte)(&DAT_100106507)[uVar11] | (uVar21 & 0x7f) << 8;
              }
              uVar20 = uVar20 - uVar21;
              if ((int)uVar20 < 0) break;
              bVar5 = (bool)(bVar5 ^ 1);
          ...
          if (((uVar25 & 1) != 0) ||
             (((uVar3 - 0x2fa1e < 0x5e2 || uVar3 - 0x3134b < 0xaedb5) || 0xe01ef < uVar3) ||
              (uVar3 & 0xfffffffe) == 0x2b81e)) goto LAB_1000a8418;
        }
