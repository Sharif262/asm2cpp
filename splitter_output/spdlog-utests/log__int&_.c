...
/* void spdlog::logger::log_<int&>(spdlog::source_loc, spdlog::level::level_enum,
   fmt::v12::basic_string_view<char>, int&) */

void spdlog::logger::log_<int&>
               ...
               undefined8 param_5,uint *param_6)
{
  ...
  if (iVar3 <= (int)param_3 || iVar5 != 0) {
    ...
    local_1f0[0] = (ulong)*param_6;
    local_1f0[1] = 0;
    local_190 = auStack_170;
    fmt::v12::detail::vformat_to(&local_190,param_4,param_5,1,local_1f0,0);
