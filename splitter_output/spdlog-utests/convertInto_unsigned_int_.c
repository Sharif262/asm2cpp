/* Catch::Clara::Detail::BasicResult<Catch::Clara::ParseResultType>
   Catch::Clara::Detail::convertInto<unsigned int>(std::string const&, unsigned int&) */

void __thiscall
Catch::Clara::Detail::convertInto<unsigned_int>(Detail *this,string *param_1,uint *param_2)
{
  undefined8 uVar1;
  undefined1 uVar2;
  undefined8 *puVar3;
  ...
  std::istream::operator>>((istream *)local_170,(uint *)param_1);
