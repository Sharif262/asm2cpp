...
/* CATCH2_INTERNAL_TEST_56() */

void CATCH2_INTERNAL_TEST_56(void)
{
  size_t sVar1;
  long *plVar2;
  bool bVar3;
  ...
  spdlog::pattern_formatter::format(local_298,alStack_318,(basic_memory_buffer *)&local_168);
  ...
  bVar3 = local_160 == local_280;
  sVar1 = local_160;
  if (local_280 <= local_160) {
    sVar1 = local_280;
  }
  iVar5 = _memcmp(local_168,local_288,sVar1);
  local_388._0_2_ = CONCAT11(iVar5 == 0 && bVar3,1);
