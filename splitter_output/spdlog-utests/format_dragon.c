               ...
               (ulong *param_1,uint param_2,uint param_3,long *param_4,int *param_5)
{
  ...
  local_108 = (code *)PTR_grow_10012c7f0;
  piStack_110 = _UNK_100103428;
  local_118 = _DAT_100103420;
  local_78 = 0;
  local_1b8 = (code *)PTR_grow_10012c7f0;
  piStack_1c0 = _UNK_100103428;
  local_1c8 = _DAT_100103420;
  local_128 = 0;
  local_268 = (code *)PTR_grow_10012c7f0;
  piStack_270 = _UNK_100103428;
  local_278 = _DAT_100103420;
  local_1d8 = 0;
  local_318 = (code *)PTR_grow_10012c7f0;
  piStack_320 = _UNK_100103428;
  local_328 = _DAT_100103420;
  local_288 = 0;
  uVar89 = 1;
  if ((param_2 & 1) != 0) {
    uVar89 = 2;
...
LAB_100060bdc:
        ...
        if ((2 < uVar94) && (0x3f < (ulong)((long)local_280 - (long)local_120))) {
          ...
          if (uVar94 < 0xf) {
            ...
            if (uVar90 == uVar108) goto LAB_100060e30;
            if ((uVar90 & 0xc) == 0) {
          ...
          if (uVar90 == uVar94) goto LAB_100060e30;
        }
LAB_100060e1c:
        do {
          piVar84 = piVar113 + 1;
        ...
        local_278 = local_118;
        if (local_118 != (int *)0x0) goto LAB_100060bdc;
      }
LAB_100060e30:
      piVar97 = local_118;
      local_1d8 = local_78;
...
LAB_100060f10:
              ...
              piVar113 = local_120 + uVar94;
              if (uVar90 != uVar94) goto LAB_100060f60;
            }
            else {
              uVar108 = uVar90 & 0x7ffffffffffffff0;
              piVar98 = local_330 + 8;
...
LAB_100061010:
              ...
              if (local_328 != piVar98) goto LAB_100061010;
            }
            if ((int)uVar117 < 0) {
          ...
          local_328 = local_118;
          if (local_118 != (int *)0x0) goto LAB_100060e8c;
          local_288 = local_78;
        }
        ppiVar112 = &local_330;
        piVar97 = local_120;
      ...
      if (local_118 != (int *)0x0) {
        ...
        if (uVar94 != 0 || uVar110 != 0) {
          ...
          if (piVar98 == (int *)0x0) goto LAB_100061240;
        }
        uVar125 = 0x20 - uVar89;
...
LAB_1000611e0:
          ...
          if (local_118 != piVar113) goto LAB_1000611e0;
        }
        if (uVar83 != 0) {
          piVar98 = (int *)((long)local_118 + 1);
          piVar113 = local_118;
...
LAB_100061240:
      ...
      *local_1d0 = 1;
      ...
      if (piVar98 < (int *)0x20) {
        piVar113 = (int *)0x20;
        uVar125 = 0x20 - uVar89;
        if (piVar98 < (int *)0xf) goto LAB_10006064c;
LAB_100060a2c:
        ...
        uVar83 = auVar126._12_4_;
        if (piVar97 != piVar91) goto LAB_100060ab0;
      }
      else {
        piVar113 = piVar97;
        if (piVar97 < (int *)0x31) {
        ...
        if (piVar84 == (int *)0x0) goto LAB_100061f60;
        uVar125 = 0x20 - uVar89;
        local_120 = piVar84;
        piStack_110 = piVar113;
        if ((int *)0xe < piVar98) goto LAB_100060a2c;
LAB_10006064c:
        piVar91 = (int *)0x0;
        uVar83 = 0;
LAB_100060ab0:
      ...
      if (uVar83 != 0) {
        ...
        if (piVar113 <= piVar97) {
          ...
          if (piVar98 == (int *)0x0) goto LAB_100061f60;
...
LAB_100060c9c:
          ...
          uVar83 = auVar126._12_4_;
          if (local_1c8 != piVar98) goto LAB_100060c9c;
        }
        if (uVar83 != 0) {
          piVar97 = (int *)((long)local_1c8 + 1);
          piVar98 = local_1c8;
      ...
      *local_280 = 1;
      if (piStack_270 == (int *)0x0) {
        ...
        local_1d8 = 0;
        if ((param_2 & 1) == 0) goto LAB_100060d14;
LAB_100060d44:
        local_1d8 = 0;
        *local_330 = 2;
        ...
        local_278 = (int *)0x1;
        local_1d8 = 0;
        if ((param_2 & 1) != 0) goto LAB_100060d44;
LAB_100060d14:
        local_1d8 = 0;
        ppiVar112 = (int **)0x0;
      }
...
LAB_100060744:
        ...
        if (piVar84 != piVar95) goto LAB_100060744;
      }
      if (uVar125 != 0) {
...
LAB_100061f60:
            ...
            ___cxa_throw(uVar86,PTR_typeinfo_10012c4a0,PTR__bad_alloc_10012c438);
          }
...
LAB_1000608d4:
        ...
        uVar83 = auVar126._12_4_;
        if (local_1c8 != piVar98) goto LAB_1000608d4;
      }
      if (uVar83 != 0) {
        piVar97 = (int *)((long)local_1c8 + 1);
        piVar98 = local_1c8;
...
LAB_100061374:
      ...
      if ((int)uVar83 < iVar121) {
        ...
        do {
          ...
          if (uVar88 < uVar108) goto LAB_100061374;
          if (1 < uVar88 - uVar108) goto LAB_100061364;
          lVar102 = lVar102 + -1;
    ...
    if ((param_2 >> 2 & 1) != 0) {
      ...
      if ((-1 < iVar118) && (0x7ffffffe - iVar118 < (int)param_3)) {
        ...
        *(undefined ***)this_00 = &PTR__format_error_10012f370;
                    /* WARNING: Subroutine does not return */
        ...
        *(byte *)(lVar100 + lVar93) = bVar81 + 0x30;
        ...
        if ((int)uVar125 < iVar123) {
          ...
          do {
            ...
            uVar88 = uVar88 | uVar94;
            uVar108 = uVar108 + uVar90;
            if (uVar88 < uVar108) goto LAB_100061754;
            if (1 < uVar88 - uVar108) goto LAB_10006172c;
            lVar106 = lVar106 + -1;
            uVar94 = uVar88 - uVar108 << 0x20;
      ...
      if (iVar118 <= iVar119) {
        ...
        if ((int)uVar120 < iVar119) {
          ...
          do {
            ...
            uVar88 = uVar88 | uVar94;
            if (uVar88 < uVar108) goto LAB_100061ccc;
            if (1 < uVar88 - uVar108) goto LAB_100061d6c;
            lVar99 = lVar99 + -1;
            uVar94 = uVar88 - uVar108 << 0x20;
        ...
        if ((bVar79) || ((uVar83 & 1) == 0)) goto LAB_100061d6c;
      }
LAB_100061ccc:
      if (uVar83 == 9) {
...
LAB_100061d6c:
  ...
  if (uVar89 == 0) {
    ...
    if (iVar119 + 1 < iVar121) goto LAB_100061b10;
    if (iVar121 < iVar119) {
LAB_100061d94:
      uVar109 = 0x31;
    }
      ...
      if (iVar121 <= (int)uVar89) goto LAB_100061b10;
      uVar94 = 0;
      ...
      do {
        ...
        if ((uVar108 | uVar94) < uVar90) goto LAB_100061d94;
        if (1 < uVar88) break;
        lVar99 = lVar99 + -1;
        uVar94 = uVar88 << 0x20;
...
joined_r0x000100061ee0:
  ...
  ___stack_chk_fail();
LAB_1000619a4:
  if ((int)local_338 <= iVar118) goto LAB_100061e88;
      ...
      if (iVar118 <= iVar119) {
        ...
        if ((int)uVar89 < iVar119) {
          ...
          do {
            ...
            if (uVar108 < uVar90) goto LAB_100061e88;
            if (1 < uVar108 - uVar90) goto LAB_100061e98;
            lVar102 = lVar102 + -1;
        ...
        if ((bVar79) || ((bVar81 & 1) == 0)) goto LAB_100061e98;
      }
LAB_100061e88:
