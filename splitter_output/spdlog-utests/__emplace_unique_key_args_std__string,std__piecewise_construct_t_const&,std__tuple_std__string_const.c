...
LAB_10009bc88:
      ...
      if (uVar12 < uVar15) goto LAB_10009bc88;
    }
    uVar15 = *(ulong *)(param_1 + 8);
    ...
    lVar11 = *(long *)param_1;
    plVar14 = *(long **)(lVar11 + unaff_x26 * 8);
    if (plVar14 == (long *)0x0) goto LAB_10009bd28;
LAB_10009bbe8:
    *local_78 = *plVar14;
LAB_10009bbf0:
    *plVar14 = (long)local_78;
    ...
    lVar11 = *(long *)param_1;
    plVar14 = *(long **)(lVar11 + unaff_x26 * 8);
joined_r0x00010009bd74:
    if (plVar14 != (long *)0x0) goto LAB_10009bbe8;
LAB_10009bd28:
