  ...
  if (local_a4 - param_2 == 0 || local_a4 < param_2) {
    ...
    if ((uVar23 & 1) == 0) {
      ...
      *(undefined2 *)pcVar19 = *(undefined2 *)(&digits2(unsigned_long)::data + uVar13 * 2);
      ...
      if ((uint)param_2 < 3) goto LAB_10005d99c;
LAB_10005dad8:
      ...
      *(undefined2 *)(pcVar19 + uVar21) =
      ...
      if (uVar1 != 0 && 8 < param_2) {
        ...
        if ((uint)uVar11 < *(uint *)(&DAT_100103784 + (ulong)(0x11 - param_2) * 4)) {
          uVar18 = uVar18 & 1;
          if (uVar20 != 0 || lVar12 != 0) {
            uVar18 = 1;
          }
          if ((uVar18 & (uint)uVar11 >> 0x1f) == 0) goto LAB_10005ddcc;
        }
        goto LAB_10005dd28;
      }
      if (uVar1 != 0) goto LAB_10005d9a0;
...
LAB_10005dd90:
      ...
      *pcVar19 = (char)(uVar16 >> 0x20) + '0';
      uVar21 = 1;
      uVar15 = uVar15 + uVar11 * -10000000000;
      if (1 < (uint)param_2) goto LAB_10005dad8;
LAB_10005d99c:
      uVar20 = (uint)uVar13;
      uVar18 = (uint)uVar16;
LAB_10005d9a0:
      if ((*(uint *)(&DAT_100103784 + (8 - (long)(int)uVar23) * 4) <= uVar18) ||
         (((uVar20 | (uVar15 != 0 || lVar12 != 0)) & uVar18 >> 0x1f) != 0)) {
LAB_10005dd28:
        *(char *)(*(long *)param_5 + (ulong)(uint)param_2 + -1) =
             *(char *)(*(long *)param_5 + (ulong)(uint)param_2 + -1) + '\x01';
        if (param_2 != 1) goto LAB_10005dd50;
        uVar11 = 1;
        goto LAB_10005dd90;
      }
    }
    ...
    if (uVar11 != 0) {
      do {
        ...
        if (*(char *)(*(long *)param_5 + -1 + uVar11) != '0') {
          uVar22 = *(ulong *)(param_5 + 0x10);
          if (uVar11 <= uVar22) goto LAB_10005de48;
          (**(code **)(param_5 + 0x18))(param_5,uVar11);
          goto LAB_10005de44;
        }
        uVar11 = uVar11 - 1;
