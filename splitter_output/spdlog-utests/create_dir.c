...
LAB_1000728e0:
          ...
          for (uVar7 = uVar12 & 3; uVar7 != 0; uVar7 = uVar7 - 1) {
            if (*psVar8 == (string)0x2f) goto joined_r0x0001000728dc;
            psVar8 = psVar8 + 1;
          }
          if (uVar12 - 1 < 3) goto LAB_1000728e0;
          psVar8 = psVar8 + 3;
          while( true ) {
            if (psVar8[-3] == (string)0x2f) {
              psVar8 = psVar8 + -3;
              if (psVar8 != psVar2) goto LAB_1000728bc;
              goto LAB_1000728e0;
            }
            if (psVar8[-2] == (string)0x2f) break;
            if (psVar8[-1] == (string)0x2f) {
              psVar8 = psVar8 + -1;
              goto joined_r0x0001000728dc;
            }
            if (*psVar8 == (string)0x2f) goto joined_r0x0001000728dc;
            psVar1 = psVar8 + 1;
            psVar8 = psVar8 + 4;
            if (psVar1 == psVar2) goto LAB_1000728e0;
          }
          psVar8 = psVar8 + -2;
joined_r0x0001000728dc:
          if (psVar8 == psVar2) goto LAB_1000728e0;
LAB_1000728bc:
          uVar7 = (long)psVar8 - (long)psVar9;
          uVar12 = uVar7;
          if (uVar7 == 0xffffffffffffffff) goto LAB_1000728e0;
        }
        psVar9 = *(string **)param_1;
        if (-1 < (char)uVar5) {
          uVar6 = uVar5;
