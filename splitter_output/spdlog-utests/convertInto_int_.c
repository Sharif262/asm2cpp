/* Catch::Clara::Detail::BasicResult<Catch::Clara::ParseResultType>
   Catch::Clara::Detail::convertInto<int>(std::string const&, int&) */

void __thiscall Catch::Clara::Detail::convertInto<int>(Detail *this,string *param_1,int *param_2)
{
  undefined8 uVar1;
  undefined1 uVar2;
  undefined8 *puVar3;
  ...
  std::istream::operator>>((istream *)local_170,(int *)param_1);
