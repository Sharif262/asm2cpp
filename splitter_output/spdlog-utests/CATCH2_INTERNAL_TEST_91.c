...
/* CATCH2_INTERNAL_TEST_91() */

void CATCH2_INTERNAL_TEST_91(void)
{
  ...
  lVar8 = std::
          ...
          __emplace_unique_key_args<std::string,std::piecewise_construct_t_const&,std::tuple<std::string_const&>,std::tuple<>>
                    (this,(piecewise_construct_t *)&local_188,(tuple *)&std::piecewise_construct,
                     (tuple *)&local_2c0);
  std::string::operator=((string *)(lVar8 + 0x38),(string *)&local_210);
  if (local_1f9 < '\0') {
  ...
  fmt::v12::vformat(&local_228,"[logger-name] [info] [mdc_key_2:mdc_value_2] some message{}",0x3b,
                    0xc,&local_2c0);
  ...
  bVar5 = local_180 == uStack_220;
  sVar2 = local_180;
  if (uStack_220 <= local_180) {
    sVar2 = uStack_220;
  }
  iVar6 = _memcmp(local_188,pppppuVar1,sVar2);
  local_250._0_2_ = CONCAT11(iVar6 == 0 && bVar5,1);
  ...
  bVar5 = Catch::Section::operator_cast_to_bool((Section *)&local_2c0);
  if (bVar5) {
    pbVar7 = (byte *)(*pcVar10)(puVar4);
    if ((*pbVar7 & 1) == 0) {
      CATCH2_INTERNAL_TEST_82();
