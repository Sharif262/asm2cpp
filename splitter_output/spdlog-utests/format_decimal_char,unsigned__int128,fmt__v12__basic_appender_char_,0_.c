    ...
    *(ulong *)(this + 8) = uVar5;
    if (*(long *)this != 0) {
      ...
      if (param_3 == 0 && !CARRY8(param_3 - 1,(ulong)(99 < param_2))) {
        if (param_3 == 0 && !CARRY8(param_3 - 1,(ulong)(9 < param_2))) goto LAB_1000a1444;
      }
      else {
        do {
          uVar8 = (int)param_4 - 2;
...
LAB_1000a1444:
  ...
  if (param_3 == 0 && !CARRY8(param_3 - 1,(ulong)(99 < param_2))) {
    uVar9 = uVar8;
    if (param_3 != 0 || CARRY8(param_3 - 1,(ulong)(9 < param_2))) goto LAB_1000a13a0;
LAB_1000a13d0:
    ...
    if (auVar10._8_8_ == 0 && !CARRY8(auVar10._8_8_ - 1,(ulong)(9 < param_2))) goto LAB_1000a13d0;
LAB_1000a13a0:
