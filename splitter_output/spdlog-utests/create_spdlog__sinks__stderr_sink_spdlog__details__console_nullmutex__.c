/* std::shared_ptr<spdlog::async_logger>
   spdlog::async_factory_impl<(spdlog::async_overflow_policy)0>::create<spdlog::sinks::stderr_sink<spdlog::details::console_nullmutex>>(std::string)
    */
          ...
          (undefined8 *param_1,async_factory_impl<(spdlog::async_overflow_policy)0> *this)
{
  ...
  if (local_58 != (registry *)0x0) goto LAB_1000906f8;
...
LAB_100090888:
    ...
    prVar1 = local_58;
    plVar4 = local_50;
    if (local_50 != (long *)0x0) goto LAB_100090888;
  }
  local_68 = local_58;
  local_60 = local_50;
...
LAB_1000906f8:
  ...
  plVar3[2] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_100131450;
  plVar3[1] = 0;
  local_78 = spdlog::sinks::stderr_sink<spdlog::details::console_nullmutex>::stderr_sink();
  local_7c = 0;
  local_70 = plVar3;
  std::
  allocate_shared_abi_ne200100_<spdlog::async_logger,std::allocator<spdlog::async_logger>,std::string,std::shared_ptr<spdlog::sinks::stderr_sink<spdlog::details::console_nullmutex>>,std::shared_ptr<spdlog::details::thread_pool>,spdlog::async_overflow_policy,0>
