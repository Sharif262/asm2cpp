...
/* CATCH2_INTERNAL_TEST_32() */

void CATCH2_INTERNAL_TEST_32(void)
{
  undefined8 uVar1;
  bool bVar2;
  undefined4 local_dc;
  ...
  log_to_str<char[10],spdlog::pattern_time_type,char[2]>
            ((string *)&local_c0,(char *)&local_d8,(pattern_time_type *)"[%=8l] %v",
             (char *)&local_dc);
  bVar2 = false;
  if ((local_a9 < '\0') && (local_b8 == 0x18)) {
    bVar2 = (*local_c0 == 0x206f666e6920205b && local_c0[1] == 0x20656d6f53205d20) &&
