/* WARNING: Removing unreachable block (ram,0x00010000ed68) */
...
::delete_old_(daily_file_sink<spdlog::details::null_mutex,spdlog::sinks::daily_filename_calculator>
              *this)
{
  long lVar1;
  code *pcVar2;
  ...
  puVar4 = (undefined8 *)details::file_helper::filename((file_helper *)(this + 0x48));
  ...
  if (uVar6 != 0) {
    uVar8 = 0;
    if (uVar6 != 0) {
      uVar8 = (*(long *)(this + 0x108) + 1U) / uVar6;
    }
    lVar7 = (*(long *)(this + 0x108) + 1U) - uVar8 * uVar6;
    if (lVar7 == *(long *)(this + 0x100)) {
      puVar4 = (undefined8 *)(*(long *)(this + 0x118) + lVar7 * 0x18);
      local_50 = puVar4[2];
      uStack_58 = puVar4[1];
      ...
      *puVar4 = 0;
      ...
      uVar8 = 0;
      if (uVar6 != 0) {
        uVar8 = (*(long *)(this + 0x100) + 1U) / uVar6;
      }
      *(ulong *)(this + 0x100) = (*(long *)(this + 0x100) + 1U) - uVar8 * uVar6;
      iVar3 = details::os::remove_if_exists((string *)&local_60);
      if (iVar3 != 0) {
        details::circular_q<std::string>::push_back
                  ((circular_q<std::string> *)(this + 0xf8),(string *)&local_40);
        ...
        *puVar4 = 0;
        ...
        pcVar2 = (code *)SoftwareBreakpoint(1,0x10000edd8);
        (*pcVar2)();
      }
      if (local_50 < 0) {
    ...
    puVar4 = (undefined8 *)(*(long *)(this + 0x118) + *(long *)(this + 0x108) * 0x18);
    if (*(char *)((long)puVar4 + 0x17) < '\0') {
    ...
    *puVar4 = local_40;
    ...
    uVar6 = 0;
    if (uVar8 != 0) {
      uVar6 = (*(long *)(this + 0x108) + 1U) / uVar8;
    }
    lVar7 = (*(long *)(this + 0x108) + 1U) - uVar6 * uVar8;
