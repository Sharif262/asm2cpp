...
/* std::string log_info<int>(int const&, spdlog::level::level_enum) */

void log_info<int>(undefined8 *param_1_00,undefined8 param_1,undefined8 param_3)
{
  ...
  *(undefined1 *)(plVar6 + 0xf) = 0;
  ...
  uStack_138 = 0;
  local_130 = 0;
  spdlog::logger::log_<int&>(alStack_128,&local_140,2,"{}",2,param_1);
  std::stringbuf::str();
  std::stringbuf::str();
  if (-1 < (char)local_299) {
