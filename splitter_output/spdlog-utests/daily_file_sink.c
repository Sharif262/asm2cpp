...
daily_file_sink<spdlog::details::null_mutex,spdlog::sinks::daily_filename_calculator> * __thiscall
...
::daily_file_sink(daily_file_sink<spdlog::details::null_mutex,spdlog::sinks::daily_filename_calculator>
                  *this,undefined8 *param_2,tm *param_3,uint param_4,
                 daily_file_sink<spdlog::details::null_mutex,spdlog::sinks::daily_filename_calculator>
                 param_5,undefined2 param_6,file_event_handlers *param_7)
{
  code *pcVar1;
  undefined8 *puVar2;
  long lVar3;
  ...
  ptVar6 = param_3;
  puVar2 = (undefined8 *)spdlog::sinks::base_sink<spdlog::details::null_mutex>::base_sink();
  *puVar2 = &PTR__daily_file_sink_10012d2d8;
  uVar8 = param_2[1];
  uVar7 = *param_2;
  puVar2[6] = param_2[2];
  puVar2[5] = uVar8;
  ...
  param_2[2] = 0;
  *param_2 = 0;
  *(uint *)(puVar2 + 7) = (uint)param_3;
  *(uint *)((long)puVar2 + 0x3c) = param_4;
  puVar2[8] = 0;
  details::file_helper::file_helper((file_helper *)(puVar2 + 9),param_7);
  *(undefined8 *)(this + 0x100) = 0;
  *(undefined8 *)(this + 0xf8) = 0;
  this[0xf0] = param_5;
  *(undefined2 *)(this + 0xf2) = param_6;
  ...
  *(undefined8 *)(this + 0x128) = 0;
  if (((uint)param_3 < 0x18) && (param_4 < 0x3c)) {
    ...
    daily_filename_calculator::calc_filename
              ((daily_filename_calculator *)(this + 0x20),(string *)&local_98,ptVar6);
    details::file_helper::open((file_helper *)(this + 0x48),(string *)local_c8,(bool)this[0xf0]);
    lVar3 = std::chrono::system_clock::now();
    local_58 = lVar3;
    auVar9 = std::chrono::system_clock::to_time_t((time_point *)&local_58);
    local_60 = auVar9._0_8_;
    details::os::localtime((os *)&local_60,auVar9._8_8_);
    local_98._4_8_ = NEON_rev64(*(undefined8 *)(this + 0x38),4);
    local_98.tm_sec = 0;
  ...
  pcVar1 = (code *)SoftwareBreakpoint(1,0x10000e598);
  (*pcVar1)();
}