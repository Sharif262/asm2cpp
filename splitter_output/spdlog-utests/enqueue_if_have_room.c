/* spdlog::details::mpmc_blocking_queue<spdlog::details::async_msg>::enqueue_if_have_room(spdlog::details::async_msg&&)
    */
          ...
          (mpmc_blocking_queue<spdlog::details::async_msg> *this,async_msg *param_1)
{
  ...
  if (uVar5 != 0) {
    uVar4 = *(long *)(this + 0xb0) + 1;
    uVar2 = 0;
    if (uVar5 != 0) {
      uVar2 = uVar4 / uVar5;
    }
    if (uVar4 - uVar2 * uVar5 == *(long *)(this + 0xa8)) {
      std::mutex::unlock();
      LOAcquire();
    ...
    *(undefined8 *)(this_00 + 0x188) = uVar7;
    ...
    uVar5 = 0;
    if (uVar4 != 0) {
      uVar5 = (*(long *)(this + 0xb0) + 1U) / uVar4;
    }
    lVar3 = (*(long *)(this + 0xb0) + 1U) - uVar5 * uVar4;
