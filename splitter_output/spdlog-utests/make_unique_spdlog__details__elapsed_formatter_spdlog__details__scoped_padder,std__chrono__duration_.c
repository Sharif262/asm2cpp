/* std::unique_ptr<spdlog::details::elapsed_formatter<spdlog::details::scoped_padder,
   std::chrono::duration<long long, std::ratio<1l, 1l> > >,
   std::default_delete<spdlog::details::elapsed_formatter<spdlog::details::scoped_padder,
   std::chrono::duration<long long, std::ratio<1l, 1l> > > > >
   spdlog::details::make_unique<spdlog::details::elapsed_formatter<spdlog::details::scoped_padder,
   std::chrono::duration<long long, std::ratio<1l, 1l> > >,
