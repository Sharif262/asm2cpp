                 ...
                 (long *param_1,long *param_2,long param_3,ulong param_4)
{
  ...
  local_850 = (code *)PTR_grow_10012c7e8;
  uStack_858 = _UNK_100103418;
  local_860 = _DAT_100103410;
  local_848[0] = 0;
  plVar16 = param_1;
  ...
  while( true ) {
    ...
    if (lVar4 < 0) {
      lVar4 = param_1[1];
      plVar7 = (long *)*param_1;
      if (plVar16 == (long *)(*param_1 + lVar4)) goto LAB_10005f178;
LAB_10005f14c:
      lVar4 = *plVar16;
      ...
      plVar7 = param_1;
      if (plVar16 != (long *)((long)param_1 + lVar4)) goto LAB_10005f14c;
LAB_10005f178:
...
LAB_10005f318:
                ...
                if (uVar19 != uVar8) goto LAB_10005f2a8;
              }
              else {
                ...
                if (uVar19 != uVar8) {
                  uVar9 = uVar8;
                  if ((uVar19 & 0x38) == 0) goto LAB_10005f2a8;
                  goto LAB_10005f318;
                }
              }
              lVar4 = param_2[1];
