/* std::pair<std::__hash_iterator<std::__hash_node<std::__hash_value_type<std::string,
   std::shared_ptr<spdlog::logger> >, void*>*>, bool>
...
LAB_10007b290:
      ...
      if (uVar12 < uVar15) goto LAB_10007b290;
    }
    uVar15 = *(ulong *)(param_1 + 8);
    if ((uVar15 & uVar15 - 1) == 0) {
      unaff_x26 = uVar15 - 1 & uVar7;
      lVar11 = *(long *)param_1;
      plVar10 = *(long **)(lVar11 + unaff_x26 * 8);
      goto joined_r0x00010007b374;
    }
    if (uVar7 < uVar15) {
      lVar11 = *(long *)param_1;
      plVar10 = *(long **)(lVar11 + uVar7 * 8);
      unaff_x26 = uVar7;
      goto joined_r0x00010007b374;
    }
    uVar12 = 0;
    ...
    lVar11 = *(long *)param_1;
    plVar10 = *(long **)(lVar11 + unaff_x26 * 8);
    if (plVar10 == (long *)0x0) goto LAB_10007b32c;
LAB_10007b1f0:
    *plVar14 = *plVar10;
LAB_10007b1f8:
    *plVar10 = (long)plVar14;
    ...
    lVar11 = *(long *)param_1;
    plVar10 = *(long **)(lVar11 + unaff_x26 * 8);
joined_r0x00010007b374:
    if (plVar10 != (long *)0x0) goto LAB_10007b1f0;
LAB_10007b32c:
    *plVar14 = *(long *)psVar1;
    *(long **)psVar1 = plVar14;
    *(string **)(lVar11 + unaff_x26 * 8) = psVar1;
    if (*plVar14 != 0) {
      ...
      if ((uVar15 & uVar15 - 1) == 0) {
        plVar10 = (long *)(lVar11 + (uVar7 & uVar15 - 1) * 8);
      }
      else {
        if (uVar15 <= uVar7) {
          uVar12 = 0;
