/* std::shared_ptr<spdlog::async_logger>
   spdlog::async_factory_impl<(spdlog::async_overflow_policy)0>::create<spdlog::sinks::stdout_sink<spdlog::details::console_mutex>>(std::string)
    */
          ...
          (undefined8 *param_1,async_factory_impl<(spdlog::async_overflow_policy)0> *this)
{
  ...
  if (local_58 != (registry *)0x0) goto LAB_10008fc34;
...
LAB_10008fde0:
    ...
    prVar1 = local_58;
    plVar4 = local_50;
    if (local_50 != (long *)0x0) goto LAB_10008fde0;
  }
  local_68 = local_58;
  local_60 = local_50;
...
LAB_10008fc34:
  ...
  plVar3[2] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_100131360;
  plVar3[1] = 0;
  local_78 = spdlog::sinks::stdout_sink_base<spdlog::details::console_mutex>::stdout_sink_base
                       ((__sFILE *)(plVar3 + 3));
  plVar3[3] = (long)(PTR_vtable_10012c9c8 + 0x10);
  local_7c = 0;
  local_70 = plVar3;
  std::
  allocate_shared_abi_ne200100_<spdlog::async_logger,std::allocator<spdlog::async_logger>,std::string,std::shared_ptr<spdlog::sinks::stdout_sink<spdlog::details::console_mutex>>,std::shared_ptr<spdlog::details::thread_pool>,spdlog::async_overflow_policy,0>
