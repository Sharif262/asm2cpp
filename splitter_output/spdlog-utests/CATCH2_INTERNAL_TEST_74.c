...
/* CATCH2_INTERNAL_TEST_74() */

void CATCH2_INTERNAL_TEST_74(void)
{
  ...
  local_179 = '\x11';
  local_180 = 0x76;
  acStack_188[0] = s___n____t____u___v_100120d21[8];
  acStack_188[1] = s___n____t____u___v_100120d21[9];
  acStack_188[2] = s___n____t____u___v_100120d21[10];
  acStack_188[3] = s___n____t____u___v_100120d21[0xb];
  acStack_188[4] = s___n____t____u___v_100120d21[0xc];
  acStack_188[5] = s___n____t____u___v_100120d21[0xd];
  acStack_188[6] = s___n____t____u___v_100120d21[0xe];
  acStack_188[7] = s___n____t____u___v_100120d21[0xf];
  local_190 = (void *)s___n____t____u___v_100120d21._0_8_;
  ...
  local_250 = "\n";
  fmt::v12::vformat(&local_208,"[logger-name] [custom1] [custom2] some message{}",0x30,0xc,
                    &local_250);
