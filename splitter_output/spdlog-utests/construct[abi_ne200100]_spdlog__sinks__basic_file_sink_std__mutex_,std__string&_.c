/* void std::allocator<spdlog::sinks::basic_file_sink<std::mutex>
   >::construct[abi:ne200100]<spdlog::sinks::basic_file_sink<std::mutex>,
   std::string&>(spdlog::sinks::basic_file_sink<std::mutex>*, std::string&) */
          ...
          string *param_2)
{
  ...
  spdlog::sinks::basic_file_sink<std::mutex>::basic_file_sink
            ((string *)param_1,SUB81(param_2,0),(file_event_handlers *)0x0);
...
LAB_100008cac:
  ...
  if (local_90 == alStack_a8) {
    ...
    if (local_90 == (long *)0x0) goto LAB_100008ce4;
    lVar1 = 0x28;
  }
  (**(code **)(*local_90 + lVar1))();
LAB_100008ce4:
