...
LAB_100088e2c:
            ...
            if (uVar20 != uVar12) goto LAB_100088dbc;
          }
          else {
            ...
            if (uVar20 != uVar12) {
              uVar13 = uVar12;
              if ((uVar20 & 0x38) == 0) goto LAB_100088dbc;
              goto LAB_100088e2c;
            }
          }
          lVar5 = *(long *)(param_2 + 8);
...
LAB_100088f20:
          ...
          if (uVar20 != uVar13) goto LAB_100088f54;
        }
        else {
          uVar13 = uVar20 & 0xffffffffffffffc0;
          pcVar7 = "to_string_view(formatted) == oss.str()" + lVar4 + 0xe;
          ...
          if (uVar20 != uVar13) {
            uVar12 = uVar13;
            if ((uVar20 & 0x38) == 0) goto LAB_100088f54;
            goto LAB_100088f20;
          }
        }
        lVar5 = *(long *)(param_2 + 8);
...
LAB_100089080:
            ...
            if (uVar20 != uVar12) goto LAB_100089010;
          }
          else {
            uVar12 = uVar20 & 0xffffffffffffffc0;
            pmVar6 = pmVar19 + 0x20;
            ...
            if (uVar20 != uVar12) {
              uVar13 = uVar12;
              if ((uVar20 & 0x38) == 0) goto LAB_100089010;
              goto LAB_100089080;
            }
          }
          lVar5 = *(long *)(param_2 + 8);
...
LAB_100089178:
            ...
            if (uVar20 != uVar13) goto LAB_1000891ac;
          }
          else {
            uVar13 = uVar20 & 0xffffffffffffffc0;
            pcVar7 = "                                                                " +
            ...
            if (uVar20 != uVar13) {
              uVar12 = uVar13;
              if ((uVar20 & 0x38) == 0) goto LAB_1000891ac;
              goto LAB_100089178;
            }
          }
          lVar5 = *(long *)(param_2 + 8);
...
LAB_1000892d4:
            ...
            if (uVar20 != uVar12) goto LAB_100089264;
          }
          else {
            uVar12 = uVar20 & 0xffffffffffffffc0;
            ...
            if (uVar20 != uVar12) {
              uVar13 = uVar12;
              if ((uVar20 & 0x38) == 0) goto LAB_100089264;
              goto LAB_1000892d4;
            }
          }
          lVar5 = plVar2[1];
