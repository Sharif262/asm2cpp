/* WARNING: Removing unreachable block (ram,0x00010000ca44) */
           ...
           *this,daily_file_sink *param_1)
{
  ...
  *(undefined **)param_1 = PTR_vtable_10012ca40 + 0x10;
  std::mutex::~mutex((mutex *)(param_1 + 0x18));
  plVar2 = *(long **)(param_1 + 0x10);
  *(undefined8 *)(param_1 + 0x10) = 0;
  if (plVar2 != (long *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00010000caac. Too many branches */
