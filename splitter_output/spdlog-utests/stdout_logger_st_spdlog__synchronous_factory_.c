/* std::shared_ptr<spdlog::logger> spdlog::stdout_logger_st<spdlog::synchronous_factory>(std::string
   const&) */

void __thiscall spdlog::stdout_logger_st<spdlog::synchronous_factory>(spdlog *this,string *param_1)
{
  string *extraout_x1;
  void *local_40;
