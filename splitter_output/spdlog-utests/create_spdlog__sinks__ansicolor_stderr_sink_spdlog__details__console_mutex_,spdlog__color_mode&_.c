          ...
          undefined4 *param_3)
{
  ...
  if (local_68 != (registry *)0x0) goto LAB_100093f34;
...
LAB_1000940e8:
    ...
    prVar1 = local_68;
    plVar4 = local_60;
    if (local_60 != (long *)0x0) goto LAB_1000940e8;
  }
  local_78 = local_68;
  local_70 = local_60;
...
LAB_100093f34:
  ...
  plVar3[2] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_100131700;
  plVar3[1] = 0;
  local_88 = spdlog::sinks::ansicolor_sink<spdlog::details::console_mutex>::ansicolor_sink
                       (plVar3 + 3,*(undefined8 *)PTR____stderrp_10012c5c8,*param_3);
  plVar3[3] = (long)(PTR_vtable_10012ca18 + 0x10);
  local_8c = 0;
  local_80 = plVar3;
  std::
