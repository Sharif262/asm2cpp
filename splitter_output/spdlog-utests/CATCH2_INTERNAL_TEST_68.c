...
/* CATCH2_INTERNAL_TEST_68() */

void CATCH2_INTERNAL_TEST_68(void)
{
  size_t sVar1;
  void *pvVar2;
  undefined8 *puVar3;
  ...
  Catch::AssertionHandler::AssertionHandler
            ((AssertionHandler *)&local_328,"REQUIRE",7,&local_358,
             "to_string_view(formatted) == \"myfile.cpp:123\"",0x2d,1);
  local_368 = local_168;
  ...
  iVar6 = _memcmp(local_168,"myfile.cpp:123",sVar1);
  local_350._0_2_ = CONCAT11(iVar6 == 0 && bVar5,1);
  local_358 = &PTR_streamReconstructedExpression_10012e638;
  local_348 = &local_368;
  pcStack_340 = "==";
  local_338 = 2;
  pcStack_330 = "myfile.cpp:123";
  ...
  if (local_209 < '\0') {
    ...
    if (*(long *)PTR____stack_chk_guard_10012c5c0 != local_48) goto LAB_100025dbc;
  }
