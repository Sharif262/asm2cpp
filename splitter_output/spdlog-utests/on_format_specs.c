/* WARNING: Heritage AFTER dead removal. Example location: x0 : 0x0001000a45bc */
...
LAB_1000a49f0:
  ...
  if (0xd < uVar23 - 1) goto LAB_1000a4544;
  ...
  case 1:
    ...
    if ((int)uVar1 < 0) {
      ...
      uVar16 = (ulong)(uint)(&DAT_100106080)
  ...
  case 2:
    ...
    uVar16 = CONCAT44((&DAT_100106080)[uVar23 >> 10 & 3],uVar1);
    goto LAB_1000a49e4;
  case 3:
    if ((bStack_af >> 6 & 1) != 0) {
      local_70 = 3;
    ...
    if ((long)((ulong)uVar2 << 0x20) < 0) {
      ...
      uVar13 = (&DAT_100106080)[(ulong)(CONCAT22(uStack_ae,CONCAT11(bStack_af,local_b0)) >> 10) & 3]
      ;
    }
    goto LAB_1000a49c0;
  case 4:
    ...
    uVar13 = (&DAT_100106080)[uVar23 >> 10 & 3];
    pcVar20 = pcVar6;
LAB_1000a49c0:
  ...
  case 5:
    ...
    if ((long)pcVar22 < 0) {
      ...
      local_70 = (&DAT_100106080)[uVar23 >> 10 & 3];
      local_80 = pcVar3;
    }
    goto LAB_1000a499c;
  case 6:
...
LAB_1000a499c:
  ...
  case 7:
    ...
    uVar16 = (ulong)pdVar21 & 1 | (ulong)(uint)(&DAT_100106080)[uVar23 >> 10 & 3] << 0x20;
LAB_1000a49e4:
