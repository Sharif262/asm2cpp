...
LAB_10009d818:
          ...
          *(uint *)(param_3 + 0x10) = uVar4 + 1;
          ...
          if (dVar3 == (detail)0x7d) {
            uVar4 = *(uint *)(param_3 + 0x10);
            uVar5 = (ulong)uVar4;
            if ((int)uVar4 < 0) goto LAB_10009d818;
            *(uint *)(param_3 + 0x10) = uVar4 + 1;
            uVar6 = *(ulong *)(param_3 + 0x20);
            if ((long)uVar6 < 0) {
              if ((int)uVar6 <= (int)uVar4) goto LAB_10009d80c;
              ...
              if ((0xe < uVar4) ||
                 ...
                 (uVar6 & 0xf) == 0)) goto LAB_10009d80c;
              lVar2 = *(long *)(param_3 + 0x28) + uVar5 * 0x10;
            }
            if (uVar4 - 1 < 0xf) {
                    /* WARNING: Could not recover jumptable at 0x00010009d184. Too many branches */
                    /* WARNING: Treating indirect jump as call */
              (*(code *)(&UNK_10009cf8c +
                        (ulong)*(ushort *)(&DAT_1001060a0 + (ulong)(uVar4 - 1) * 2) * 4))
...
LAB_10009d824:
          ...
          if (*pdVar7 != (detail)0x3a) {
            if (*pdVar7 == (detail)0x7d) {
              ...
              if ((long)uVar5 < 0) {
                if ((int)uVar5 <= (int)local_a0) goto LAB_10009d80c;
                ...
                if ((0xe < local_a0) ||
                   ...
                   (uVar5 & 0xf) == 0)) goto LAB_10009d80c;
                lVar2 = *(long *)(param_3 + 0x28) + (ulong)local_a0 * 0x10;
              }
              if (uVar4 - 1 < 0xf) {
                    /* WARNING: Could not recover jumptable at 0x00010009d1d0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&UNK_10009d1d4 +
                          (ulong)*(ushort *)(&DAT_1001060be + (ulong)(uVar4 - 1) * 2) * 4))
                          (*(undefined8 *)(lVar2 + 8),*(undefined8 *)(param_3 + 0x18));
                return;
              }
              goto LAB_10009d80c;
