...
/* CATCH2_INTERNAL_TEST_62() */

void CATCH2_INTERNAL_TEST_62(void)
{
  ...
  *plVar5 = (long)&PTR____shared_ptr_emplace_10012e240;
  ...
  construct_abi_ne200100_<spdlog::pattern_formatter,char_const(&)[5],spdlog::pattern_time_type,char_const(&)[2]>
            ((allocator<spdlog::pattern_formatter> *)&local_288,this,"%D %X [%] [%n] %v",
             (pattern_time_type *)&local_168,"xxxxxx\n");
  local_298 = this;
  local_290 = plVar5;
  ...
  uStack_2b4 = 0x32;
  spdlog::details::log_msg::log_msg(alStack_318,&local_2b8,5,2,"some message",0xc);
  ...
  if (local_2a1 < '\0') {
    operator_delete((void *)CONCAT26(uStack_2b2,CONCAT24(uStack_2b4,local_2b8)));
  }
  plVar5 = local_2a0;
  local_2a0 = (long *)0x0;
  if (plVar5 != (long *)0x0) {
