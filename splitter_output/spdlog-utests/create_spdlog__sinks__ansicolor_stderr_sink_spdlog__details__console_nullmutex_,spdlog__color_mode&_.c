          ...
          undefined4 *param_3)
{
  ...
  if (local_68 != (registry *)0x0) goto LAB_1000942ec;
...
LAB_1000944a0:
    ...
    prVar1 = local_68;
    plVar4 = local_60;
    if (local_60 != (long *)0x0) goto LAB_1000944a0;
  }
  local_78 = local_68;
  local_70 = local_60;
...
LAB_1000942ec:
  ...
  plVar3[2] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_100131750;
  plVar3[1] = 0;
  ...
  plVar3[3] = (long)(PTR_vtable_10012ca20 + 0x10);
  local_8c = 0;
  local_80 = plVar3;
  std::
