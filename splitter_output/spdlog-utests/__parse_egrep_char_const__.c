/* char const* std::regex::__parse_egrep<char const*>(char const*, char const*) */

char * __thiscall std::regex::__parse_egrep<char_const*>(regex *this,char *param_1,char *param_2)
{
  char *pcVar1;
  undefined8 *puVar2;
  char *pcVar3;
  ...
  if (pcVar6 == param_1) {
    ...
    *(undefined8 **)(this + 0x38) = puVar2;
    ...
    __parse_extended_reg_exp<char_const*>(this,param_1,pcVar6);
    if (pcVar6 != param_2) {
      pcVar6 = pcVar6 + 1;
    }
  }
    ...
    do {
      ...
      if (pcVar6 == pcVar1) {
        ...
        *(undefined8 **)(this + 0x38) = puVar2;
        ...
        __parse_extended_reg_exp<char_const*>(this,pcVar1,pcVar6);
      }
