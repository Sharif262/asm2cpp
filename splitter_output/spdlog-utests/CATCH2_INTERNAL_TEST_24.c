...
void CATCH2_INTERNAL_TEST_24(void)
{
  ...
  *plVar2 = (long)&PTR____shared_ptr_emplace_10012e240;
  ...
  Catch::AssertionHandler::AssertionHandler
            (aAStack_238,"REQUIRE",7,&local_268,"msg.color_range_start == 2",0x1a,1);
  local_260._0_2_ = CONCAT11(local_1c8 == 2,1);
  ...
  local_260 = 0x9b;
  Catch::AssertionHandler::AssertionHandler
            (aAStack_238,"REQUIRE",7,&local_268,"msg.color_range_end == 0",0x18,1);
  local_260._0_2_ = CONCAT11(local_1c0 == 0,1);
  local_268 = &PTR_streamReconstructedExpression_10012cb18;
  local_258 = local_1c0;
  pcStack_250 = "==";
  local_248 = 2;
