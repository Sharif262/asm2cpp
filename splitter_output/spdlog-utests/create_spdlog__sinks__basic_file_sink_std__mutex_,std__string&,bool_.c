/* std::shared_ptr<spdlog::async_logger>
   ...
   std::string&, bool>(std::string, std::string&, bool&&) */
          ...
          string *param_3,bool *param_4)
{
  ...
  if (local_68 != (registry *)0x0) goto LAB_10006ea94;
...
LAB_10006ec3c:
    ...
    prVar1 = local_68;
    plVar4 = local_60;
    if (local_60 != (long *)0x0) goto LAB_10006ec3c;
  }
  local_78 = local_68;
  local_70 = local_60;
...
LAB_10006ea94:
  ...
  plVar3[2] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_10012ceb8;
  plVar3[1] = 0;
  ...
  construct_abi_ne200100_<spdlog::sinks::basic_file_sink<std::mutex>,std::string&,bool>
            ((allocator<spdlog::sinks::basic_file_sink<std::mutex>> *)&local_8c,
             (basic_file_sink *)(plVar3 + 3),param_3,param_4);
  local_8c = 0;
  local_88 = (basic_file_sink *)(plVar3 + 3);
  local_80 = plVar3;
  std::
