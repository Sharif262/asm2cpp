...
/* void spdlog::logger::log_<spdlog::details::dump_info<std::__wrap_iter<unsigned char const*> >
   >(spdlog::source_loc, spdlog::level::level_enum, fmt::v12::basic_string_view<char>,
   spdlog::details::dump_info<std::__wrap_iter<unsigned char const*> >&&) */

void spdlog::logger::log_<spdlog::details::dump_info<std::__wrap_iter<unsigned_char_const*>>>
               ...
               undefined8 param_5,undefined8 param_6)
{
  ...
  if (iVar3 <= (int)param_3 || iVar5 != 0) {
    ...
    puStack_1e8 = 
    PTR_format_custom<spdlog::details::dump_info<std::__wrap_iter<unsigned_char_const*>>>_10012c820;
    local_1f0 = param_6;
