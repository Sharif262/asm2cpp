...
switchD_10005d240_caseD_7:
  ...
  switch(uVar7) {
  case 1:
    if ((int)(uint)*puVar9 < 0) goto LAB_10005d2a4;
    break;
  case 2:
    break;
  case 3:
    ...
    goto joined_r0x00010005d25c;
  case 4:
    uVar10 = *puVar9;
    goto joined_r0x00010005d25c;
  case 5:
    if ((long)puVar9[1] < 0) goto LAB_10005d2a4;
  case 6:
    uVar10 = *puVar9;
    break;
  default:
    goto switchD_10005d240_caseD_7;
  }
joined_r0x00010005d25c:
  if (uVar10 >> 0x1f == 0) {
    *param_2 = (int)uVar10;
    return;
  }
