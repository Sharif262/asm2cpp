/* void std::allocator<spdlog::sinks::daily_file_sink<std::mutex, custom_daily_file_name_calculator>
   >::construct[abi:ne200100]<spdlog::sinks::daily_file_sink<std::mutex,
   custom_daily_file_name_calculator>, std::string&, int,
   int>(spdlog::sinks::daily_file_sink<std::mutex, custom_daily_file_name_calculator>*,
   std::string&, int&&, int&&) */
...
construct_abi_ne200100_<spdlog::sinks::daily_file_sink<std::mutex,custom_daily_file_name_calculator>,std::string&,int,int>
          (allocator<spdlog::sinks::daily_file_sink<std::mutex,custom_daily_file_name_calculator>>
           *this,daily_file_sink *param_1,string *param_2,int *param_3,int *param_4)
{
  ...
  local_60 = (long *)0x0;
  local_40 = (long *)0x0;
  spdlog::sinks::daily_file_sink<std::mutex,custom_daily_file_name_calculator>::daily_file_sink
            ((daily_file_sink<std::mutex,custom_daily_file_name_calculator> *)param_1,&local_d0,
             *param_3,*param_4,0,0,alStack_b8);
...
LAB_10000cdf4:
  ...
  if (local_a0 == alStack_b8) {
    ...
    if (local_a0 == (long *)0x0) goto LAB_10000ce2c;
    lVar1 = 0x28;
  }
  (**(code **)(*local_a0 + lVar1))();
LAB_10000ce2c:
