/* Catch::XmlWriter& Catch::XmlWriter::writeAttribute<Catch::Version, void>(Catch::StringRef,
   Catch::Version const&) */

XmlWriter *
Catch::XmlWriter::writeAttribute<Catch::Version,void>
          (undefined8 param_1,undefined8 param_2,undefined8 param_3,Version *param_4)
{
  undefined8 ***pppuVar1;
  XmlWriter *pXVar2;
  undefined8 **local_58;
  ...
  Catch::operator<<(local_38,param_4);
