...
LAB_1000731e8:
    ...
    if (prVar3 != this + 0x120) goto LAB_1000731f8;
LAB_10007322c:
    lVar1 = 0x20;
  }
  else {
    ...
    plVar4[1] = lVar1 + -1;
    LORelease();
    if (lVar1 != 0) goto LAB_1000731e8;
    (**(code **)(*plVar4 + 0x10))(plVar4);
    std::__shared_weak_count::__release_weak();
    prVar3 = *(registry **)(this + 0x138);
    if (prVar3 == this + 0x120) goto LAB_10007322c;
LAB_1000731f8:
    if (prVar3 == (registry *)0x0) goto LAB_10007323c;
    lVar1 = 0x28;
  }
  ...
  *(undefined8 *)(this + 0xe8) = 0;
  ...
  while (puVar5 != (undefined8 *)0x0) {
    while( true ) {
      ...
      operator_delete(puVar5);
      puVar5 = puVar6;
      if (puVar6 == (undefined8 *)0x0) goto LAB_100073308;
    }
    operator_delete((void *)puVar5[2]);
    operator_delete(puVar5);
    puVar5 = puVar6;
