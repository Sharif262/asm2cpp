...
/* CATCH2_INTERNAL_TEST_38() */

void CATCH2_INTERNAL_TEST_38(void)
{
  undefined8 uVar1;
  bool bVar2;
  long *******ppppppplVar3;
  ...
  if (local_a9 < '\0') {
    ...
    if (lStack_b8 == 0x13) goto LAB_100020744;
LAB_100020790:
    bVar2 = false;
  }
  else {
    if (local_a9 != '\x13') goto LAB_100020790;
    ppppppplVar3 = (long *******)&local_c0;
LAB_100020744:
    bVar2 = (*ppppppplVar3 == (long ******)0x6f53205d2049205b &&
  ...
  if (local_a9 < '\0') {
    ppppppplVar3 = local_c0;
    if (lStack_b8 != 0x13) goto LAB_100020914;
  }
  else {
    if (local_a9 != '\x13') {
LAB_100020914:
