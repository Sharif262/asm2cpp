...
fmt::v12::detail::utf8_to_utf16::utf8_to_utf16(utf8_to_utf16 *this,char *param_2,ulong param_3)
{
  ...
  *(undefined **)(this + 0x18) = PTR_grow_10012c7f8;
  *(utf8_to_utf16 **)this = this + 0x20;
  uVar9 = _DAT_100103400;
  *(undefined8 *)(this + 0x10) = _UNK_100103408;
  *(undefined8 *)(this + 8) = uVar9;
  pcVar1 = param_2;
  if (3 < param_3) {
    do {
      if (param_2 + (param_3 - 3) <= pcVar1) goto LAB_10009c9c4;
...
LAB_10009c9c4:
  ...
  if (param_2 == (char *)0x0) goto LAB_10009cac8;
  acStack_48[4] = '\0';
  acStack_48[5] = '\0';
  acStack_48[6] = '\0';
  acStack_48[0] = '\0';
...
LAB_10009ca48:
    ...
    if (param_2 != pcVar8) goto LAB_10009ca8c;
  }
  else {
