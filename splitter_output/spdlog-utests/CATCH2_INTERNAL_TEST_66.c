...
/* CATCH2_INTERNAL_TEST_66() */

void CATCH2_INTERNAL_TEST_66(void)
{
  size_t sVar1;
  void *pvVar2;
  undefined8 *puVar3;
  ...
  if (local_229 < '\0') {
    operator_delete((void *)CONCAT53(uStack_23d,CONCAT12(uStack_23e,local_240)));
  }
  local_150 = PTR_grow_10012c7d8;
  uStack_158 = _UNK_100100948;
  local_160 = _DAT_100100940;
  local_328 = "/a/b//myfile.cpp";
  local_320 = 0x7b;
  local_318 = "some_func()";
  ...
  Catch::AssertionHandler::AssertionHandler
            ((AssertionHandler *)&local_328,"REQUIRE",7,&local_358,
             "to_string_view(formatted) == \"myfile.cpp\"",0x29,1);
  local_368 = local_168;
  ...
  iVar6 = _memcmp(local_168,"myfile.cpp",sVar1);
  local_350._0_2_ = CONCAT11(iVar6 == 0 && bVar5,1);
  local_358 = &PTR_streamReconstructedExpression_10012e5f8;
  local_348 = &local_368;
  pcStack_340 = "==";
  local_338 = 2;
  pcStack_330 = "myfile.cpp";
  ...
  if (local_209 < '\0') {
    ...
    if (*(long *)PTR____stack_chk_guard_10012c5c0 != local_48) goto LAB_1000259a4;
  }
