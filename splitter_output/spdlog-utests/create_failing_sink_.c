/* std::shared_ptr<spdlog::async_logger>
   spdlog::async_factory_impl<(spdlog::async_overflow_policy)0>::create<failing_sink>(std::string)
    */
          ...
          (undefined8 *param_1,async_factory_impl<(spdlog::async_overflow_policy)0> *this)
{
  ...
  if (local_58 != (registry *)0x0) goto LAB_10006f374;
...
LAB_10006f530:
    ...
    prVar1 = local_58;
    plVar4 = local_50;
    if (local_50 != (long *)0x0) goto LAB_10006f530;
  }
  local_68 = local_58;
  local_60 = local_50;
...
LAB_10006f374:
  ...
  plVar3[4] = 0;
  plVar3[3] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_10012f558;
  plVar3[1] = 0;
  plVar3[6] = 0;
  plVar3[5] = 0;
  plVar3[8] = 0;
  ...
  plVar3[3] = (long)&PTR__ostream_sink_10012f5a8;
  local_7c = 0;
  local_70 = plVar3;
  std::
  allocate_shared_abi_ne200100_<spdlog::async_logger,std::allocator<spdlog::async_logger>,std::string,std::shared_ptr<failing_sink>,std::shared_ptr<spdlog::details::thread_pool>,spdlog::async_overflow_policy,0>
