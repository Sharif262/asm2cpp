          ...
          undefined4 *param_3)
{
  ...
  if (local_68 != (registry *)0x0) goto LAB_100093b7c;
...
LAB_100093d30:
    ...
    prVar1 = local_68;
    plVar4 = local_60;
    if (local_60 != (long *)0x0) goto LAB_100093d30;
  }
  local_78 = local_68;
  local_70 = local_60;
...
LAB_100093b7c:
  ...
  plVar3[2] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_1001316b0;
  plVar3[1] = 0;
  ...
  plVar3[3] = (long)(PTR_vtable_10012ca30 + 0x10);
  local_8c = 0;
  local_80 = plVar3;
  std::
