/* fmt::v12::basic_appender<char> fmt::v12::detail::write_codepoint<2ul, char,
   fmt::v12::basic_appender<char> >(fmt::v12::basic_appender<char>, char, unsigned int) */

long * fmt::v12::detail::write_codepoint<2ul,char,fmt::v12::basic_appender<char>>
                 (long *param_1,undefined1 param_2,ulong param_3)
{
  ...
  *(undefined1 *)(*param_1 + lVar1) = param_2;
  ...
  lVar1 = 1;
  do {
    local_42[lVar1] = "0123456789abcdef"[param_3 & 0xf];
    lVar1 = lVar1 + -1;
    uVar2 = (uint)param_3;
  ...
  do {
    ...
    if (uVar3 != 0) {
      _memcpy((void *)(*param_1 + lVar1),local_42 + lVar4,uVar3);
      lVar1 = param_1[1];
    }
    lVar1 = lVar1 + uVar3;
    param_1[1] = lVar1;
