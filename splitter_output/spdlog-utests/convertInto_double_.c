/* Catch::Clara::Detail::BasicResult<Catch::Clara::ParseResultType>
   Catch::Clara::Detail::convertInto<double>(std::string const&, double&) */

void __thiscall
Catch::Clara::Detail::convertInto<double>(Detail *this,string *param_1,double *param_2)
{
  undefined8 uVar1;
  undefined1 uVar2;
  undefined8 *puVar3;
  ...
  std::istream::operator>>((istream *)local_170,(double *)param_1);
