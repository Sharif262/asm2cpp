/* WARNING: Removing unreachable block (ram,0x000100023f68) */
/* WARNING: Removing unreachable block (ram,0x000100023cc0) */
/* WARNING: Removing unreachable block (ram,0x000100023cb0) */
/* WARNING: Removing unreachable block (ram,0x000100023d9c) */
/* WARNING: Removing unreachable block (ram,0x000100023fdc) */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* CATCH2_INTERNAL_TEST_54() */

void CATCH2_INTERNAL_TEST_54(void)
{
  void *pvVar1;
  undefined8 *puVar2;
  bool bVar3;
  ...
  local_99 = 9;
  local_a8 = 0x5d;
  local_b0[0] = s__v___10___100120a2e[0];
  local_b0[1] = s__v___10___100120a2e[1];
  local_b0[2] = s__v___10___100120a2e[2];
  local_b0[3] = s__v___10___100120a2e[3];
  local_b0[4] = s__v___10___100120a2e[4];
  local_b0[5] = s__v___10___100120a2e[5];
  local_b0[6] = s__v___10___100120a2e[6];
  local_b0[7] = s__v___10___100120a2e[7];
  local_b1 = 1;
  local_c8[0] = 10;
  uStack_e8 = 0;
  local_f0 = (void *)0x0;
  ...
  Catch::AssertionHandler::AssertionHandler
            ((AssertionHandler *)&local_1b8,"REQUIRE",7,&local_200,
             "test_sink.lines()[0] == \"message [      func]\"",0x2e,1);
  ...
  if (*(char *)((long)local_230 + 0x17) < '\0') {
    ...
    ppuVar5 = local_230;
    if (*(char *)((long)local_230 + 0x17) == '\x14') {
LAB_100023cdc:
      bVar3 = (*ppuVar5 == (undefined *)0x206567617373656d &&
              ppuVar5[1] == (undefined *)0x662020202020205b) && *(int *)(ppuVar5 + 2) == 0x5d636e75;
      goto LAB_100023d20;
    }
  }
  bVar3 = false;
LAB_100023d20:
  ...
  local_200 = &PTR_streamReconstructedExpression_10012e488;
  local_1f0 = local_230;
  pcStack_1e8 = "==";
  local_1e0 = 2;
  ...
  __init_with_size_abi_ne200100_<std::string_const*,std::string_const*>
            ((vector<std::string,std::allocator<std::string>> *)&local_248,local_58,local_50,
             ((long)local_50 - (long)local_58 >> 3) * -0x5555555555555555);
  local_220 = (undefined8 *)((long)local_248 + 0x18);
  if ((*(char *)((long)local_248 + 0x2f) < '\0') && (*(long *)((long)local_248 + 0x20) == 0x17)) {
    plVar6 = (long *)*local_220;
    bVar3 = (*plVar6 == 0x206567617373656d && plVar6[1] == 0x373635636e75665b) &&
            *(long *)((long)plVar6 + 0xf) == 0x5d33323130393837;
  }
  else {
    bVar3 = false;
  }
  local_228._0_2_ = CONCAT11(bVar3,1);
  local_230 = &PTR_streamReconstructedExpression_10012e4c8;
  pcStack_218 = "==";
  local_210 = 2;
  pcStack_208 = "message [func567890123]";
  Catch::AssertionHandler::handleExpr
