               ...
               (long param_1,uint *param_2,int param_3,undefined1 param_4,uint *param_5,int param_6)
{
  ...
  if (-1 < (int)uVar2) {
    ...
    uVar7 = uVar8 >> ((long)(char)(&DAT_100106bae)[(ulong)(uVar2 >> 3) & 7] & 0x3fU);
    local_60 = param_5;
  ...
  if (param_3 == 0) {
    ...
    if (local_44 != 0) goto LAB_1000a3cb4;
    uVar2 = *param_5;
    uVar5 = (ulong)uVar2;
    local_45 = (byte)(uVar2 >> 0xd) & 1;
    if ((uVar2 >> 0xd & 1) != 0) goto LAB_1000a3cc0;
    iVar6 = 1;
  }
  else {
LAB_1000a3cb4:
...
LAB_1000a3cc0:
  ...
  uVar7 = uVar8 >> ((long)(char)(&DAT_100106bae)[uVar5 >> 3 & 7] & 0x3fU);
  local_60 = param_2;
