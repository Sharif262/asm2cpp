...
/* void std::__advance[abi:ne200100]<std::__tree_const_iterator<std::__value_type<std::string,
   ...
   std::__tree_node<std::__value_type<std::string, unsigned char>, void*>*, long>
   >::difference_type, std::bidirectional_iterator_tag) */
...
void std::
     __advance_abi_ne200100_<std::__tree_const_iterator<std::__value_type<std::string,unsigned_char>,std::__tree_node<std::__value_type<std::string,unsigned_char>,void*>*,long>>
               (__tree_const_iterator<std::__value_type<std::string,unsigned_char>,std::__tree_node<std::__value_type<std::string,unsigned_char>,void*>*,long>
