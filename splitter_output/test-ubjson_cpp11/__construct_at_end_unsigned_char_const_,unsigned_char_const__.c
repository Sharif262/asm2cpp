/* void std::vector<unsigned char, std::allocator<unsigned char> >::__construct_at_end<unsigned char
   const*, unsigned char const*>(unsigned char const*, unsigned char const*, unsigned long) */
          ...
          ulong param_3)
{
  ...
  local_40 = __uninitialized_allocator_copy_abi_ne200100_<std::allocator<unsigned_char>,unsigned_char_const*,unsigned_char_const*,unsigned_char*>
