/* std::__tree_iterator<std::__value_type<std::string, unsigned char>,
   ...
   std::__tree_node<std::__value_type<std::string, unsigned char>, void*>*, long>,
   bool>::pair[abi:ne200100]<std::__tree_iterator<std::__value_type<std::string, unsigned char>,
   std::__tree_node<std::__value_type<std::string, unsigned char>, void*>*, long>, bool&, 0>(bool&)
    */
