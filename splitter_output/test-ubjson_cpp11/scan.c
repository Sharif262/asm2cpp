...
::scan(lexer<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>,nlohmann::json_abi_v3_12_0::detail::iterator_input_adapter<std::__wrap_iter<unsigned_char_const*>>>
       *this)
{
  bool bVar1;
  undefined4 uVar2;
  ...
  undefined8 uVar5;
  undefined4 local_30;
  array<unsigned_char,5ul> local_2c [4];
  char local_28;
  undefined4 local_24;
  lexer<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>,nlohmann::json_abi_v3_12_0::detail::iterator_input_adapter<std::__wrap_iter<unsigned_char_const*>>>
  *local_20;
    ...
    *(char **)(this + 0x70) = "invalid BOM; must be 0xEF 0xBB 0xBF if given";
    ...
    while( true ) {
      ...
      if (((byte)this[0x10] & 1) != 0) {
        bVar1 = *(long *)(this + 0x18) == 0x2f;
      }
      if (!bVar1) {
        switch(*(undefined8 *)(this + 0x18)) {
        default:
        ...
        case 0x5d:
          return 10;
        case 0x66:
          local_2c[0] = (array<unsigned_char,5ul>)s_false_10014a5ff[0];
          local_2c[1] = (array<unsigned_char,5ul>)s_false_10014a5ff[1];
          local_2c[2] = (array<unsigned_char,5ul>)s_false_10014a5ff[2];
          local_2c[3] = (array<unsigned_char,5ul>)s_false_10014a5ff[3];
          local_28 = s_false_10014a5ff[4];
          uVar4 = std::array<unsigned_char,5ul>::data_abi_ne200100_(local_2c);
          uVar5 = std::array<unsigned_char,5ul>::size_abi_ne200100_();
          uVar2 = nlohmann::json_abi_v3_12_0::detail::
                  lexer<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>,nlohmann::json_abi_v3_12_0::detail::iterator_input_adapter<std::__wrap_iter<unsigned_char_const*>>>
                  ::scan_literal(this,uVar4,uVar5,2);
          return uVar2;
        case 0x6e:
          local_30 = DAT_10014adac;
          uVar4 = std::array<unsigned_char,4ul>::data_abi_ne200100_
                            ((array<unsigned_char,4ul> *)&local_30);
          uVar5 = std::array<unsigned_char,4ul>::size_abi_ne200100_();
          uVar2 = nlohmann::json_abi_v3_12_0::detail::
                  lexer<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>,nlohmann::json_abi_v3_12_0::detail::iterator_input_adapter<std::__wrap_iter<unsigned_char_const*>>>
                  ::scan_literal(this,uVar4,uVar5,3);
          return uVar2;
        case 0x74:
          local_24 = DAT_10014ada8;
          uVar4 = std::array<unsigned_char,4ul>::data_abi_ne200100_
