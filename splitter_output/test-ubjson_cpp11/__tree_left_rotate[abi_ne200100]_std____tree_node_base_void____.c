...
/* void 
   std::__tree_left_rotate[abi:ne200100]<std::__tree_node_base<void*>*>(std::__tree_node_base<void*>*)
    */

void std::__tree_left_rotate_abi_ne200100_<std::__tree_node_base<void*>*>(__tree_node_base *param_1)
{
  bool bVar1;
  long lVar2;
  __tree_node_base *p_Var3;
  
  p_Var3 = *(__tree_node_base **)(param_1 + 8);
  *(undefined8 *)(param_1 + 8) = *(undefined8 *)p_Var3;
  if (*(long *)(param_1 + 8) != 0) {
    __tree_node_base<void*>::__set_parent_abi_ne200100_
              (*(__tree_node_base<void*> **)(param_1 + 8),param_1);
  }
  ...
  *(__tree_node_base **)p_Var3 = param_1;
