...
LAB_1000a74c0:
    ...
    lexer<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>,nlohmann::json_abi_v3_12_0::detail::iterator_input_adapter<std::__wrap_iter<unsigned_char_const*>>>
    ::get();
    if ((*(ulong *)(this + 0x18) < 0x30) || (0x39 < *(ulong *)(this + 0x18))) {
      if ((*(ulong *)(this + 0x18) < 0x41) || (0x46 < *(ulong *)(this + 0x18))) {
        if ((*(ulong *)(this + 0x18) < 0x61) || (0x66 < *(ulong *)(this + 0x18))) {
          local_2c = 0xffffffff;
          goto LAB_1000a74c0;
        }
        iVar2 = (int)*(undefined8 *)(this + 0x18) + -0x57 << (ulong)(uVar1 & 0x1f);
      }
      else {
        iVar2 = (int)*(undefined8 *)(this + 0x18) + -0x37 << (ulong)(uVar1 & 0x1f);
      }
    }
    else {
      iVar2 = (int)*(undefined8 *)(this + 0x18) + -0x30 << (ulong)(uVar1 & 0x1f);
    }
