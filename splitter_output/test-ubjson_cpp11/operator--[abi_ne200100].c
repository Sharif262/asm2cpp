           ...
           *this)
{
  ...
  p_Var1 = __tree_prev_iter_abi_ne200100_<std::__tree_node_base<void*>*,std::__tree_end_node<std::__tree_node_base<void*>*>*>
                     (*(__tree_end_node **)this);
  *(__tree_node_base **)this = p_Var1;
  return;
}