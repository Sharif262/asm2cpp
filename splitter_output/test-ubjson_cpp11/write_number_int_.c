/* void 
   ...
   char> >, void>, unsigned char>::write_number<int>(int, bool) */
...
::write_number<int>(binary_writer<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>,unsigned_char>
                    *this,int param_1,bool param_2)
{
  ...
  *local_18;
  ...
  local_1c = param_1;
  local_18 = this;
  piVar1 = (int *)std::array<unsigned_char,4ul>::data_abi_ne200100_
