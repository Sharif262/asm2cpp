/* nlohmann::json_abi_v3_12_0::basic_json<std::map, std::vector, std::string, bool, long long,
   ...
   void>::array(std::initializer_list<nlohmann::json_abi_v3_12_0::detail::json_ref<nlohmann::json_abi_v3_12_0::basic_json<std::map,
...
void nlohmann::json_abi_v3_12_0::
     ...
     ::array(undefined8 param_1,undefined8 param_2,undefined8 param_3)
{
  basic_json(param_1,param_2,param_3,0,2);
  return;
}