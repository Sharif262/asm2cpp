...
/* std::pair<unsigned char const*, unsigned char*>
   std::__copy_move_unwrap_iters[abi:ne200100]<std::__copy_impl, unsigned char const*, unsigned char
   const*, unsigned char*, 0>(unsigned char const*, unsigned char const*, unsigned char*) */

undefined1  [16]
std::
__copy_move_unwrap_iters_abi_ne200100_<std::__copy_impl,unsigned_char_const*,unsigned_char_const*,unsigned_char*,0>
          (uchar *param_1,uchar *param_2,uchar *param_3)
{
  ...
  local_30 = param_2;
  local_28 = param_1;
  local_48 = __unwrap_range_abi_ne200100_<unsigned_char_const*,unsigned_char_const*>
                       (param_1,param_2);
  ...
  puVar3 = (uchar *)__unwrap_iter_abi_ne200100_<unsigned_char*,std::__unwrap_iter_impl<unsigned_char*,true>,0>
                              (local_38);
  local_58 = __copy_impl::operator()[abi_ne200100_<unsigned_char_const,unsigned_char,0>
                       (&_Stack_59,puVar2,puVar4,puVar3);
  local_68 = __rewrap_range_abi_ne200100_<unsigned_char_const*,unsigned_char_const*>
