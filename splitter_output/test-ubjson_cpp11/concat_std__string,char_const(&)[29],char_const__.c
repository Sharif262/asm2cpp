/* WARNING: Removing unreachable block (ram,0x00010005b3b8) */
/* std::string nlohmann::json_abi_v3_12_0::detail::concat<std::string, char const (&) [29], char
   const*>(char const (&) [29], char const*&&) */
          ...
          (detail *this,char *param_1,char **param_2)
{
  ...
  nlohmann::json_abi_v3_12_0::detail::concat_into<std::string,char_const(&)[29],char_const*,0>
