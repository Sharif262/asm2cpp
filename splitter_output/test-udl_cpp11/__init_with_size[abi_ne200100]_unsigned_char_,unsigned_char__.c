/* void std::vector<unsigned char, std::allocator<unsigned char>
   >::__init_with_size[abi:ne200100]<unsigned char*, unsigned char*>(unsigned char*, unsigned char*,
   unsigned long) */

void __thiscall
std::vector<unsigned_char,std::allocator<unsigned_char>>::
__init_with_size_abi_ne200100_<unsigned_char*,unsigned_char*>
          ...
          ulong param_3)
{
  ...
  if (local_30 != 0) {
    ...
    std::vector<unsigned_char,std::allocator<unsigned_char>>::
    __construct_at_end<unsigned_char*,unsigned_char*>((uchar *)this,local_20,(ulong)local_28);
  }
  __exception_guard_exceptions<std::vector<unsigned_char,std::allocator<unsigned_char>>::__destroy_vector>
