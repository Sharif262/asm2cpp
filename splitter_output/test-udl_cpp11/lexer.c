/* nlohmann::json_abi_v3_12_0::detail::lexer<nlohmann::json_abi_v3_12_0::basic_json<std::map,
   ...
   >::lexer(nlohmann::json_abi_v3_12_0::detail::iterator_input_adapter<char const*>&&, bool) */
        ...
        *this,iterator_input_adapter *param_1,bool param_2)
{
  ...
  *(undefined8 *)this = uVar2;
  this[0x10] = (lexer<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>,nlohmann::json_abi_v3_12_0::detail::iterator_input_adapter<char_const*>>
                )param_2;
  uVar1 = std::char_traits<char>::eof_abi_ne200100_();
  ...
  *(undefined8 *)(this + 0x30) = 0;
  position_t::position_t((position_t *)(this + 0x20));
  std::vector<char,std::allocator<char>>::vector_abi_ne200100_
