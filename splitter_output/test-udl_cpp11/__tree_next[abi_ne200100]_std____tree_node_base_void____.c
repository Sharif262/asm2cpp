...
/* std::__tree_node_base<void*>*
   std::__tree_next[abi:ne200100]<std::__tree_node_base<void*>*>(std::__tree_node_base<void*>*) */

__tree_node_base *
std::__tree_next_abi_ne200100_<std::__tree_node_base<void*>*>(__tree_node_base *param_1)
{
  bool bVar1;
