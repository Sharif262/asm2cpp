/* WARNING: Removing unreachable block (ram,0x00010000b17c) */
     ...
     ::get_token_string(void)
{
  ...
  local_48 = (vector<char,std::allocator<char>> *)(in_x0 + 0x38);
  local_50 = std::vector<char,std::allocator<char>>::begin_abi_ne200100_(local_48);
  local_58 = std::vector<char,std::allocator<char>>::end_abi_ne200100_(local_48);
  while (bVar1 = std::operator!=[abi_ne200100_<char_const*>
                           ((__wrap_iter *)&local_50,(__wrap_iter *)&local_58), bVar1) {
    pbVar2 = (byte *)std::__wrap_iter<char_const*>::operator*[abi_ne200100_
                               ((__wrap_iter<char_const*> *)&local_50);
    if (*pbVar2 < 0x20) {
      local_28 = 0;
      local_20 = 0;
    ...
    std::__wrap_iter<char_const*>::operator++[abi_ne200100_((__wrap_iter<char_const*> *)&local_50);
  }
  local_39 = 1;
