...
::set_end(iter_impl<nlohmann::json_abi_v3_12_0::basic_json<std::map,std::vector,std::string,bool,long_long,unsigned_long_long,double,std::allocator,nlohmann::json_abi_v3_12_0::adl_serializer,std::vector<unsigned_char,std::allocator<unsigned_char>>,void>>
          *this)
{
  char cVar1;
  undefined8 uVar2;
  ...
  if (*(long *)this == 0) {
    ...
    ___assert_rtn("set_end","iter_impl.hpp",0xf3,"m_object != nullptr");
  }
  cVar1 = **(char **)this;
  if (cVar1 != '\0') {
    if (cVar1 == '\x01') {
  ...
  nlohmann::json_abi_v3_12_0::detail::primitive_iterator_t::set_end();
  return;
}