...
/* unsigned char* std::__uninitialized_allocator_copy[abi:ne200100]<std::allocator<unsigned char>,
   unsigned char*, unsigned char*, unsigned char*>(std::allocator<unsigned char>&, unsigned char*,
   unsigned char*, unsigned char*) */

uchar * std::
        __uninitialized_allocator_copy_abi_ne200100_<std::allocator<unsigned_char>,unsigned_char*,unsigned_char*,unsigned_char*>
                  (allocator *param_1,uchar *param_2,uchar *param_3,uchar *param_4)
{
  uchar *puVar1;
  undefined1 auVar2 [16];
  
  auVar2 = __unwrap_range_abi_ne200100_<unsigned_char*,unsigned_char*>(param_2,param_3);
  puVar1 = (uchar *)__unwrap_iter_abi_ne200100_<unsigned_char*,std::__unwrap_iter_impl<unsigned_char*,true>,0>
                              (param_4);
  puVar1 = __uninitialized_allocator_copy_impl_abi_ne200100_<std::allocator<unsigned_char>,unsigned_char,unsigned_char,0>
