...
/* void spdlog::logger::log_<char const (&) [6], char const (&) [5]>(spdlog::source_loc,
   spdlog::level::level_enum, fmt::v12::basic_string_view<char>, char const (&) [6], char const (&)
   [5]) */

void spdlog::logger::log_<char_const(&)[6],char_const(&)[5]>
               ...
               undefined8 param_5,undefined8 param_6,undefined8 param_7)
{
  ...
  if (iVar3 <= (int)param_3 || iVar5 != 0) {
    ...
    fmt::v12::detail::vformat_to(&local_190,param_4,param_5,0xcc,local_1f0,0);
