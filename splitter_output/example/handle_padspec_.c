...
undefined1  [16] spdlog::pattern_formatter::handle_padspec_(long *param_1,byte *param_2)
{
  ...
  pbVar5 = (byte *)*param_1;
  if (pbVar5 == param_2) goto LAB_10001d0f4;
  uVar3 = 0x10000000001;
  if (*pbVar5 == 0x2d) {
LAB_10001d0bc:
    pbVar5 = pbVar5 + 1;
    *param_1 = (long)pbVar5;
    puVar2 = PTR___DefaultRuneLocale_1000582f0;
  }
  else {
    if (*pbVar5 == 0x3d) {
      uVar3 = 0x10000000002;
  ...
  PTR___DefaultRuneLocale_1000582f0 = puVar2;
    ...
    if (pbVar1 != param_2) {
      ...
      if ((*(uint *)(puVar2 + uVar6 * 4 + 0x3c) >> 10 & 1) != 0) {
        ...
        do {
          ...
          *param_1 = (long)pbVar5;
          if (pbVar5 == param_2) goto LAB_10001d184;
          uVar6 = (ulong)*pbVar5;
          pbVar1 = pbVar5 + 1;
