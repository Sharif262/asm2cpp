...
LAB_1000217f4:
      ...
      if (uVar12 < uVar15) goto LAB_1000217f4;
    }
    uVar15 = *(ulong *)(param_1 + 8);
    ...
    lVar11 = *(long *)param_1;
    plVar10 = *(long **)(lVar11 + unaff_x26 * 8);
    if (plVar10 == (long *)0x0) goto LAB_100021890;
LAB_100021754:
    *plVar14 = *plVar10;
LAB_10002175c:
    *plVar10 = (long)plVar14;
    ...
    lVar11 = *(long *)param_1;
    plVar10 = *(long **)(lVar11 + unaff_x26 * 8);
joined_r0x0001000218d8:
    if (plVar10 != (long *)0x0) goto LAB_100021754;
LAB_100021890:
    *plVar14 = *(long *)psVar1;
    *(long **)psVar1 = plVar14;
