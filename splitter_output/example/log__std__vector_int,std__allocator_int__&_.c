...
/* void spdlog::logger::log_<std::vector<int, std::allocator<int> >&>(spdlog::source_loc,
   spdlog::level::level_enum, fmt::v12::basic_string_view<char>, std::vector<int,
   std::allocator<int> >&) */

void spdlog::logger::log_<std::vector<int,std::allocator<int>>&>
               ...
               undefined8 param_5,undefined8 param_6)
{
  ...
  if (iVar3 <= (int)param_3 || iVar5 != 0) {
    ...
    puStack_1e8 = PTR_format_custom<std::vector<int,std::allocator<int>>>_100058578;
    local_1f0 = param_6;
