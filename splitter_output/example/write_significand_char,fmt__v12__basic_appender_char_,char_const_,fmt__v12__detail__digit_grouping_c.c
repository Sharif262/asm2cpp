...
LAB_100013160:
            ...
            if (uVar1 != uVar13) goto LAB_1000130f0;
          }
          else {
            ...
            if (uVar1 != uVar13) {
              uVar2 = uVar13;
              if ((uVar1 & 0x38) == 0) goto LAB_1000130f0;
              goto LAB_100013160;
            }
          }
          lVar9 = param_1[1];
    ...
    local_258 = (code *)PTR_grow_100058500;
    uStack_260 = _UNK_10004c8a8;
    local_268 = _DAT_10004c8a0;
    uVar1 = 0;
        ...
        if (uVar13 != 0) {
          ...
          if ((uVar13 < 8) || (local_270 + (uVar1 - param_2) < (undefined1 *)0x40)) {
            ...
            if (uVar13 < 0x40) {
              ...
              if (uVar13 == uVar5) goto LAB_100012ee8;
              uVar6 = uVar5;
              if ((uVar13 & 0x38) == 0) goto LAB_100012f54;
            }
