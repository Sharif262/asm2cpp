...
/* fmt::v12::detail::do_report_error(void (*)(fmt::v12::detail::buffer<char>&, int, char const*),
   int, char const*) */

void fmt::v12::detail::do_report_error
               (_func_void_buffer_ptr_int_char_ptr *param_1,int param_2,char *param_3)
{
  ...
  (*param_1)((buffer *)&local_250,param_2,param_3);
