...
/* void spdlog::logger::log_<int, int, int>(spdlog::source_loc, spdlog::level::level_enum,
   fmt::v12::basic_string_view<char>, int&&, int&&, int&&) */

void spdlog::logger::log_<int,int,int>
               ...
               undefined8 param_5,undefined4 *param_6,undefined4 *param_7,undefined4 *param_8)
{
  ...
  if (iVar3 <= (int)param_3 || iVar5 != 0) {
    ...
    fmt::v12::detail::vformat_to(&local_190,param_4,param_5,0x111,local_1f0,0);
