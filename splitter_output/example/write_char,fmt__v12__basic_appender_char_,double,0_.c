...
/* fmt::v12::basic_appender<char> fmt::v12::detail::write<char, fmt::v12::basic_appender<char>,
   double, 0>(fmt::v12::basic_appender<char>, double, fmt::v12::format_specs, fmt::v12::locale_ref)
    */

detail * __thiscall
fmt::v12::detail::write<char,fmt::v12::basic_appender<char>,double,0>
          (double param_1,detail *this,detail *param_3,long param_4,undefined8 param_5)
{
  ...
  if (((uint)param_3 >> 0xe & 1) != 0) {
    ...
    if ((uVar6 & 1) != 0) goto LAB_10000cce0;
...
LAB_10000cc8c:
    ...
    if (uVar1 == 2) goto joined_r0x00010000cc74;
    if (uVar1 != 4) {
      if (uVar10 < 2) {
        uVar10 = 1;
      }
