...
/* fmt::v12::basic_appender<char> fmt::v12::detail::write_significand<char,
   fmt::v12::basic_appender<char>, unsigned long long, fmt::v12::detail::digit_grouping<char>
   >(fmt::v12::basic_appender<char>, unsigned long long, int, int,
   fmt::v12::detail::digit_grouping<char> const&) */

long * fmt::v12::detail::
       write_significand<char,fmt::v12::basic_appender<char>,unsigned_long_long,fmt::v12::detail::digit_grouping<char>>
                 (undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4,long param_5)
{
  ...
  if (uVar2 == 0) {
    plVar1 = (long *)format_decimal<char,unsigned_long_long,fmt::v12::basic_appender<char>,0>
                               (param_1);
    if (0 < param_4) {
      do {
        lVar3 = plVar1[1];
    ...
    local_248 = (code *)PTR_grow_100058500;
    uStack_250 = _UNK_10004c8a8;
    local_258 = _DAT_10004c8a0;
    local_260 = auStack_240;
    format_decimal<char,unsigned_long_long,fmt::v12::basic_appender<char>,0>(&local_260);
    if (0 < param_4) {
      do {
        uVar2 = local_258 + 1;
        if (uStack_250 < uVar2) {
