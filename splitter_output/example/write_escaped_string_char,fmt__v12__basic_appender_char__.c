          ...
          (detail *this,byte *param_2,long param_3)
{
  ...
  *(undefined1 *)(*(long *)this + lVar11) = 0x22;
  uVar9 = _UNK_10004f6a8;
  uVar8 = _DAT_10004f6a0;
  uVar7 = _UNK_10004f698;
  uVar6 = _DAT_10004f690;
  ...
  do {
    ...
    if ((3 < uVar12) && (param_2 < param_2 + (uVar12 - 3))) {
      do {
        ...
        lVar11 = (long)(char)(&DAT_1000502c4)[uVar13];
        bVar2 = pbVar23[1];
        uVar3 = ((*(uint *)(&DAT_100050274 + lVar11 * 4) & (uint)*pbVar23) << 0x12 |
                 (bVar2 & 0x3f) << 0xc | (pbVar23[2] & 0x3f) << 6 | pbVar23[3] & 0x3f) >>
                (ulong)(*(uint *)(&DAT_10005029c + lVar11 * 4) & 0x1f);
        uVar4 = ((pbVar23[2] >> 4 & 0xc | bVar2 >> 2 & 0x30 | (uint)(pbVar23[3] >> 6) |
                  (uint)(uVar3 < *(uint *)(&DAT_100050288 + lVar11 * 4)) << 6 |
                  (uint)(0x10ffff < uVar3) << 8 | (uint)((uVar3 & 0x7ffff800) == 0xd800) << 7) ^
                0x2a) >> (ulong)(*(uint *)(&DAT_1000502b0 + lVar11 * 4) & 0x1f);
        if (uVar4 != 0) {
          uVar3 = 0xffffffff;
        }
...
LAB_100049f94:
        ...
        if (uVar12 != uVar13) goto LAB_100049fd8;
      }
      else {
      ...
      do {
        ...
        lVar11 = (long)(char)(&DAT_1000502c4)[uVar13];
        bVar2 = pbVar22[1];
        uVar3 = ((*(uint *)(&DAT_100050274 + lVar11 * 4) & (uint)*pbVar22) << 0x12 |
...
LAB_10004a2e4:
        ...
        if (uVar3 >> 0x10 == 0) {
          ...
          do {
            ...
            break;
            uVar21 = (ulong)((int)uVar10 + (uint)(byte)(&DAT_10004f7e3)[lVar18 * 2]);
            if (uVar3 >> 8 == (uint)(byte)(&is_printable(unsigned_int)::singletons0)[lVar18 * 2] &&
                (byte)(&DAT_10004f7e3)[lVar18 * 2] != 0) {
              do {
                if ((uint)(byte)(&is_printable(unsigned_int)::singletons0_lower)[uVar10] ==
                    (uVar3 & 0xff)) goto LAB_10004a2e4;
                uVar10 = uVar10 + 1;
              } while (uVar10 < uVar21);
            }
            lVar18 = lVar18 + 1;
          ...
          do {
            ...
            if ((char)(&is_printable(unsigned_int)::normal0)[uVar10] < '\0') {
              uVar21 = uVar10 + 1;
              uVar20 = (uint)(byte)(&DAT_10004fa52)[uVar10] | (uVar20 & 0x7f) << 8;
            }
...
LAB_10004a2b8:
          ...
          if (uVar3 >> 0x11 == 0) {
            ...
            do {
              ...
              uVar21 = (ulong)((int)uVar10 + (uint)(byte)(&DAT_10004f957)[lVar18 * 2]);
              if (uVar20 == (byte)(&is_printable(unsigned_int)::singletons1)[lVar18 * 2] &&
                  (byte)(&DAT_10004f957)[lVar18 * 2] != 0) {
                do {
            ...
            do {
              ...
              if ((char)(&is_printable(unsigned_int)::normal1)[uVar10] < '\0') {
                uVar21 = uVar10 + 1;
                uVar20 = (uint)(byte)(&DAT_10004fb87)[uVar10] | (uVar20 & 0x7f) << 8;
              }
              uVar19 = uVar19 - uVar20;
              if ((int)uVar19 < 0) break;
              bVar5 = (bool)(bVar5 ^ 1);
          ...
          if (((uVar24 & 1) != 0) ||
             (((uVar3 - 0x2fa1e < 0x5e2 || uVar3 - 0x3134b < 0xaedb5) || 0xe01ef < uVar3) ||
              (uVar3 & 0xfffffffe) == 0x2b81e)) goto LAB_10004a2e4;
        }
...
LAB_10004a3ec:
            ...
            if (uVar12 != uVar13) goto LAB_10004a37c;
          }
          else {
            ...
            if (uVar12 != uVar13) {
              uVar10 = uVar13;
              if ((uVar12 & 0x38) == 0) goto LAB_10004a37c;
              goto LAB_10004a3ec;
            }
          }
          lVar11 = *(long *)(this + 8);
