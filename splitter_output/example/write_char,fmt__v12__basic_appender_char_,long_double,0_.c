...
/* fmt::v12::basic_appender<char> fmt::v12::detail::write<char, fmt::v12::basic_appender<char>, long
   double, 0>(fmt::v12::basic_appender<char>, long double, fmt::v12::format_specs,
   fmt::v12::locale_ref) */

detail * __thiscall
fmt::v12::detail::write<char,fmt::v12::basic_appender<char>,long_double,0>
          (double param_1,detail *this,detail *param_3,long param_4,undefined8 param_5)
{
  uint uVar1;
  undefined8 uVar2;
  char *pcVar3;
  ...
  if (((uint)param_3 >> 0xe & 1) != 0) {
    local_260 = CONCAT44(local_260._4_4_,0xb);
    local_270 = (undefined1  [8])param_1;
    uVar6 = write_loc(this,local_270,&local_290,param_5);
    if ((uVar6 & 1) != 0) goto LAB_1000499c0;
  ...
  if (0x7fefffffffffffff < (ulong)ABS(param_1)) {
    pcStack_268 = (char *)uStack_288;
    local_270 = (undefined1  [8])local_290;
    if ((((ulong)local_290 & 0xff00000000) == 0x3000000000) &&
       (((uint)local_290 & 0x38000) == 0x8000)) {
      local_270._5_3_ = (undefined3)((ulong)local_290 >> 0x28);
      local_270._0_5_ = 0x2000000000;
      local_270._0_4_ = (uint)local_290;
    }
  ...
  if ((((uint)param_3 & 0x38) == 0x20) && (uVar9 != 0)) {
    ...
    *(char *)(*(long *)this + lVar8) = (char)(0x202b2d00 >> (ulong)(uVar9 << 3));
    if ((int)uStack_288 != 0) {
      uVar9 = 0;
      uStack_288 = CONCAT44(uStack_288._4_4_,(int)uStack_288 + -1);
      goto LAB_10004987c;
    }
    uVar9 = 0;
...
LAB_10004987c:
  ...
  if (uStack_288 < 0) {
    ...
    if (((ulong)local_290 & 7) == 0) {
      _local_270 = fmt::v12::detail::dragonbox::to_decimal<double>(param_1);
      this = (detail *)
             do_write_float<char,fmt::v12::detail::digit_grouping<char>,fmt::v12::basic_appender<char>,fmt::v12::detail::dragonbox::decimal_fp<double>>
                       (this,local_270,&local_290,uVar9,0x10,param_5);
      goto LAB_1000499c0;
    }
    uVar10 = 6;
  }
  uVar1 = uVar7 & 7;
  pcStack_268 = _DAT_10004c8a0;
  local_270 = (undefined1  [8])local_250;
  local_260 = _UNK_10004c8a8;
  local_258 = PTR_grow_100058500;
  if (uVar1 == 1) {
...
LAB_10004996c:
    iVar5 = format_float<double>
                      (param_1,uVar10,(format_specs *)&local_290,false,(buffer *)local_270);
    uStack_288 = CONCAT44(uVar10,(int)uStack_288);
    local_280 = (detail *)local_270;
    ...
    this = (detail *)
           do_write_float<char,fmt::v12::detail::digit_grouping<char>,fmt::v12::basic_appender<char>,fmt::v12::detail::big_decimal_fp>
                     (this,&local_280,&local_290,uVar9,0x10,param_5);
  }
  else {
    if (uVar1 == 2) goto joined_r0x000100049954;
    if (uVar1 != 4) {
      if (uVar10 < 2) {
        uVar10 = 1;
      }
  ...
  if (local_270 != (undefined1  [8])local_250) {
    _free((void *)local_270);
  }
LAB_1000499c0:
