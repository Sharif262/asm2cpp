...
/* void spdlog::logger::log_<my_type>(spdlog::source_loc, spdlog::level::level_enum,
   fmt::v12::basic_string_view<char>, my_type&&) */

void spdlog::logger::log_<my_type>
               ...
               undefined8 param_5,undefined8 param_6)
{
  ...
  if (iVar3 <= (int)param_3 || iVar5 != 0) {
    ...
    puStack_1e8 = PTR_format_custom<my_type>_100058558;
    local_1f0 = param_6;
