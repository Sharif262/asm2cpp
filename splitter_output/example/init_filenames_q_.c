/* WARNING: Removing unreachable block (ram,0x000100007a80) */
/* WARNING: Removing unreachable block (ram,0x000100007c78) */
/* spdlog::sinks::daily_file_sink<std::mutex,
   spdlog::sinks::daily_filename_calculator>::init_filenames_q_() */

void spdlog::sinks::daily_file_sink<std::mutex,spdlog::sinks::daily_filename_calculator>::
     init_filenames_q_(void)
{
  ...
  lVar6 = (ulong)*(ushort *)(in_x0 + 0x12a) + 1;
  ...
  *(void **)(in_x0 + 0x150) = pvVar5;
  *(long *)(in_x0 + 0x158) = local_60;
  *(void **)(in_x0 + 0x160) = pvVar11;
  local_a0 = (string *)0x0;
  local_98 = (string *)0x0;
  local_90 = (string *)0x0;
  ...
  do {
    while( true ) {
      if ((ulong)*(ushort *)(in_x0 + 0x12a) <=
          (ulong)(((long)local_98 - (long)local_a0 >> 3) * -0x5555555555555555)) goto LAB_100007ba4;
      local_48 = lVar6;
      ...
      daily_filename_calculator::calc_filename
                ((daily_filename_calculator *)(in_x0 + 0x58),(string *)local_88,in_x2);
      ...
      if ((uVar7 & 1) == 0) goto LAB_100007ba4;
    }
    operator_delete(local_b8);
  } while ((uVar7 & 1) != 0);
LAB_100007ba4:
  if ((local_98 != local_a0) && (*(long *)(in_x0 + 0x130) != 0)) {
    uVar7 = 1;
    psVar9 = local_98;
    do {
      psVar10 = psVar9 + -0x18;
      if (uVar7 != 0) {
        puVar12 = (undefined8 *)(*(long *)(in_x0 + 0x150) + *(long *)(in_x0 + 0x140) * 0x18);
        ...
        *puVar12 = uVar13;
        ...
        uVar2 = *(long *)(in_x0 + 0x140) + 1;
        uVar7 = *(ulong *)(in_x0 + 0x130);
        uVar4 = 0;
        if (uVar7 != 0) {
          uVar4 = uVar2 / uVar7;
        }
        lVar6 = uVar2 - uVar4 * uVar7;
        *(long *)(in_x0 + 0x140) = lVar6;
        if (lVar6 == *(long *)(in_x0 + 0x138)) {
          lVar3 = 0;
          if (lVar6 + 1U != uVar7) {
            lVar3 = lVar6 + 1;
          }
          *(long *)(in_x0 + 0x138) = lVar3;
          *(long *)(in_x0 + 0x148) = *(long *)(in_x0 + 0x148) + 1;
        }
      }
      psVar9 = psVar10;
