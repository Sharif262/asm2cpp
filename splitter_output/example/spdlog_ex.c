...
spdlog_ex * __thiscall spdlog::spdlog_ex::spdlog_ex(spdlog_ex *this,string *param_1,int param_2)
{
  ...
  ppuVar6 = &puStack_190;
  lStack_58 = *(long *)PTR____stack_chk_guard_100058320;
  *(undefined ***)this = &PTR__spdlog_ex_100059108;
  psVar7 = this + 8;
  *(undefined8 *)psVar7 = 0;
  puStack_160 = PTR_grow_1000584f8;
  *(undefined8 *)(this + 0x10) = 0;
  *(undefined8 *)(this + 0x18) = 0;
  uStack_168 = _UNK_10004c898;
  uStack_170 = _DAT_10004c890;
...
joined_r0x00010001678c:
  ...
  if (*(long *)PTR____stack_chk_guard_100058320 != lStack_58) {
