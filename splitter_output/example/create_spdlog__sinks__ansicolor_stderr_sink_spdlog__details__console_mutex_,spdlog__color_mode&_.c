/* std::shared_ptr<spdlog::async_logger>
   spdlog::async_factory_impl<(spdlog::async_overflow_policy)0>::create<spdlog::sinks::ansicolor_stderr_sink<spdlog::details::console_mutex>,
          ...
          undefined4 *param_3)
{
  ...
  if (local_68 != (registry *)0x0) goto LAB_10003795c;
...
LAB_100037b10:
    ...
    prVar1 = local_68;
    plVar4 = local_60;
    if (local_60 != (long *)0x0) goto LAB_100037b10;
  }
  local_78 = local_68;
  local_70 = local_60;
...
LAB_10003795c:
  ...
  plVar3[2] = 0;
  *plVar3 = (long)&PTR____shared_ptr_emplace_10005ac60;
  plVar3[1] = 0;
  local_88 = spdlog::sinks::ansicolor_sink<spdlog::details::console_mutex>::ansicolor_sink
                       (plVar3 + 3,*(undefined8 *)PTR____stderrp_100058328,*param_3);
  plVar3[3] = (long)(PTR_vtable_100058650 + 0x10);
  local_8c = 0;
  local_80 = plVar3;
  std::
  allocate_shared_abi_ne200100_<spdlog::async_logger,std::allocator<spdlog::async_logger>,std::string,std::shared_ptr<spdlog::sinks::ansicolor_stderr_sink<spdlog::details::console_mutex>>,std::shared_ptr<spdlog::details::thread_pool>,spdlog::async_overflow_policy,0>
