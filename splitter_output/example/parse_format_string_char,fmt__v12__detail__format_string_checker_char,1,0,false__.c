          ...
          *(long *)(param_3 + 0x20) = *(long *)(param_3 + 0x20) + (lVar2 - (long)pdVar5);
          if (iVar6 == 0) {
            ...
            while ((dVar3 = *pdVar5, 0 < iVar6 || (dVar3 != (detail)0x7d))) {
              ...
              pdVar5 = pdVar5 + 1;
              iVar6 = iVar4;
              if (pdVar5 == pdVar1) goto LAB_10000a264;
            }
          }
          if ((pdVar5 == pdVar1) || (*pdVar5 != (detail)0x7d)) {
LAB_10000a264:
...
LAB_10000a2b4:
              ...
              iVar6 = local_38;
              if (*pdVar5 == (detail)0x3a) goto LAB_10000a1d0;
              if (*pdVar5 != (detail)0x7d) goto LAB_10000a2b4;
              lVar2 = *(long *)(param_3 + 0x18);
              *(detail **)(param_3 + 0x18) = pdVar5;
              *(long *)(param_3 + 0x20) = *(long *)(param_3 + 0x20) + (lVar2 - (long)pdVar5);
              if (local_38 == 0) {
            ...
            iVar6 = *(int *)(param_3 + 0x28);
            if (iVar6 < 0) goto LAB_10000a29c;
            *(int *)(param_3 + 0x28) = iVar6 + 1;
            if (*(int *)(param_3 + 0x2c) <= iVar6) goto LAB_10000a2a8;
            lVar2 = *(long *)(param_3 + 0x18);
            *(detail **)(param_3 + 0x18) = pdVar5;
            *(long *)(param_3 + 0x20) = *(long *)(param_3 + 0x20) + (lVar2 - (long)pdVar5);
            if (iVar6 == 0) {
