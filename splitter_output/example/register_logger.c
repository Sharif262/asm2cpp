/* spdlog::register_logger(std::shared_ptr<spdlog::logger>) */

void spdlog::register_logger(undefined8 *param_1)
{
  long lVar1;
  int iVar2;
  undefined8 local_30;
  ...
  *param_1 = 0;
  param_1[1] = 0;
  details::registry::register_logger((registry *)&DAT_10005c1f8,&local_30);
