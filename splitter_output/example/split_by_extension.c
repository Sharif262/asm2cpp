...
LAB_10003926c:
  ...
  if ((char)fVar1 < '\0') {
    uVar8 = *(ulong *)(this + 8);
    if (uVar4 == uVar8 - 1) goto LAB_100039298;
    pfVar9 = *(file_helper **)this;
  }
  else {
    uVar8 = uVar7;
    pfVar9 = this;
    if (uVar4 == uVar7 - 1) goto LAB_10003926c;
  }
  do {
    if (uVar8 == 0) goto LAB_10003931c;
    lVar2 = uVar8 - 1;
    uVar8 = uVar8 - 1;
...
LAB_10003931c:
  ...
  if (uVar8 < 0x17) {
    ...
    puVar5 = &local_70;
    if (uVar8 != 0) goto LAB_1000393c8;
                    /* WARNING: Ignoring partial resolution of indirect */
    local_70._0_1_ = 0;
    uVar7 = (ulong)(char)this[0x17];
    if ((long)uVar7 < 0) goto LAB_1000393e8;
LAB_100039370:
    if (uVar7 < uVar4) {
LAB_1000394d8:
      std::string::__throw_out_of_range_abi_ne200100_();
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(1,0x1000394e0);
      (*pcVar3)();
    }
    uVar8 = uVar7 - uVar4;
  }
...
LAB_1000393c8:
    ...
    *(undefined1 *)((long)puVar5 + uVar8) = 0;
    uVar7 = (ulong)(char)this[0x17];
    if (-1 < (long)uVar7) goto LAB_100039370;
LAB_1000393e8:
    uVar7 = *(ulong *)(this + 8);
    if (uVar7 < uVar4) goto LAB_1000394d8;
  ...
  if (uVar8 < 0x17) {
    ...
    if (uVar7 != uVar4) goto LAB_10003943c;
  }
  else {
    uVar7 = 0x19;
    if ((uVar8 | 7) != 0x17) {
