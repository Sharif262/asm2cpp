...
LAB_10003ee88:
    ...
    if ((long)uVar5 < 0) goto LAB_10003f164;
LAB_10003eea0:
    local_70 = local_a8;
    uStack_68 = uStack_a0;
    local_60 = local_98;
    if (uVar5 <= uVar3) goto LAB_10003f1f8;
    uVar7 = uVar5 - (uVar3 + 1);
  }
  else {
    uVar7 = 0x19;
...
LAB_10003f128:
    ...
    *(undefined1 *)((long)pppppppcVar4 + uVar5) = 0;
    if (-1 < (long)local_60) goto LAB_10003ee88;
    operator_delete(local_70);
    uStack_68 = uStack_a0;
    local_70 = local_a8;
    local_60 = local_98;
    uVar5 = (ulong)(char)psVar6[0x17];
    if (-1 < (long)uVar5) goto LAB_10003eea0;
LAB_10003f164:
    uVar5 = *(ulong *)(psVar6 + 8);
    local_70 = local_a8;
    uStack_68 = uStack_a0;
...
LAB_10003f1f8:
      ...
      pcVar2 = (code *)SoftwareBreakpoint(1,0x10003f200);
      (*pcVar2)();
    }
  ...
  if (uVar7 < 0x17) {
    ...
    pppppppcVar4 = (char *******)&local_a8;
    if (uVar5 != uVar3 + 1) goto LAB_10003f1b4;
