/* WARNING: Removing unreachable block (ram,0x00010003ea30) */
  ...
  do {
    do {
      ...
      if (((byte)piVar2[*(long *)(*(long *)piVar2 + -0x18) + 0x20] & 5) != 0) {
        local_178[0] = *(long *)PTR_VTT_100058268;
        *(undefined8 *)((long)local_178 + *(long *)(local_178[0] + -0x18)) =
             *(undefined8 *)(PTR_VTT_100058268 + 0x18);
        local_168 = PTR_vtable_100058280 + 0x10;
        if (local_111 < '\0') {
          operator_delete(local_128);
        }
        local_168 = PTR_vtable_100058278 + 0x10;
    ...
    if (local_179 < '\0') goto LAB_10003e988;
  } while (-1 < local_191);
  goto LAB_10003e998;
LAB_10003e988:
