/* double argparse::details::do_strtod<double>(std::string const&) */

double argparse::details::do_strtod<double>(string *param_1)
{
  string sVar1;
  uint uVar2;
  int *piVar3;
...
LAB_100071b84:
        piVar3 = ___error();
        *piVar3 = 0;
        dVar8 = _strtod((char *)psVar6,(char **)&local_80);
        piVar3 = ___error();
        if (*piVar3 == 0) {
