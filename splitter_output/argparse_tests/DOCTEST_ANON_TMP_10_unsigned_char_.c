/* WARNING: Removing unreachable block (ram,0x0001000b09d8) */
/* WARNING: Removing unreachable block (ram,0x0001000b0648) */
/* WARNING: Removing unreachable block (ram,0x0001000b0478) */
/* WARNING: Removing unreachable block (ram,0x0001000b0868) */
/* WARNING: Removing unreachable block (ram,0x0001000b0ba0) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_10<unsigned char>() */

void DOCTEST_ANON_TMP_10<unsigned_char>(void)
{
  ulong uVar1;
  undefined8 uVar2;
  code *pcVar3;
  ...
  local_110 = &local_128;
  local_128 = (string *)&PTR____func_10015aa50;
  uVar1 = *(ulong *)(pAVar7 + 0xf8);
  if (uVar1 < *(ulong *)(pAVar7 + 0x100)) {
    *(ulong *)(uVar1 + 0x18) = uVar1;
    (*(code *)PTR___clone_10015aa68)(local_110,uVar1);
  ...
  *(variant **)(pAVar7 + 0xf8) = pvVar8;
  if (local_110 == &local_128) {
    ...
    if (local_110 == (string **)0x0) goto LAB_1000b03a4;
    lVar11 = 0x28;
  }
...
LAB_1000b03a4:
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x30;
    ...
    if (iVar6 != 0) {
      ...
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b054c);
      (*pcVar3)();
    }
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x363630;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b0720);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 4;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b0890);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 4;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b0a00);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined8 *)(local_320 + 0x18) = 0x6e2d;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b0bd0);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
