/* argparse::Argument::Argument<3ul, 0ul, 1ul, 2ul>(std::basic_string_view<char,
   std::char_traits<char> >, std::array<std::basic_string_view<char, std::char_traits<char> >,
   3ul>&&, std::integer_sequence<unsigned long, 0ul, 1ul, 2ul>) */

Argument * __thiscall
argparse::Argument::Argument<3ul,0ul,1ul,2ul>
...
LAB_100079c04:
    ...
    *(string **)(this + 8) = psVar7;
    if (psVar7 < *(string **)(this + 0x10)) goto LAB_100079bb4;
LAB_100079c30:
    ...
    *(string **)(this + 8) = psVar7;
    if (*(string **)(this + 0x10) <= psVar7) goto LAB_100079ccc;
  }
  else {
    psVar7 = std::vector<std::string,std::allocator<std::string>>::
             __emplace_back_slow_path<std::basic_string_view<char,std::char_traits<char>>&>
    ...
    *(string **)(this + 8) = psVar7;
    if (*(string **)(this + 0x10) <= psVar7) goto LAB_100079c30;
LAB_100079bb4:
    uVar5 = param_4[3];
    if (0x7ffffffffffffff7 < uVar5) {
                    /* WARNING: Subroutine does not return */
...
LAB_100079ca0:
    ...
    *(string **)(this + 8) = psVar7;
    *(string **)(this + 8) = psVar7;
    if (*(string **)(this + 0x10) <= psVar7) {
LAB_100079ccc:
      psVar7 = std::vector<std::string,std::allocator<std::string>>::
               __emplace_back_slow_path<std::basic_string_view<char,std::char_traits<char>>&>
                         ((vector<std::string,std::allocator<std::string>> *)this,
                          (basic_string_view *)(param_4 + 4));
      goto LAB_100079d24;
    }
  }
  uVar5 = param_4[5];
