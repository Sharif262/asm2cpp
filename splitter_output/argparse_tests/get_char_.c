/* char argparse::Argument::get<char>() const */

char __thiscall argparse::Argument::get<char>(Argument *this)
{
  char *pcVar1;
  logic_error *this_00;
  undefined8 *puVar2;
  ...
  if (puVar2 == *(undefined8 **)(this + 0x138)) {
    ...
    if (pcVar3 == (code *)0x0) goto LAB_10005de2c;
    pcVar1 = (char *)(*pcVar3)(3,this + 0x58,0,PTR_typeinfo_1001582d8,PTR___id_1001585d0);
joined_r0x00010005de24:
    if (pcVar1 != (char *)0x0) {
      return *pcVar1;
    }
  }
  else if ((code *)*puVar2 != (code *)0x0) {
    pcVar1 = (char *)(*(code *)*puVar2)(3,puVar2,0,PTR_typeinfo_1001582d8,PTR___id_1001585d0);
    goto joined_r0x00010005de24;
  }
