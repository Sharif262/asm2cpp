void __GLOBAL__sub_I_test_prefix_chars_cpp(void)
{
  TestSuite *pTVar1;
  TestCase *pTVar2;
  ...
  doctest::detail::TestCase::TestCase
            ((TestCase *)&local_c0,DOCTEST_ANON_FUNC_2,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_prefix_chars.cpp",0xb,pTVar1,
             aSStack_d8,-1);
  pTVar2 = (TestCase *)
           doctest::detail::TestCase::operator*
                     ((TestCase *)&local_c0,"Parse with custom prefix chars");
  *(char **)(pTVar2 + 0x28) = "prefix_chars";
  ...
  doctest::detail::TestCase::TestCase
            ((TestCase *)&local_c0,DOCTEST_ANON_FUNC_4,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_prefix_chars.cpp",0x16,pTVar1
             ,aSStack_d8,-1);
  pTVar2 = (TestCase *)
           doctest::detail::TestCase::operator*
                     ((TestCase *)&local_c0,"Parse with custom Windows-style prefix chars");
  *(char **)(pTVar2 + 0x28) = "prefix_chars";
  doctest::detail::regTest(pTVar2);
  doctest::String::~String(aSStack_48);
  doctest::String::~String(aSStack_68);
  ...
  doctest::detail::TestCase::TestCase
            ((TestCase *)&local_c0,DOCTEST_ANON_FUNC_6,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_prefix_chars.cpp",0x22,pTVar1
             ,aSStack_d8,-1);
  pTVar2 = (TestCase *)
           doctest::detail::TestCase::operator*
                     ((TestCase *)&local_c0,
                      "Parse with custom Windows-style prefix chars and assign chars");
  *(char **)(pTVar2 + 0x28) = "prefix_chars";
  doctest::detail::regTest(pTVar2);
  doctest::String::~String(aSStack_48);
  doctest::String::~String(aSStack_68);
