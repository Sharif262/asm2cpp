/* WARNING: Removing unreachable block (ram,0x0001000efd20) */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* DOCTEST_ANON_FUNC_28() */

void DOCTEST_ANON_FUNC_28(void)
{
  code *pcVar1;
  int iVar2;
  Argument *this;
  ...
  local_2ac = -1.0;
  this = argparse::ArgumentParser::add_argument<char_const*>(aAStack_278,"--float-opt");
  local_e8 = (undefined8 **)CONCAT44(local_e8._4_4_,0x40600000);
  *(undefined8 *)(this + 0x148) = 0;
  argparse::details::repr<float>((float *)&local_e8);
  if ((char)this[0x8f] < '\0') {
  ...
  *(undefined8 **)(this + 0x88) = local_b8;
  ...
  std::any::operator=[abi_ne200100_<float,float,void>((any *)(this + 0x58),(float *)&local_e8);
  argparse::Argument::store_into<float,(void*)0>(this,&local_2ac);
  ...
  *(undefined1 *)((long)local_c8 + 0x17) = 10;
  local_c8[3] = 0x2d74616f6c662d2d;
  local_c8[4] = 0x74706f;
  *(undefined1 *)((long)local_c8 + 0x2f) = 0xb;
  local_c8[6] = 0x352e35;
  *(undefined1 *)((long)local_c8 + 0x47) = 3;
  local_b8 = puStack_c0;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0x9c,
             "res == 5.5f","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  doctest::detail::Expression_lhs<float&>::operator==
            ((Expression_lhs<float&> *)&local_2c0,&local_2c8);
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000efdd8);
  (*pcVar1)();
}