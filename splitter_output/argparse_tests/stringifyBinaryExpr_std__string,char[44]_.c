/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [44]>(std::string const&,
   char const*, char const (&) [44]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[44]>
