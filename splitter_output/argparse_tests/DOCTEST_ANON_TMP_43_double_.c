/* WARNING: Removing unreachable block (ram,0x0001000db1a0) */
/* WARNING: Removing unreachable block (ram,0x0001000daea4) */
/* WARNING: Removing unreachable block (ram,0x0001000dabc4) */
/* WARNING: Removing unreachable block (ram,0x0001000da7bc) */
/* WARNING: Removing unreachable block (ram,0x0001000da5f4) */
/* WARNING: Removing unreachable block (ram,0x0001000da99c) */
/* WARNING: Removing unreachable block (ram,0x0001000dad34) */
/* WARNING: Removing unreachable block (ram,0x0001000db020) */
/* WARNING: Removing unreachable block (ram,0x0001000db320) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_43<double>() */

void DOCTEST_ANON_TMP_43<double>(void)
{
  ulong uVar1;
  code *pcVar2;
  bool bVar3;
  ...
  *(variant **)(pAVar5 + 0xf8) = pvVar6;
  if (local_e0 == &local_f8) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_1000da520;
    lVar8 = 0x28;
  }
...
LAB_1000da520:
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 1;
    ...
    if (iVar4 != 0) {
      ...
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000da6c4);
      (*pcVar2)();
    }
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 4;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000da89c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 5;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000daa7c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 4;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000dabec);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 4;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000dad5c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 4;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000daecc);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 7;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000db048);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 9;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000db1c8);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 9;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000db348);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
