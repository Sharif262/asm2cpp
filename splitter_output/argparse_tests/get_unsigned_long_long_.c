/* unsigned long long argparse::Argument::get<unsigned long long>() const */

ulonglong __thiscall argparse::Argument::get<unsigned_long_long>(Argument *this)
{
  ulonglong *puVar1;
  logic_error *this_00;
  undefined8 *puVar2;
  ...
  if (puVar2 == *(undefined8 **)(this + 0x138)) {
    ...
    if (pcVar3 == (code *)0x0) goto LAB_1000b0068;
    puVar1 = (ulonglong *)(*pcVar3)(3,this + 0x58,0,PTR_typeinfo_100158328,PTR___id_100158620);
joined_r0x0001000b0060:
    if (puVar1 != (ulonglong *)0x0) {
      return *puVar1;
    }
  }
  else if ((code *)*puVar2 != (code *)0x0) {
    puVar1 = (ulonglong *)(*(code *)*puVar2)(3,puVar2,0,PTR_typeinfo_100158328,PTR___id_100158620);
    goto joined_r0x0001000b0060;
  }
