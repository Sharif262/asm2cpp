/* unsigned char argparse::details::do_from_chars<unsigned char, 10>(std::basic_string_view<char,
   std::char_traits<char> >) */

uchar __thiscall argparse::details::do_from_chars<unsigned_char,10>(details *this,long param_2)
{
