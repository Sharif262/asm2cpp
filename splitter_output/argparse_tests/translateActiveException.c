...
doctest::(anonymous_namespace)::translateActiveException(_anonymous_namespace_ *this)
{
  ...
  local_50 = 0;
  uStack_39 = 0x17;
  puVar1 = DAT_10015c268;
  puVar2 = DAT_10015c270;
  if ((DAT_10015c230 & 1) == 0) {
    detail::registerExceptionTranslatorImpl((IExceptionTranslator *)this);
    puVar1 = DAT_10015c268;
    puVar2 = DAT_10015c270;
  }
  while( true ) {
    puVar3 = DAT_10015c270;
    if (puVar1 == DAT_10015c270) {
      DAT_10015c270 = puVar2;
      ___cxa_rethrow();
                    /* WARNING: Does not return */
      pcVar4 = (code *)SoftwareBreakpoint(1,0x100007818);
      (*pcVar4)();
    }
    DAT_10015c270 = puVar2;
