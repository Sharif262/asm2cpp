/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [80]>(std::string const&,
   char const*, char const (&) [80]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[80]>
