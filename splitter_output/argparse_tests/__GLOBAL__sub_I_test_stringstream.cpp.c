void __GLOBAL__sub_I_test_stringstream_cpp(void)
{
  TestSuite *pTVar1;
  TestCase *pTVar2;
  ...
  doctest::detail::TestCase::TestCase
            ((TestCase *)&local_c0,DOCTEST_ANON_FUNC_2,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_stringstream.cpp",0xe,pTVar1,
             aSStack_d8,-1);
  pTVar2 = (TestCase *)
           doctest::detail::TestCase::operator*((TestCase *)&local_c0,"Get Version String");
  *(char **)(pTVar2 + 0x28) = "stringstream";
