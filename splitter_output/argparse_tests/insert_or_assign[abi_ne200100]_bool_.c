/* std::pair<std::__map_iterator<std::__tree_iterator<std::__value_type<std::string, bool>,
   std::__tree_node<std::__value_type<std::string, bool>, void*>*, long> >, bool>
   std::map<std::string, bool, std::less<std::string >, std::allocator<std::pair<std::string const,
   bool> > >::insert_or_assign[abi:ne200100]<bool>(std::string const&, bool&&) */

undefined1  [16] __thiscall
std::map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
           ...
           *this,string *param_1,bool *param_2)
{
  ...
  *pmVar12;
  ...
  pmVar11 = this + 8;
  pmVar12 = *(map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
              **)pmVar11;
  pmVar9 = pmVar11;
  if (pmVar12 !=
      (map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
    ...
    do {
      pmVar2 = *(map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
                 **)(pmVar12 + 0x20);
      ...
      pmVar12 = *(map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
              ...
              *)0x0);
    if (pmVar9 != pmVar11) {
      pmVar11 = *(map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
                  **)(pmVar9 + 0x20);
      ...
      if (!bVar5) {
        uVar10 = 0;
        pmVar9[0x38] = (map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
                        )*param_2;
        goto LAB_100039ba0;
      }
    }
  }
  pmVar9 = (map<std::string,bool,std::less<std::string>,std::allocator<std::pair<std::string_const,bool>>>
