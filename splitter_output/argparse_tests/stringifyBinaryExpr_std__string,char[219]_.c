/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [219]>(std::string const&,
   char const*, char const (&) [219]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[219]>
