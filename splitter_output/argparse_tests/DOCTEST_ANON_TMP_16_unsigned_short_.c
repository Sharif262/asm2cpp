/* WARNING: Removing unreachable block (ram,0x0001000b77a8) */
/* WARNING: Removing unreachable block (ram,0x0001000b7418) */
/* WARNING: Removing unreachable block (ram,0x0001000b716c) */
/* WARNING: Removing unreachable block (ram,0x0001000b6dd4) */
/* WARNING: Removing unreachable block (ram,0x0001000b6ff4) */
/* WARNING: Removing unreachable block (ram,0x0001000b72fc) */
/* WARNING: Removing unreachable block (ram,0x0001000b7634) */
/* WARNING: Removing unreachable block (ram,0x0001000b7924) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_16<unsigned short>() */

void DOCTEST_ANON_TMP_16<unsigned_short>(void)
{
  ulong uVar1;
  code *pcVar2;
  bool bVar3;
  ...
  *(variant **)(pAVar6 + 0xf8) = pvVar7;
  if (local_e0 == &local_f8) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_1000b6d00;
    lVar9 = 0x28;
  }
...
LAB_1000b6d00:
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 4;
    ...
    if (iVar5 != 0) {
      ...
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b6eac);
      (*pcVar2)();
    }
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 4;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b701c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 5;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b7194);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 0x13;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b7324);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 2;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b74f0);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 2;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b765c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 3;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b77d0);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 0x11;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b794c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
