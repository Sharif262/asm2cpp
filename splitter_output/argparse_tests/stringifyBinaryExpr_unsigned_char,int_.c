/* doctest::String doctest::detail::stringifyBinaryExpr<unsigned char, int>(unsigned char const&,
   char const*, int const&) */

void doctest::detail::stringifyBinaryExpr<unsigned_char,int>
               (uchar *param_1,char *param_2,int *param_3)
{
  String *pSVar1;
