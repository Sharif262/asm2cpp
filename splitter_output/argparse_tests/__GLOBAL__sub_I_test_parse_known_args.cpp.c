void __GLOBAL__sub_I_test_parse_known_args_cpp(void)
{
  TestSuite *pTVar1;
  TestCase *pTVar2;
  ...
  doctest::detail::TestCase::TestCase
            ((TestCase *)&local_c0,DOCTEST_ANON_FUNC_2,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_parse_known_args.cpp",0xe,
             pTVar1,aSStack_d8,-1);
  pTVar2 = (TestCase *)
           doctest::detail::TestCase::operator*
                     ((TestCase *)&local_c0,
                      "Parse unknown optional and positional arguments without exceptions");
  *(char **)(pTVar2 + 0x28) = "parse_known_args";
  ...
  doctest::detail::TestCase::TestCase
            ((TestCase *)&local_c0,DOCTEST_ANON_FUNC_6,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_parse_known_args.cpp",0x25,
             pTVar1,aSStack_d8,-1);
  pTVar2 = (TestCase *)
           doctest::detail::TestCase::operator*
                     ((TestCase *)&local_c0,
                      "Parse unknown optional and positional arguments in subparsers without exceptions"
                     );
  *(char **)(pTVar2 + 0x28) = "parse_known_args";
  doctest::detail::regTest(pTVar2);
  doctest::String::~String(aSStack_48);
