...
/* void DOCTEST_ANON_TMP_4<unsigned int>() */

void DOCTEST_ANON_TMP_4<unsigned_int>(void)
{
  undefined8 uVar1;
  code *pcVar2;
  int iVar3;
  ...
  argparse::details::repr<unsigned_int>(&local_204);
  ...
  if (iVar3 != 0) {
    ...
    pcVar2 = (code *)SoftwareBreakpoint(0,0x1000980ac);
    (*pcVar2)();
  }
