/* doctest::String doctest::detail::stringifyBinaryExpr<float, float>(float const&, char const*,
   float const&) */

void doctest::detail::stringifyBinaryExpr<float,float>(float *param_1,char *param_2,float *param_3)
{
  String *pSVar1;
