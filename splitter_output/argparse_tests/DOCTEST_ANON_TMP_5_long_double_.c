...
/* void DOCTEST_ANON_TMP_5<long double>() */

void DOCTEST_ANON_TMP_5<long_double>(void)
{
  undefined8 uVar1;
  code *pcVar2;
  int iVar3;
  ...
  local_208 = 0.3333333333;
  std::ostream::operator<<((ostream *)&local_1f0,0.3333333333);
  doctest::String::String(aSStack_e8,"");
  doctest::detail::ResultBuilder::ResultBuilder
            (aRStack_c8,0xc,"/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_repr.cpp",0x24
             ,"argparse::details::repr(v) == ss.str()","",aSStack_e8);
  doctest::String::~String(aSStack_e8);
  doctest::detail::ExpressionDecomposer::ExpressionDecomposer
            ((ExpressionDecomposer *)&local_234,0xc);
  argparse::details::repr<long_double>(&local_208);
  ...
  if (iVar3 != 0) {
    ...
    pcVar2 = (code *)SoftwareBreakpoint(0,0x100098dfc);
    (*pcVar2)();
  }
