/* WARNING: Removing unreachable block (ram,0x0001000f2400) */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* DOCTEST_ANON_FUNC_46() */

void DOCTEST_ANON_FUNC_46(void)
{
  code *pcVar1;
  int iVar2;
  Argument *this;
  ...
  *(undefined1 *)((long)local_c8 + 0x17) = 10;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0xfa,
             "res == std::vector<int>{1, 2}","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  *local_2f0 = 0x200000001;
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000f24d4);
  (*pcVar1)();
}