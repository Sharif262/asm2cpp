/* unsigned char argparse::Argument::get<unsigned char>() const */

uchar __thiscall argparse::Argument::get<unsigned_char>(Argument *this)
{
  uchar *puVar1;
  logic_error *this_00;
  undefined8 *puVar2;
  ...
  if (puVar2 == *(undefined8 **)(this + 0x138)) {
    ...
    if (pcVar3 == (code *)0x0) goto LAB_1000ab010;
    puVar1 = (uchar *)(*pcVar3)(3,this + 0x58,0,PTR_typeinfo_1001582f8,PTR___id_1001585f0);
joined_r0x0001000ab008:
    if (puVar1 != (uchar *)0x0) {
      return *puVar1;
    }
  }
  else if ((code *)*puVar2 != (code *)0x0) {
    puVar1 = (uchar *)(*(code *)*puVar2)(3,puVar2,0,PTR_typeinfo_1001582f8,PTR___id_1001585f0);
    goto joined_r0x0001000ab008;
  }
