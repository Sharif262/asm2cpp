/* std::vector<double, std::allocator<double> > argparse::Argument::get<std::vector<double,
   std::allocator<double> > >() const */

void argparse::Argument::get<std::vector<double,std::allocator<double>>>(void)
{
  ulong uVar1;
  void *in_x0;
  undefined8 *puVar2;
  ...
  if (lVar5 != *(long *)((long)in_x0 + 0x138)) {
    *in_x8 = 0;
    ...
    in_x8[2] = 0;
    std::
    transform_abi_ne200100_<std::__wrap_iter<std::any_const*>,std::back_insert_iterator<std::vector<double,std::allocator<double>>>,argparse::Argument::any_cast_container<std::vector<double,std::allocator<double>>>(std::vector<std::any,std::allocator<std::any>>const&)::_lambda(auto:1_const&)_1_>
              ();
    return;
  }
  ...
  if (pcVar4 == (code *)0x0) {
    ...
    puVar2 = (undefined8 *)
             (*pcVar4)(3,(undefined8 *)((long)in_x0 + 0x58),0,
                       &std::vector<double,std::allocator<double>>::typeinfo,PTR___id_100158598);
