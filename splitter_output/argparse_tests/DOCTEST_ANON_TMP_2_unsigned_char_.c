/* WARNING: Removing unreachable block (ram,0x0001000aa1b0) */
/* WARNING: Removing unreachable block (ram,0x0001000a9ec8) */
/* WARNING: Removing unreachable block (ram,0x0001000a9b30) */
/* WARNING: Removing unreachable block (ram,0x0001000a9964) */
/* WARNING: Removing unreachable block (ram,0x0001000a9d50) */
/* WARNING: Removing unreachable block (ram,0x0001000aa03c) */
/* WARNING: Removing unreachable block (ram,0x0001000aa378) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_2<unsigned char>() */

void DOCTEST_ANON_TMP_2<unsigned_char>(void)
{
  ulong uVar1;
  undefined8 uVar2;
  code *pcVar3;
  ...
  local_110 = &local_128;
  local_128 = (string *)&PTR____func_10015a8d0;
  uVar1 = *(ulong *)(pAVar7 + 0xf8);
  if (uVar1 < *(ulong *)(pAVar7 + 0x100)) {
    *(ulong *)(uVar1 + 0x18) = uVar1;
    (*(code *)PTR___clone_10015a8e8)(local_110,uVar1);
  ...
  *(variant **)(pAVar7 + 0xf8) = pvVar8;
  if (local_110 == &local_128) {
    ...
    if (local_110 == (string **)0x0) goto LAB_1000a9890;
    lVar11 = 0x28;
  }
...
LAB_1000a9890:
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x30;
    ...
    bVar5 = argparse::Argument::get<unsigned_char>(pAVar7);
    local_320 = (string *)((ulong)bVar5 | (long)local_148 << 0x20);
    ...
    if (iVar6 != 0) {
      ...
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000a9a38);
      (*pcVar3)();
    }
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x35;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000a9c08);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 4;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000a9d78);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000a9ef0);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000aa064);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000aa1d8);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined8 *)(local_320 + 0x18) = 0x6e2d;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000aa3a8);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
