/* doctest::String doctest::detail::stringifyBinaryExpr<char, char>(char const&, char const*, char
   const&) */

void doctest::detail::stringifyBinaryExpr<char,char>(char *param_1,char *param_2,char *param_3)
{
  String *pSVar1;
