/* WARNING: Removing unreachable block (ram,0x0001000eecd0) */
  ...
  *(undefined1 *)((long)local_c8 + 0x17) = 10;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0x72,
             "res == 3.5","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000eed88);
  (*pcVar1)();
}