/* WARNING: Removing unreachable block (ram,0x0001000ef4b4) */
  ...
  *(undefined1 *)((long)local_c8 + 0x17) = 10;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0x88,
             "res == -1.0f","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000ef56c);
  (*pcVar1)();
}