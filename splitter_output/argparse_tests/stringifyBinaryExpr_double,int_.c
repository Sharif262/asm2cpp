/* doctest::String doctest::detail::stringifyBinaryExpr<double, int>(double const&, char const*, int
   const&) */

void doctest::detail::stringifyBinaryExpr<double,int>(double *param_1,char *param_2,int *param_3)
{
  String *pSVar1;
