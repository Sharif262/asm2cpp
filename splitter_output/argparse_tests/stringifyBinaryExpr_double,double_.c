/* doctest::String doctest::detail::stringifyBinaryExpr<double, double>(double const&, char const*,
   double const&) */

void doctest::detail::stringifyBinaryExpr<double,double>
               (double *param_1,char *param_2,double *param_3)
{
  String *pSVar1;
