/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [139]>(std::string const&,
   char const*, char const (&) [139]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[139]>
