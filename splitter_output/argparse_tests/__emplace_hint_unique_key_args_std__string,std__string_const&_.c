/* WARNING: Heritage AFTER dead removal. Example location: x0 : 0x0001000f7ea4 */
...
/* std::pair<std::__tree_iterator<std::string, std::__tree_node<std::string, void*>*, long>, bool>
   ...
   >::__emplace_hint_unique_key_args<std::string, std::string
   const&>(std::__tree_const_iterator<std::string, std::__tree_node<std::string, void*>*, long>,
