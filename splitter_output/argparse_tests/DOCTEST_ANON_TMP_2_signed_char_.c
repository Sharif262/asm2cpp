/* WARNING: Removing unreachable block (ram,0x0001000a3170) */
/* WARNING: Removing unreachable block (ram,0x0001000a2e88) */
/* WARNING: Removing unreachable block (ram,0x0001000a2a90) */
/* WARNING: Removing unreachable block (ram,0x0001000a28c4) */
/* WARNING: Removing unreachable block (ram,0x0001000a2c60) */
/* WARNING: Removing unreachable block (ram,0x0001000a2ffc) */
/* WARNING: Removing unreachable block (ram,0x0001000a3338) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_2<signed char>() */

void DOCTEST_ANON_TMP_2<signed_char>(void)
{
  undefined8 uVar1;
  code *pcVar2;
  bool bVar3;
  ...
  local_110 = &local_128;
  local_128 = (string *)&PTR____func_10015a6d0;
  uVar7 = *(ulong *)(pAVar5 + 0xf8);
  if (uVar7 < *(ulong *)(pAVar5 + 0x100)) {
    *(ulong *)(uVar7 + 0x18) = uVar7;
    (*(code *)PTR___clone_10015a6e8)(local_110,uVar7);
    *(undefined4 *)(uVar7 + 0x20) = 0;
    pvVar6 = (variant *)(uVar7 + 0x28);
  }
  else {
    pvVar6 = std::
  ...
  *(variant **)(pAVar5 + 0xf8) = pvVar6;
  if (local_110 == &local_128) {
    ...
    if (local_110 == (string **)0x0) goto LAB_1000a27f0;
    lVar10 = 0x28;
  }
...
LAB_1000a27f0:
  ...
  if (bVar3) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x30;
    ...
    uVar7 = argparse::Argument::get<signed_char>(pAVar5);
    local_320 = (string *)(uVar7 & 0xff | (long)local_148 << 0x20);
    local_130 = (string *)((ulong)local_130 & 0xffffffff00000000);
    doctest::detail::Expression_lhs<signed_char>::operator==
              ((Expression_lhs<signed_char> *)&local_320,(int *)&local_130);
    ...
    if (iVar4 != 0) {
      ...
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000a2998);
      (*pcVar2)();
    }
  ...
  if (bVar3) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x35;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000a2b68);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if (bVar3) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x3832312d;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000a2d38);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  doctest::String::~String((String *)&local_128);
  bVar3 = doctest::detail::Subcase::operator_cast_to_bool(aSStack_98);
  if ((bVar3) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    doctest::String::String((String *)&local_68,"");
    doctest::detail::ResultBuilder::ResultBuilder
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000a2eb0);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar3) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000a3024);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar3) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000a3198);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar3) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    uVar1 = s_987654321987654321987654321_10014e956._0_8_;
    *(ulong *)(pcVar8 + 8) =
    ...
    *(undefined8 *)(local_320 + 0x18) = 0x6e2d;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000a3368);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
