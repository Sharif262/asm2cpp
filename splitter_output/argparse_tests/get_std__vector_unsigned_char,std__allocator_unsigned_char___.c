/* std::vector<unsigned char, std::allocator<unsigned char> >
   argparse::Argument::get<std::vector<unsigned char, std::allocator<unsigned char> > >() const */

void argparse::Argument::get<std::vector<unsigned_char,std::allocator<unsigned_char>>>(void)
{
  ulong uVar1;
  void *in_x0;
  undefined8 *puVar2;
  ...
  if (lVar5 != *(long *)((long)in_x0 + 0x138)) {
    *in_x8 = 0;
    ...
    in_x8[2] = 0;
    std::
    transform_abi_ne200100_<std::__wrap_iter<std::any_const*>,std::back_insert_iterator<std::vector<unsigned_char,std::allocator<unsigned_char>>>,argparse::Argument::any_cast_container<std::vector<unsigned_char,std::allocator<unsigned_char>>>(std::vector<std::any,std::allocator<std::any>>const&)::_lambda(auto:1_const&)_1_>
              ();
    return;
  }
