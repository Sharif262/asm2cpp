/* WARNING: Removing unreachable block (ram,0x0001000f079c) */
...
void DOCTEST_ANON_FUNC_34(void)
{
  ...
  uStack_2b8 = 0;
  local_2b0 = 0;
  pAVar3 = argparse::ArgumentParser::add_argument<char_const*>(aAStack_278,"--str-opt");
  pAVar3 = (Argument *)argparse::Argument::default_value(pAVar3,"default");
  argparse::Argument::store_into(pAVar3,(string *)&local_2c0);
  ...
  *(undefined1 *)((long)local_c8 + 0x47) = 3;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0xba,
             "res == \"foo\"","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  doctest::detail::Expression_lhs<std::string&>::operator==
            ((Expression_lhs<std::string&> *)&local_2d0,"foo");
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000f0850);
  (*pcVar1)();
}