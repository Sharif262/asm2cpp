/* WARNING: Heritage AFTER dead removal. Example location: x0 : 0x0001000267e4 */
...
/* std::pair<std::__tree_iterator<std::__value_type<std::string,
   ...
   bool> std::__tree<std::__value_type<std::string,
   std::__list_iterator<std::reference_wrapper<argparse::ArgumentParser>, void*> >,
   ...
   std::__list_iterator<std::reference_wrapper<argparse::ArgumentParser>,
   void*>&>(std::__tree_const_iterator<std::__value_type<std::string,
   std::__list_iterator<std::reference_wrapper<argparse::ArgumentParser>, void*> >,
   std::__tree_node<std::__value_type<std::string,
   std::__list_iterator<std::reference_wrapper<argparse::ArgumentParser>, void*> >, void*>*, long>,
           ...
           *this,undefined8 param_2,undefined8 param_3,undefined8 *param_4,undefined8 *param_5)
{
  ...
  pp_Var1 = __find_equal<std::string>(this,param_2,&local_48,auStack_50,param_3);
  p_Var3 = *pp_Var1;
  if (p_Var3 == (__tree_node_base *)0x0) {
    ...
    *(undefined8 *)(p_Var3 + 0x38) = *param_5;
    *(undefined8 *)p_Var3 = 0;
