/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [51]>(std::string const&,
   char const*, char const (&) [51]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[51]>
