/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [195]>(std::string const&,
   char const*, char const (&) [195]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[195]>
