...
void __thiscall doctest::Context::parseArgs(Context *this,int param_1,char **param_2,bool param_3)
{
  ...
  if (((uVar5 & 1) == 0) &&
    ...
    if (((uVar5 & 1) != 0) ||
       ...
       (uVar2 | uVar7) == 1)) goto LAB_100008a8c;
LAB_100008b24:
    if ((uStack_5c < 0) && (local_70 != (void *)0x0)) {
      operator_delete__(local_70);
    }
...
LAB_100008a8c:
    ...
    if (ppvVar1 == &local_70) goto LAB_100008b24;
  ...
  if (((uVar5 & 1) == 0) &&
    ...
    if ((iVar3 != 0) ||
       ...
       , (uVar2 | uVar7) == 1)) goto LAB_100008bf4;
  }
  else {
LAB_100008bf4:
    lVar8 = *(long *)this;
  ...
  if (((uVar5 & 1) == 0) &&
    ...
    if (((uVar5 & 1) != 0) ||
      ...
      *(undefined1 *)(lVar8 + 0x80) = 1;
      goto joined_r0x00010000992c;
    }
    if (uVar7 == 0) goto LAB_100009938;
    lVar8 = *(long *)this;
