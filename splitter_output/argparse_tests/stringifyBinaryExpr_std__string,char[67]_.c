/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [67]>(std::string const&,
   char const*, char const (&) [67]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[67]>
