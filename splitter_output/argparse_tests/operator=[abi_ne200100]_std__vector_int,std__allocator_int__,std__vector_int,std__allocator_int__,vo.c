/* std::any& std::any::operator=[abi:ne200100]<std::vector<int, std::allocator<int> >,
   std::vector<int, std::allocator<int> >, void>(std::vector<int, std::allocator<int> >&&) */
          ...
          (any *this,vector *param_1)
{
  ...
  *(undefined8 *)(param_1 + 0x10) = 0;
  local_68 = __any_imp::_SmallHandler<std::vector<int,std::allocator<int>>>::__handle_abi_ne200100_;
...
LAB_10005d16c:
    ...
    if (*(code **)this == (code *)0x0) {
      ...
      *(code **)this =
           __any_imp::_SmallHandler<std::vector<int,std::allocator<int>>>::__handle_abi_ne200100_;
    ...
    if (local_68 != (code *)0x0) goto LAB_10005d16c;
  }
  if (*(long *)PTR____stack_chk_guard_100158438 == local_28) {
    return this;
  }
