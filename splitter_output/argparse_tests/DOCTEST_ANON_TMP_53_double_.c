/* WARNING: Removing unreachable block (ram,0x0001000dfaf8) */
/* WARNING: Removing unreachable block (ram,0x0001000df750) */
/* WARNING: Removing unreachable block (ram,0x0001000df578) */
/* WARNING: Removing unreachable block (ram,0x0001000df980) */
/* WARNING: Removing unreachable block (ram,0x0001000dfc68) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_53<double>() */

void DOCTEST_ANON_TMP_53<double>(void)
{
  ulong uVar1;
  code *pcVar2;
  bool bVar3;
  ...
  *(variant **)(pAVar5 + 0xf8) = pvVar6;
  if (local_e0 == &local_f8) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_1000df4a0;
    lVar8 = 0x28;
  }
...
LAB_1000df4a0:
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 3;
    ...
    if (iVar4 != 0) {
      ...
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000df648);
      (*pcVar2)();
    }
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 9;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000df828);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 9;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000df9a8);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 6;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000dfb20);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 4;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000dfc90);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
