/* WARNING: Removing unreachable block (ram,0x0001000f2d8c) */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* DOCTEST_ANON_FUNC_50() */

void DOCTEST_ANON_FUNC_50(void)
{
  code *pcVar1;
  int iVar2;
  Argument *this;
  ...
  *(undefined8 **)(this + 0x88) = local_b8;
  ...
  local_c8 = operator_new(0x60);
  puStack_c0 = local_c8 + 0xc;
  ...
  *(undefined1 *)((long)local_c8 + 0x47) = 1;
  local_c8[9] = 0x34;
  *(undefined1 *)((long)local_c8 + 0x5f) = 1;
  local_b8 = puStack_c0;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0x110,
  ...
  *local_2f0 = 0x400000003;
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000f2e68);
  (*pcVar1)();
}