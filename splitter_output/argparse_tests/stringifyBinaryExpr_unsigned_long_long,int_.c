/* doctest::String doctest::detail::stringifyBinaryExpr<unsigned long long, int>(unsigned long long
   const&, char const*, int const&) */

void doctest::detail::stringifyBinaryExpr<unsigned_long_long,int>
               (ulonglong *param_1,char *param_2,int *param_3)
{
  String *pSVar1;
