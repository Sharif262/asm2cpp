/* short argparse::Argument::get<short>() const */

short __thiscall argparse::Argument::get<short>(Argument *this)
{
  short *psVar1;
  logic_error *this_00;
  undefined8 *puVar2;
  ...
  if (puVar2 == *(undefined8 **)(this + 0x138)) {
    ...
    if (pcVar3 == (code *)0x0) goto LAB_1000a625c;
    psVar1 = (short *)(*pcVar3)(3,this + 0x58,0,PTR_typeinfo_100158310,PTR___id_100158608);
joined_r0x0001000a6254:
    if (psVar1 != (short *)0x0) {
      return *psVar1;
    }
  }
  else if ((code *)*puVar2 != (code *)0x0) {
    psVar1 = (short *)(*(code *)*puVar2)(3,puVar2,0,PTR_typeinfo_100158310,PTR___id_100158608);
    goto joined_r0x0001000a6254;
  }
