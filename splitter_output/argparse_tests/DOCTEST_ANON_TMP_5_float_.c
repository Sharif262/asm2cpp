...
/* void DOCTEST_ANON_TMP_5<float>() */

void DOCTEST_ANON_TMP_5<float>(void)
{
  undefined8 uVar1;
  code *pcVar2;
  int iVar3;
  ...
  local_204 = 0.33333334;
  std::ostream::operator<<((ostream *)&local_1f0,0.33333334);
  ...
  argparse::details::repr<float>(&local_204);
  ...
  if (iVar3 != 0) {
    ...
    pcVar2 = (code *)SoftwareBreakpoint(0,0x1000987b4);
    (*pcVar2)();
  }
