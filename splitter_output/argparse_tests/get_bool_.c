/* bool argparse::Argument::get<bool>() const */
...
bool __thiscall argparse::Argument::get<bool>(Argument *this)
{
  ...
  if (puVar2 == *(undefined8 **)(this + 0x138)) {
    ...
    if (pcVar3 == (code *)0x0) goto LAB_100031c40;
    puVar1 = (undefined1 *)(*pcVar3)(3,this + 0x58,0,PTR_typeinfo_1001582d0,PTR___id_1001585c8);
joined_r0x000100031c38:
    if (puVar1 != (undefined1 *)0x0) {
      return (bool)*puVar1;
    }
  }
  else if ((code *)*puVar2 != (code *)0x0) {
    puVar1 = (undefined1 *)(*(code *)*puVar2)(3,puVar2,0,PTR_typeinfo_1001582d0,PTR___id_1001585c8);
    goto joined_r0x000100031c38;
  }
