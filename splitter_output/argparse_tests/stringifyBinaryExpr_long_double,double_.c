/* doctest::String doctest::detail::stringifyBinaryExpr<long double, double>(long double const&,
   char const*, double const&) */

void doctest::detail::stringifyBinaryExpr<long_double,double>
               (longdouble *param_1,char *param_2,double *param_3)
{
  String *pSVar1;
