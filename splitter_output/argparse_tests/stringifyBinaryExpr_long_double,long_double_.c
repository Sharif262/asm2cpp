/* doctest::String doctest::detail::stringifyBinaryExpr<long double, long double>(long double
   const&, char const*, long double const&) */

void doctest::detail::stringifyBinaryExpr<long_double,long_double>
               (longdouble *param_1,char *param_2,longdouble *param_3)
{
  String *pSVar1;
