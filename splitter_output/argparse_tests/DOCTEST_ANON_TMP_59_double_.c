/* WARNING: Removing unreachable block (ram,0x0001000e3bd0) */
/* WARNING: Removing unreachable block (ram,0x0001000e38e0) */
/* WARNING: Removing unreachable block (ram,0x0001000e34d0) */
/* WARNING: Removing unreachable block (ram,0x0001000e32fc) */
/* WARNING: Removing unreachable block (ram,0x0001000e36b4) */
/* WARNING: Removing unreachable block (ram,0x0001000e3a50) */
/* WARNING: Removing unreachable block (ram,0x0001000e3d50) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_59<double>() */

void DOCTEST_ANON_TMP_59<double>(void)
{
  ulong uVar1;
  code *pcVar2;
  bool bVar3;
  ...
  *(variant **)(pAVar5 + 0xf8) = pvVar6;
  if (local_e0 == &local_f8) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_1000e3224;
    lVar8 = 0x28;
  }
...
LAB_1000e3224:
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 3;
    ...
    local_128 = (undefined ****)argparse::Argument::get<double>(pAVar5);
    local_120 = local_2ec;
    local_2f8 = 0.0;
    doctest::detail::Expression_lhs<double>::operator==
              ((Expression_lhs<double> *)&local_128,&local_2f8);
    ...
    if (iVar4 != 0) {
      ...
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000e33cc);
      (*pcVar2)();
    }
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 7;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000e35b0);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 8;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000e378c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 7;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000e3908);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 4;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000e3a78);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 9;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000e3bf8);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar8 = doctest::getContextOptions(), (*(byte *)(lVar8 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 9;
    ...
    if (iVar4 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000e3d78);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
