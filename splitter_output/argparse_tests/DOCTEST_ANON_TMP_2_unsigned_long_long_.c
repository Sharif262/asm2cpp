/* WARNING: Removing unreachable block (ram,0x0001000af660) */
/* WARNING: Removing unreachable block (ram,0x0001000af378) */
/* WARNING: Removing unreachable block (ram,0x0001000aefe4) */
/* WARNING: Removing unreachable block (ram,0x0001000aee1c) */
/* WARNING: Removing unreachable block (ram,0x0001000af200) */
/* WARNING: Removing unreachable block (ram,0x0001000af4ec) */
/* WARNING: Removing unreachable block (ram,0x0001000af828) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_2<unsigned long long>() */

void DOCTEST_ANON_TMP_2<unsigned_long_long>(void)
{
  ulong uVar1;
  undefined8 uVar2;
  code *pcVar3;
  ...
  local_110 = &local_128;
  local_128 = (string *)&PTR____func_100159d80;
  uVar1 = *(ulong *)(pAVar6 + 0xf8);
  if (uVar1 < *(ulong *)(pAVar6 + 0x100)) {
    *(ulong *)(uVar1 + 0x18) = uVar1;
    (*(code *)PTR___clone_100159d98)(local_110,uVar1);
  ...
  *(variant **)(pAVar6 + 0xf8) = pvVar7;
  if (local_110 == &local_128) {
    ...
    if (local_110 == (string **)0x0) goto LAB_1000aed48;
    lVar10 = 0x28;
  }
...
LAB_1000aed48:
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x30;
    ...
    if (iVar5 != 0) {
      ...
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000aeeec);
      (*pcVar3)();
    }
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x35;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000af0b8);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 4;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000af228);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000af3a0);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000af514);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000af688);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar10 = doctest::getContextOptions(), (*(byte *)(lVar10 + 0x72) & 1) == 0)) {
    ...
    *(undefined8 *)(local_320 + 0x18) = 0x6e2d;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000af858);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
