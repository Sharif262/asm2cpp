/* long double argparse::details::do_strtod<long double>(std::string const&) */

longdouble argparse::details::do_strtod<long_double>(string *param_1)
{
  string sVar1;
  uint uVar2;
  int *piVar3;
...
LAB_1000dd960:
        piVar3 = ___error();
        *piVar3 = 0;
        dVar8 = _strtold((char *)psVar6,(char **)&local_80);
        piVar3 = ___error();
        if (*piVar3 == 0) {
