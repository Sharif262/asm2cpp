/* WARNING: Removing unreachable block (ram,0x0001000ef130) */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* DOCTEST_ANON_FUNC_22() */

void DOCTEST_ANON_FUNC_22(void)
{
  code *pcVar1;
  int iVar2;
  Argument *this;
  ...
  local_e8 = (undefined8 **)0x400c000000000000;
  *(undefined8 *)(this + 0x148) = 0;
  argparse::details::repr<double>((double *)&local_e8);
  if ((char)this[0x8f] < '\0') {
  ...
  *(undefined8 **)(this + 0x88) = local_b8;
  ...
  std::any::operator=[abi_ne200100_<double,double,void>((any *)(this + 0x58),(double *)&local_e8);
  ...
  *(undefined1 *)((long)local_c8 + 0x17) = 10;
  local_c8[3] = 0x656c62756f642d2d;
  local_c8[4] = 0x74706f2d;
  *(undefined1 *)((long)local_c8 + 0x2f) = 0xc;
  local_c8[6] = 0x352e35;
  *(undefined1 *)((long)local_c8 + 0x47) = 3;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0x7c,
             "res == 5.5","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  doctest::detail::Expression_lhs<double&>::operator==
            ((Expression_lhs<double&> *)&local_2c0,&local_2d0);
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000ef1e8);
  (*pcVar1)();
}