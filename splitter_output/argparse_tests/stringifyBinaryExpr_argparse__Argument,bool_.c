/* doctest::String doctest::detail::stringifyBinaryExpr<argparse::Argument, bool>(argparse::Argument
   const&, char const*, bool const&) */

void doctest::detail::stringifyBinaryExpr<argparse::Argument,bool>
               (Argument *param_1,char *param_2,bool *param_3)
{
  ostream *poVar1;
  detail *this;
  bool extraout_w1;
