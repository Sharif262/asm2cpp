/* std::vector<float, std::allocator<float> > argparse::Argument::get<std::vector<float,
   std::allocator<float> > >() const */

void argparse::Argument::get<std::vector<float,std::allocator<float>>>(void)
{
  ulong uVar1;
  void *in_x0;
  undefined8 *puVar2;
  ...
  if (pcVar4 == (code *)0x0) {
    ...
    puVar2 = (undefined8 *)
             (*pcVar4)(3,(undefined8 *)((long)in_x0 + 0x58),0,
                       &std::vector<float,std::allocator<float>>::typeinfo,PTR___id_1001585a0);
