/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [132]>(std::string const&,
   char const*, char const (&) [132]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[132]>
