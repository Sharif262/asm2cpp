/* doctest::String doctest::detail::stringifyBinaryExpr<unsigned short, int>(unsigned short const&,
   char const*, int const&) */

void doctest::detail::stringifyBinaryExpr<unsigned_short,int>
               (ushort *param_1,char *param_2,int *param_3)
{
  String *pSVar1;
