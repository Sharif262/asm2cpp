/* WARNING: Removing unreachable block (ram,0x0001000b32c4) */
/* WARNING: Removing unreachable block (ram,0x0001000b2f34) */
/* WARNING: Removing unreachable block (ram,0x0001000b2d64) */
/* WARNING: Removing unreachable block (ram,0x0001000b3154) */
/* WARNING: Removing unreachable block (ram,0x0001000b348c) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_10<unsigned int>() */

void DOCTEST_ANON_TMP_10<unsigned_int>(void)
{
  ulong uVar1;
  undefined8 uVar2;
  code *pcVar3;
  ...
  local_110 = &local_128;
  local_128 = (string *)&PTR____func_10015ab50;
  uVar1 = *(ulong *)(pAVar7 + 0xf8);
  if (uVar1 < *(ulong *)(pAVar7 + 0x100)) {
    *(ulong *)(uVar1 + 0x18) = uVar1;
    (*(code *)PTR___clone_10015ab68)(local_110,uVar1);
  ...
  *(variant **)(pAVar7 + 0xf8) = pvVar8;
  if (local_110 == &local_128) {
    ...
    if (local_110 == (string **)0x0) goto LAB_1000b2c90;
    lVar11 = 0x28;
  }
...
LAB_1000b2c90:
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x30;
    ...
    if (iVar6 != 0) {
      ...
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b2e38);
      (*pcVar3)();
    }
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x363630;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b300c);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 4;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b317c);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 4;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b32ec);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined8 *)(local_320 + 0x18) = 0x6e2d;
    ...
    local_318 = local_320;
    local_138 = local_320;
    std::string::__init_copy_ctor_external(local_130,pcVar9,0x17);
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000b34bc);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
