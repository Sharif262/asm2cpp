/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [37]>(std::string const&,
   char const*, char const (&) [37]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[37]>
