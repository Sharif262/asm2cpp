/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [48]>(std::string const&,
   char const*, char const (&) [48]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[48]>
