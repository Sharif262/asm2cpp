void __GLOBAL__sub_I_test_hidden_alias_cpp(void)
{
  TestSuite *pTVar1;
  TestCase *pTVar2;
  ...
  doctest::detail::TestCase::TestCase
            ((TestCase *)&local_c0,DOCTEST_ANON_FUNC_2,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_hidden_alias.cpp",0xb,pTVar1,
             aSStack_d8,-1);
  pTVar2 = (TestCase *)
           doctest::detail::TestCase::operator*
                     ((TestCase *)&local_c0,"Test setting a hidden alias for an argument");
  *(char **)(pTVar2 + 0x28) = "hidden_alias";
