/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [22]>(std::string const&,
   char const*, char const (&) [22]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[22]>
