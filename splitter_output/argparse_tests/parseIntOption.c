  ...
  if (((uVar6 & 1) != 0) ||
    ...
    if (param_4 == 0) {
      ...
      if (_Var3 == _Var4) {
        pcVar7 = "";
        do {
          if (*(char *)ppcVar1 == '\0') goto LAB_10000a564;
      ...
      if (_Var3 == _Var4) {
        pcVar7 = "";
        do {
          if (*(char *)ppcVar1 == '\0') goto LAB_10000a594;
          _Var3 = ___tolower((int)*(char *)((long)ppcVar1 + 1));
          _Var4 = ___tolower((int)*pcVar7);
          pcVar7 = pcVar7 + 1;
          ppcVar1 = (char **)((long)ppcVar1 + 1);
      ...
      if (iVar2 != 0) goto LAB_10000a568;
    }
  }
  uVar5 = 0;
  if (-1 < local_49) goto LAB_10000a5a8;
  goto LAB_10000a578;
LAB_10000a564:
  iVar2 = 1;
LAB_10000a568:
  *param_5 = iVar2;
  goto joined_r0x00010000a5a4;
LAB_10000a594:
  *param_5 = 0;
joined_r0x00010000a5a4:
  uVar5 = 1;
  if (local_49 < '\0') {
LAB_10000a578:
