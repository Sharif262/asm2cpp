...
/* void DOCTEST_ANON_TMP_4<long long>() */

void DOCTEST_ANON_TMP_4<long_long>(void)
{
  undefined8 uVar1;
  code *pcVar2;
  int iVar3;
  ...
  argparse::details::repr<long_long>(&local_208);
  ...
  if (iVar3 != 0) {
    ...
    pcVar2 = (code *)SoftwareBreakpoint(0,0x1000979a0);
    (*pcVar2)();
  }
