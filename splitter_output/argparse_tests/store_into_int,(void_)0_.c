...
/* auto& argparse::Argument::store_into<int, (void*)0>(int&) */

auto * __thiscall argparse::Argument::store_into<int,(void*)0>(Argument *this,int *param_1)
{
  ulong uVar1;
  int *piVar2;
  variant *pvVar3;
  ...
  if (pcVar4 != (code *)0x0) {
    piVar2 = (int *)(*pcVar4)(3,this + 0x58,0,PTR_typeinfo_100158300,PTR___id_1001585f8);
    if (piVar2 == (int *)0x0) {
  ...
  local_48 = &PTR____func_10015b920;
  local_30 = &local_48;
  uVar1 = *(ulong *)(this + 0xf8);
  piStack_40 = param_1;
  if (uVar1 < *(ulong *)(this + 0x100)) {
    *(ulong *)(uVar1 + 0x18) = uVar1;
    (*(code *)PTR___clone_10015b938)(local_30,uVar1);
  ...
  *(variant **)(this + 0xf8) = pvVar3;
  if (local_30 == &local_48) {
    ...
    if (local_30 == (undefined ***)0x0) goto LAB_1000f517c;
    lVar5 = 0x28;
  }
  (**(code **)((long)*local_30 + lVar5))();
LAB_1000f517c:
