/* doctest::String doctest::detail::stringifyBinaryExpr<long long, int>(long long const&, char
   const*, int const&) */

void doctest::detail::stringifyBinaryExpr<long_long,int>
               (longlong *param_1,char *param_2,int *param_3)
{
  String *pSVar1;
