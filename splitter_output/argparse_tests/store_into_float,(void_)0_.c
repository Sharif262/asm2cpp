...
/* auto& argparse::Argument::store_into<float, (void*)0>(float&) */

auto * __thiscall argparse::Argument::store_into<float,(void*)0>(Argument *this,float *param_1)
{
  ulong uVar1;
  float *pfVar2;
  variant *pvVar3;
  ...
  if (pcVar4 != (code *)0x0) {
    pfVar2 = (float *)(*pcVar4)(3,this + 0x58,0,PTR_typeinfo_1001582f0,PTR___id_1001585e8);
    if (pfVar2 == (float *)0x0) {
  ...
  local_48 = &PTR____func_10015baa0;
  local_30 = &local_48;
  uVar1 = *(ulong *)(this + 0xf8);
  pfStack_40 = param_1;
  if (uVar1 < *(ulong *)(this + 0x100)) {
    *(ulong *)(uVar1 + 0x18) = uVar1;
    (*(code *)PTR___clone_10015bab8)(local_30,uVar1);
  ...
  *(variant **)(this + 0xf8) = pvVar3;
  if (local_30 == &local_48) {
    ...
    if (local_30 == (undefined ***)0x0) goto LAB_1000f5cb4;
    lVar5 = 0x28;
  }
  (**(code **)((long)*local_30 + lVar5))();
LAB_1000f5cb4:
