/* WARNING: Removing unreachable block (ram,0x0001000ee0e4) */
...
void DOCTEST_ANON_FUNC_14(void)
{
  ...
  local_e8 = (undefined8 **)CONCAT71(local_e8._1_7_,3);
  *(undefined8 *)(this + 0x148) = 0;
  argparse::details::repr<unsigned_char>((uchar *)&local_e8);
  if ((char)this[0x8f] < '\0') {
  ...
  *(undefined8 **)(this + 0x88) = local_b8;
  std::to_string((uint)(byte)local_e8._0_1_);
  ...
  std::any::operator=[abi_ne200100_<unsigned_char,unsigned_char,void>
            ((any *)(this + 0x58),(uchar *)&local_e8);
  argparse::Argument::store_into<unsigned_char,(void*)0>(this,&local_2a9);
  ...
  *(undefined1 *)((long)local_c8 + 0x17) = 10;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0x52,
             "res == 3","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  doctest::detail::Expression_lhs<unsigned_char&>::operator==
            ((Expression_lhs<unsigned_char&> *)&local_2c0,&local_2c8);
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000ee19c);
  (*pcVar1)();
}