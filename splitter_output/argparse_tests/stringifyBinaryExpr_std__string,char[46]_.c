/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [46]>(std::string const&,
   char const*, char const (&) [46]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[46]>
