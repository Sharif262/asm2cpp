/* WARNING: Removing unreachable block (ram,0x0001000b99f4) */
/* WARNING: Removing unreachable block (ram,0x0001000b9664) */
/* WARNING: Removing unreachable block (ram,0x0001000b93b8) */
/* WARNING: Removing unreachable block (ram,0x0001000b9020) */
/* WARNING: Removing unreachable block (ram,0x0001000b9240) */
/* WARNING: Removing unreachable block (ram,0x0001000b9548) */
/* WARNING: Removing unreachable block (ram,0x0001000b9880) */
/* WARNING: Removing unreachable block (ram,0x0001000b9b70) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_16<unsigned int>() */

void DOCTEST_ANON_TMP_16<unsigned_int>(void)
{
  ulong uVar1;
  code *pcVar2;
  bool bVar3;
  ...
  *(variant **)(pAVar6 + 0xf8) = pvVar7;
  if (local_e0 == &local_f8) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_1000b8f4c;
    lVar9 = 0x28;
  }
...
LAB_1000b8f4c:
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 4;
    ...
    if (iVar5 != 0) {
      ...
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b90f8);
      (*pcVar2)();
    }
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 4;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b9268);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 5;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b93e0);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 0x13;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b9570);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if (bVar3) {
    ...
    *(undefined1 *)((long)local_f8 + 0x47) = 2;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b973c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 2;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b98a8);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 3;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b9a1c);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
  ...
  if ((bVar3) && (lVar9 = doctest::getContextOptions(), (*(byte *)(lVar9 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_118 + 0x47) = 0x11;
    ...
    if (iVar5 != 0) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0,0x1000b9b98);
      (*pcVar2)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_f8);
    doctest::String::~String(aSStack_88);
