/* doctest::String doctest::detail::stringifyBinaryExpr<argparse::Argument, int>(argparse::Argument
   const&, char const*, int const&) */

void doctest::detail::stringifyBinaryExpr<argparse::Argument,int>
               (Argument *param_1,char *param_2,int *param_3)
{
  ostream *poVar1;
  detail *this;
  String *pSVar2;
