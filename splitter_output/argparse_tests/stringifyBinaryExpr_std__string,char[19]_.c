/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [19]>(std::string const&,
   char const*, char const (&) [19]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[19]>
