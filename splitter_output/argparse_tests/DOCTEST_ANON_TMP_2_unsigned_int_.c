/* WARNING: Removing unreachable block (ram,0x0001000ad80c) */
/* WARNING: Removing unreachable block (ram,0x0001000ad524) */
/* WARNING: Removing unreachable block (ram,0x0001000ad18c) */
/* WARNING: Removing unreachable block (ram,0x0001000acfc0) */
/* WARNING: Removing unreachable block (ram,0x0001000ad3ac) */
/* WARNING: Removing unreachable block (ram,0x0001000ad698) */
/* WARNING: Removing unreachable block (ram,0x0001000ad9d4) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void DOCTEST_ANON_TMP_2<unsigned int>() */

void DOCTEST_ANON_TMP_2<unsigned_int>(void)
{
  ulong uVar1;
  undefined8 uVar2;
  code *pcVar3;
  ...
  local_110 = &local_128;
  local_128 = (string *)&PTR____func_10015a9d0;
  uVar1 = *(ulong *)(pAVar7 + 0xf8);
  if (uVar1 < *(ulong *)(pAVar7 + 0x100)) {
    *(ulong *)(uVar1 + 0x18) = uVar1;
    (*(code *)PTR___clone_10015a9e8)(local_110,uVar1);
  ...
  *(variant **)(pAVar7 + 0xf8) = pvVar8;
  if (local_110 == &local_128) {
    ...
    if (local_110 == (string **)0x0) goto LAB_1000aceec;
    lVar11 = 0x28;
  }
...
LAB_1000aceec:
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x30;
    ...
    uVar5 = argparse::Argument::get<unsigned_int>(pAVar7);
    local_320 = (string *)CONCAT44(local_148._0_4_,uVar5);
    ...
    if (iVar6 != 0) {
      ...
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000ad094);
      (*pcVar3)();
    }
  ...
  if (bVar4) {
    ...
    *(undefined **)(local_128 + 0x30) = (undefined *)0x35;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000ad264);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    doctest::detail::ResultBuilder::ResultBuilder
              ((ResultBuilder *)&local_128,0x24,
               "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_scan.cpp",0x21,
               "program.parse_args({\"test\", \"-n\", \"-135\"})","std::invalid_argument",&local_68)
    ;
    doctest::String::~String((String *)&local_68);
    local_68 = (string **)0x0;
    local_60 = (string **)0x0;
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 4;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000ad3d4);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000ad54c);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000ad6c0);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined1 *)((long)local_68 + 0x47) = 3;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000ad834);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
  ...
  if ((bVar4) && (lVar11 = doctest::getContextOptions(), (*(byte *)(lVar11 + 0x72) & 1) == 0)) {
    ...
    *(undefined8 *)(local_320 + 0x18) = 0x6e2d;
    ...
    if (iVar6 != 0) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0,0x1000ada04);
      (*pcVar3)();
    }
    doctest::detail::ResultBuilder::react((ResultBuilder *)&local_128);
    doctest::String::~String(aSStack_b8);
