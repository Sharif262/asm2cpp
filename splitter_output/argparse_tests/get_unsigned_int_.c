/* unsigned int argparse::Argument::get<unsigned int>() const */

uint __thiscall argparse::Argument::get<unsigned_int>(Argument *this)
{
  uint *puVar1;
  logic_error *this_00;
  undefined8 *puVar2;
  ...
  if (puVar2 == *(undefined8 **)(this + 0x138)) {
    ...
    if (pcVar3 == (code *)0x0) goto LAB_1000aea0c;
    puVar1 = (uint *)(*pcVar3)(3,this + 0x58,0,PTR_typeinfo_100158308,PTR___id_100158600);
joined_r0x0001000aea04:
    if (puVar1 != (uint *)0x0) {
      return *puVar1;
    }
  }
  else if ((code *)*puVar2 != (code *)0x0) {
    puVar1 = (uint *)(*(code *)*puVar2)(3,puVar2,0,PTR_typeinfo_100158308,PTR___id_100158600);
    goto joined_r0x0001000aea04;
  }
