/* doctest::String doctest::detail::stringifyBinaryExpr<std::string, char [65]>(std::string const&,
   char const*, char const (&) [65]) */

void doctest::detail::stringifyBinaryExpr<std::string,char[65]>
