/* long double argparse::Argument::get<long double>() const */

longdouble __thiscall argparse::Argument::get<long_double>(Argument *this)
{
  longdouble *plVar1;
  logic_error *this_00;
  undefined8 *puVar2;
  ...
  if (puVar2 == *(undefined8 **)(this + 0x138)) {
    ...
    if (pcVar3 == (code *)0x0) goto LAB_1000ddd80;
    plVar1 = (longdouble *)(*pcVar3)(3,this + 0x58,0,PTR_typeinfo_1001582e8,PTR___id_1001585e0);
joined_r0x0001000ddd78:
    if (plVar1 != (longdouble *)0x0) {
      return *plVar1;
    }
  }
  else if ((code *)*puVar2 != (code *)0x0) {
    plVar1 = (longdouble *)(*(code *)*puVar2)(3,puVar2,0,PTR_typeinfo_1001582e8,PTR___id_1001585e0);
    goto joined_r0x0001000ddd78;
  }
