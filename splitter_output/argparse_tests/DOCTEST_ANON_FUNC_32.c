/* WARNING: Removing unreachable block (ram,0x0001000f0410) */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* DOCTEST_ANON_FUNC_32() */

void DOCTEST_ANON_FUNC_32(void)
{
  code *pcVar1;
  int iVar2;
  Argument *pAVar3;
  ...
  *(undefined1 *)((long)local_c8 + 0x17) = 10;
  ...
  doctest::detail::ResultBuilder::ResultBuilder
            ((ResultBuilder *)&local_c8,0xc,
             "/Users/aaronsharif/asm2cpp/benchmarks/argparse/test/test_store_into.cpp",0xb0,
             "res == \"default\"","",&local_e8);
  doctest::String::~String((String *)&local_e8);
  ...
  doctest::detail::Expression_lhs<std::string&>::operator==
            ((Expression_lhs<std::string&> *)&local_2d0,"default");
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1000f04c4);
  (*pcVar1)();
}