...
/* std::shared_ptr<Catch::clara::detail::BoundValueRef<long long> >
   std::allocate_shared[abi:ne200100]<Catch::clara::detail::BoundValueRef<long long>,
   std::allocator<Catch::clara::detail::BoundValueRef<long long> >, long long&,
   0>(std::allocator<Catch::clara::detail::BoundValueRef<long long> > const&, long long&) */
               ...
               (allocator *param_1,longlong *param_2)
{
  ...
  *p_Var1;
  ...
  ::__allocation_guard_abi_ne200100_<std::allocator<Catch::clara::detail::BoundValueRef<long_long>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<Catch::clara::detail::BoundValueRef<long_long>,std::allocator<Catch::clara::detail::BoundValueRef<long_long>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<Catch::clara::detail::BoundValueRef<long_long>,std::allocator<Catch::clara::detail::BoundValueRef<long_long>>>>>
  ...
  std::shared_ptr<Catch::clara::detail::BoundValueRef<long_long>>::
  __create_with_control_block_abi_ne200100_<Catch::clara::detail::BoundValueRef<long_long>,std::__shared_ptr_emplace<Catch::clara::detail::BoundValueRef<long_long>,std::allocator<Catch::clara::detail::BoundValueRef<long_long>>>>
