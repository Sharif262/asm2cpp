...
{
                    /* WARNING: Could not recover jumptable at 0x00010014cccc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)PTR___init_with_size_abi_ne200100_<std::string_const*,std::string_const*>_100173358)();
  return;
}