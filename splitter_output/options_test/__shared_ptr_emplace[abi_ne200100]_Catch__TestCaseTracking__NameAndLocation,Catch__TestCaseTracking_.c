/* std::allocator<Catch::TestCaseTracking::SectionTracker>
   ...
   std::allocator<Catch::TestCaseTracking::SectionTracker>
   >::__shared_ptr_emplace[abi:ne200100]<Catch::TestCaseTracking::NameAndLocation,
   Catch::TestCaseTracking::TrackerContext&, decltype(nullptr),
   std::allocator<Catch::TestCaseTracking::SectionTracker>,
   0>(Catch::TestCaseTracking::NameAndLocation&&, Catch::TestCaseTracking::TrackerContext&,
   decltype(nullptr)&&) */
...
__shared_ptr_emplace<Catch::TestCaseTracking::SectionTracker,std::allocator<Catch::TestCaseTracking::SectionTracker>>
::
__shared_ptr_emplace_abi_ne200100_<Catch::TestCaseTracking::NameAndLocation,Catch::TestCaseTracking::TrackerContext&,decltype(nullptr),std::allocator<Catch::TestCaseTracking::SectionTracker>,0>
          (__shared_ptr_emplace<Catch::TestCaseTracking::SectionTracker,std::allocator<Catch::TestCaseTracking::SectionTracker>>
           *this,NameAndLocation *param_1,TrackerContext *param_2,_func_decltype_nullptr **param_3)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_100177c88;
  ...
  construct_abi_ne200100_<Catch::TestCaseTracking::SectionTracker,Catch::TestCaseTracking::NameAndLocation,Catch::TestCaseTracking::TrackerContext&,decltype(nullptr),0>
