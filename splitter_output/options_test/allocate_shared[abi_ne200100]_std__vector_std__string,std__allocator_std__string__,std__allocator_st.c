...
/* std::shared_ptr<std::vector<std::string, std::allocator<std::string > > >
   std::allocate_shared[abi:ne200100]<std::vector<std::string, std::allocator<std::string > >,
   std::allocator<std::vector<std::string, std::allocator<std::string > > >, ,
   0>(std::allocator<std::vector<std::string, std::allocator<std::string > > > const&) */
...
void std::
     allocate_shared_abi_ne200100_<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>,,0>
               (allocator *param_1)
{
  __shared_ptr_emplace<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>>
  *p_Var1;
  vector *pvVar2;
  ...
  __allocation_guard_abi_ne200100_<std::allocator<std::vector<std::string,std::allocator<std::string>>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>>>>
              ::__get_abi_ne200100_(a_Stack_30);
  __shared_ptr_emplace<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>>
  ::
  __shared_ptr_emplace_abi_ne200100_<,std::allocator<std::vector<std::string,std::allocator<std::string>>>,0>
            (p_Var1);
  p_Var1 = (__shared_ptr_emplace<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>>>>
  ...
  std::shared_ptr<std::vector<std::string,std::allocator<std::string>>>::
  __create_with_control_block_abi_ne200100_<std::vector<std::string,std::allocator<std::string>>,std::__shared_ptr_emplace<std::vector<std::string,std::allocator<std::string>>,std::allocator<std::vector<std::string,std::allocator<std::string>>>>>
