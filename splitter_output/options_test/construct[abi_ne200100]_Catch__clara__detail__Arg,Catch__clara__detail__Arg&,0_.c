...
{
                    /* WARNING: Could not recover jumptable at 0x00010014b19c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<Catch::clara::detail::Arg,Catch::clara::detail::Arg&,0>_100172178)()
  ;
  return;
}