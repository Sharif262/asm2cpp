...
/* std::shared_ptr<cxxopts::values::standard_value<std::vector<float, std::allocator<float> > > >
   std::allocate_shared[abi:ne200100]<cxxopts::values::standard_value<std::vector<float,
   ...
   const&, cxxopts::values::standard_value<std::vector<float, std::allocator<float> > > const&) */
...
{
  __shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>
  *p_Var1;
  ...
  __allocation_guard_abi_ne200100_<std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>>>
              ::__get_abi_ne200100_(a_Stack_30);
  __shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>
  ::
  __shared_ptr_emplace_abi_ne200100_<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>const&,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>,0>
            (p_Var1,param_2);
  p_Var1 = (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>>>
  ...
  std::shared_ptr<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>::
  __create_with_control_block_abi_ne200100_<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>>
