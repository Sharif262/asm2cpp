/* Catch::clara::detail::Opt::Opt<Catch::makeCommandLineParser(Catch::ConfigData&)::$_7>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_7
   const&, std::string const&) */

Opt * __thiscall
Catch::clara::detail::Opt::Opt<Catch::makeCommandLineParser(Catch::ConfigData&)::__7>
          (Opt *this,__7 *param_1,string *param_2)
{
