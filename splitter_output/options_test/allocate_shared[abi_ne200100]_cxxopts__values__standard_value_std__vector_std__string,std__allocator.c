...
/* std::shared_ptr<cxxopts::values::standard_value<std::vector<std::string,
   ...
   std::allocate_shared[abi:ne200100]<cxxopts::values::standard_value<std::vector<std::string,
   std::allocator<std::string > > >,
               ...
               (allocator *param_1)
{
  ...
  *p_Var1;
  ...
  __allocation_guard_abi_ne200100_<std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>>>
              ::__get_abi_ne200100_(a_Stack_30);
  __shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>
  ::
  __shared_ptr_emplace_abi_ne200100_<,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>,0>
            (p_Var1);
  p_Var1 = (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>>>
  ...
  ::
  __create_with_control_block_abi_ne200100_<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>>
