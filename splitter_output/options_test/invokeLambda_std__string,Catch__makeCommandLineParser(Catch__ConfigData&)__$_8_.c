/* Catch::clara::detail::BasicResult<Catch::clara::detail::ParseResultType>
   ...
   Catch::makeCommandLineParser(Catch::ConfigData&)::$_8>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_8
   const&, std::string const&) */

void __thiscall
Catch::clara::detail::
invokeLambda<std::string,Catch::makeCommandLineParser(Catch::ConfigData&)::__8>
          (detail *this,__8 *param_1,string *param_2)
{
  bool bVar1;
  ...
  if (bVar1) {
    ...
    invoke<Catch::makeCommandLineParser(Catch::ConfigData&)::__8,std::string>
              ((__8 *)local_20,asStack_40);
  }
  else {
