/* std::allocator<std::string > std::__shared_ptr_emplace<std::string, std::allocator<std::string >
   >::__shared_ptr_emplace[abi:ne200100]<char const (&) [13], std::allocator<std::string >, 0>(char
   const (&) [13]) */
...
__shared_ptr_emplace_abi_ne200100_<char_const(&)[13],std::allocator<std::string>,0>
          (__shared_ptr_emplace<std::string,std::allocator<std::string>> *this,char *param_1)
{
  string *psVar1;
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_1001759e8;
  ...
  construct_abi_ne200100_<std::string,char_const(&)[13],0>(aaStack_35,psVar1,local_28);
  return this;
}