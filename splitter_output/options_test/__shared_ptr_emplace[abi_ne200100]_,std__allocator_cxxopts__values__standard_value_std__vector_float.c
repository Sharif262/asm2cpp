/* std::allocator<cxxopts::values::standard_value<std::vector<float, std::allocator<float> > > >
   ...
   std::allocator<float> > > > >::__shared_ptr_emplace[abi:ne200100]<,
   std::allocator<cxxopts::values::standard_value<std::vector<float, std::allocator<float> > > >,
   0>() */
...
__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>
::
__shared_ptr_emplace_abi_ne200100_<,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>,0>
          (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>,std::allocator<cxxopts::values::standard_value<std::vector<float,std::allocator<float>>>>>
           *this)
{
