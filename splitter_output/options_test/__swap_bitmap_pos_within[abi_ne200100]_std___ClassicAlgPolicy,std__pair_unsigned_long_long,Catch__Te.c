...
/* void std::__swap_bitmap_pos_within[abi:ne200100]<std::_ClassicAlgPolicy, std::pair<unsigned long
   long, Catch::TestCase const*>*>(std::pair<unsigned long long, Catch::TestCase const*>*&,
   std::pair<unsigned long long, Catch::TestCase const*>*&, unsigned long long&, unsigned long
   long&) */

void std::
     __swap_bitmap_pos_within_abi_ne200100_<std::_ClassicAlgPolicy,std::pair<unsigned_long_long,Catch::TestCase_const*>*>
               (pair_conflict **param_1,pair_conflict **param_2,ulonglong *param_3,
               ulonglong *param_4)
{
  int iVar1;
  ...
  if (*param_3 == 0) {
    if (*param_4 != 0) {
      while (*local_30 != 0) {
        ...
        *local_30 = *local_30 & (1L << (local_48 & 0x3f)) - 1U;
        local_50 = *local_20 + local_48 * -0x10;
    ...
    while (*local_28 != 0) {
      ...
      *local_28 = *local_28 & (1L << (local_38 & 0x3f)) - 1U;
      local_40 = *local_18 + local_38 * 0x10;
