...
void std::vector<std::string,std::allocator<std::string>>::
     __init_with_size_abi_ne200100_<std::__wrap_iter<std::string*>,std::__wrap_iter<std::string*>>
               (void)
{
                    /* WARNING: Could not recover jumptable at 0x00010014ccb4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR___init_with_size_abi_ne200100_<std::__wrap_iter<std::string*>,std::__wrap_iter<std::string*>>_100173348
  )();
  return;
}