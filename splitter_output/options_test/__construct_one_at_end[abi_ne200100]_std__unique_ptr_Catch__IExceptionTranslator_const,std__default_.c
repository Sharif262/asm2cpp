...
/* void std::vector<std::unique_ptr<Catch::IExceptionTranslator const,
   ...
   std::default_delete<Catch::IExceptionTranslator const> > >
   >::__construct_one_at_end[abi:ne200100]<std::unique_ptr<Catch::IExceptionTranslator const,
   std::default_delete<Catch::IExceptionTranslator const> >
...
void std::
     ...
     ::
     __construct_one_at_end_abi_ne200100_<std::unique_ptr<Catch::IExceptionTranslator_const,std::default_delete<Catch::IExceptionTranslator_const>>>
               (unique_ptr *param_1)
{
                    /* WARNING: Could not recover jumptable at 0x00010014cbdc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR___construct_one_at_end_abi_ne200100_<std::unique_ptr<Catch::IExceptionTranslator_const,std::default_delete<Catch::IExceptionTranslator_const>>>_1001732b8
  )();
  return;
}