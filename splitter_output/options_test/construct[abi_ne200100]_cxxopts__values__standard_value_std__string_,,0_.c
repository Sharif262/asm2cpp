...
void std::allocator_traits<std::allocator<cxxopts::values::standard_value<std::string>>>::
     construct_abi_ne200100_<cxxopts::values::standard_value<std::string>,,0>
               (allocator *param_1,standard_value *param_2)
{
                    /* WARNING: Could not recover jumptable at 0x00010014b454. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)PTR_construct_abi_ne200100_<cxxopts::values::standard_value<std::string>,,0>_100172348)
            ();
  return;
}