/* Catch::Matchers::Exception::ExceptionMessageMatcher::ExceptionMessageMatcher(std::string const&)
    */

ExceptionMessageMatcher * __thiscall
Catch::Matchers::Exception::ExceptionMessageMatcher::ExceptionMessageMatcher
          (ExceptionMessageMatcher *this,string *param_1)
{
  ...
  *(undefined ***)(this + 0x20) = &PTR_match_100174b08;
  std::string::string((string *)(this + 0x28),param_1);
  return this;
}