...
/* void 
   std::__uninitialized_allocator_relocate[abi:ne200100]<std::allocator<Catch::clara::detail::Opt>,
...
void std::
     __uninitialized_allocator_relocate_abi_ne200100_<std::allocator<Catch::clara::detail::Opt>,Catch::clara::detail::Opt*>
               (allocator *param_1,Opt *param_2,Opt *param_3,Opt *param_4)
{
  ...
  for (local_78 = local_20; paVar1 = local_18, local_78 != local_28; local_78 = local_78 + 0x68) {
