/* std::allocator<cxxopts::values::standard_value<int> >
   ...
   std::allocator<cxxopts::values::standard_value<int> >
   >::__shared_ptr_emplace[abi:ne200100]<cxxopts::values::standard_value<int> const&,
   std::allocator<cxxopts::values::standard_value<int> >, 0>(cxxopts::values::standard_value<int>
   const&) */
...
__shared_ptr_emplace<cxxopts::values::standard_value<int>,std::allocator<cxxopts::values::standard_value<int>>>
::
__shared_ptr_emplace_abi_ne200100_<cxxopts::values::standard_value<int>const&,std::allocator<cxxopts::values::standard_value<int>>,0>
          (__shared_ptr_emplace<cxxopts::values::standard_value<int>,std::allocator<cxxopts::values::standard_value<int>>>
           *this,standard_value *param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_1001792f0;
  ...
  construct_abi_ne200100_<cxxopts::values::standard_value<int>,cxxopts::values::standard_value<int>const&,0>
