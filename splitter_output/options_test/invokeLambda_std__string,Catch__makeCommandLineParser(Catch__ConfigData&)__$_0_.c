/* Catch::clara::detail::BasicResult<Catch::clara::detail::ParseResultType>
   ...
   Catch::makeCommandLineParser(Catch::ConfigData&)::$_0>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_0
   const&, std::string const&) */

void __thiscall
Catch::clara::detail::
invokeLambda<std::string,Catch::makeCommandLineParser(Catch::ConfigData&)::__0>
          (detail *this,__0 *param_1,string *param_2)
{
  bool bVar1;
  ...
  if (bVar1) {
    ...
    invoke<Catch::makeCommandLineParser(Catch::ConfigData&)::__0,std::string>
              ((__0 *)local_20,asStack_40);
  }
  else {
