/* std::regex_token_iterator<std::__wrap_iter<char const*>, char, std::regex_traits<char> >
   std::__rewrap_iter[abi:ne200100]<std::regex_token_iterator<std::__wrap_iter<char const*>, char,
   ...
   std::regex_traits<char> >, false> >(std::regex_token_iterator<std::__wrap_iter<char const*>,
   char, std::regex_traits<char> >, std::regex_token_iterator<std::__wrap_iter<char const*>, char,
   std::regex_traits<char> >) */
...
void std::
     __rewrap_iter_abi_ne200100_<std::regex_token_iterator<std::__wrap_iter<char_const*>,char,std::regex_traits<char>>,std::regex_token_iterator<std::__wrap_iter<char_const*>,char,std::regex_traits<char>>,std::__unwrap_iter_impl<std::regex_token_iterator<std::__wrap_iter<char_const*>,char,std::regex_traits<char>>,false>>
                ...
                *param_1,regex_token_iterator *param_2,regex_token_iterator *param_3)
{
  ...
  *local_28;
  ...
  __unwrap_iter_impl<std::regex_token_iterator<std::__wrap_iter<char_const*>,char,std::regex_traits<char>>,false>
  ::__rewrap_abi_ne200100_(param_1,arStack_108,arStack_1d8);
  regex_token_iterator<std::__wrap_iter<char_const*>,char,std::regex_traits<char>>::
