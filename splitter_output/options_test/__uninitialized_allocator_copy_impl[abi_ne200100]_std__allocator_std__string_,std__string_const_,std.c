...
string * std::
         __uninitialized_allocator_copy_impl_abi_ne200100_<std::allocator<std::string>,std::string_const*,std::string_const*,std::string*>
                   (allocator *param_1,string *param_2,string *param_3,string *param_4)
{
  ...
  for (; paVar1 = local_18, local_20 != local_28; local_20 = local_20 + 0x18) {
    ...
    construct_abi_ne200100_<std::string,std::string_const&,0>(paVar1,psVar2,local_20);
