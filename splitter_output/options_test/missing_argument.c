/* cxxopts::exceptions::missing_argument::missing_argument(std::string const&) */

void __thiscall
cxxopts::exceptions::missing_argument::missing_argument(missing_argument *this,string *param_1)
{
  ...
  std::operator+[abi_ne200100_<char,std::char_traits<char>,std::allocator<char>>
            (asStack_50," is missing an argument");
  parsing::parsing((parsing *)this,asStack_38);
  std::string::~string(asStack_38);
  std::string::~string(asStack_50);
  std::string::~string(asStack_68);
  std::string::~string(asStack_80);
  *(undefined ***)this = &PTR__missing_argument_1001789c0;
  return;
}