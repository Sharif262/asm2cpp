/* std::allocator<cxxopts::values::standard_value<std::vector<std::string,
   ...
   std::allocator<std::string > > >,
   std::allocator<cxxopts::values::standard_value<std::vector<std::string,
   std::allocator<std::string > > > > >::__shared_ptr_emplace[abi:ne200100]<,
   std::allocator<cxxopts::values::standard_value<std::vector<std::string,
           ...
           *this)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_100178e40;
  ...
  ::
  construct_abi_ne200100_<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,,0>
            (aaStack_2d,psVar1);
  return this;
}