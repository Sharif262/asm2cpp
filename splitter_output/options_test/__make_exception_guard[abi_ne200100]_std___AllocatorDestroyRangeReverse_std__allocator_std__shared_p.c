/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<std::shared_ptr<Catch::TestSpec::Pattern>
   >, std::shared_ptr<Catch::TestSpec::Pattern>*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<std::shared_ptr<Catch::TestSpec::Pattern>
   >, std::shared_ptr<Catch::TestSpec::Pattern>*>
   >(std::_AllocatorDestroyRangeReverse<std::allocator<std::shared_ptr<Catch::TestSpec::Pattern> >,
   std::shared_ptr<Catch::TestSpec::Pattern>*>) */
