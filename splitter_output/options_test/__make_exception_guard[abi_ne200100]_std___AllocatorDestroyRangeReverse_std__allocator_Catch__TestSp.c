/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::TestSpec::Filter>,
   Catch::TestSpec::Filter*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::TestSpec::Filter>,
   Catch::TestSpec::Filter*>
   >(std::_AllocatorDestroyRangeReverse<std::allocator<Catch::TestSpec::Filter>,
   Catch::TestSpec::Filter*>) */
