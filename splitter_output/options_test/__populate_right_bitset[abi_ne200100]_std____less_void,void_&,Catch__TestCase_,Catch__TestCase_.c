...
/* void std::__populate_right_bitset[abi:ne200100]<std::__less<void, void>&, Catch::TestCase*,
   Catch::TestCase>(Catch::TestCase*, std::__less<void, void>&, Catch::TestCase&, unsigned long
   long&) */

void std::
     __populate_right_bitset_abi_ne200100_<std::__less<void,void>&,Catch::TestCase*,Catch::TestCase>
               (TestCase *param_1,__less *param_2,TestCase *param_3,ulonglong *param_4)
{
  bool bVar1;
  uint local_3c;
  TestCase *local_38;
