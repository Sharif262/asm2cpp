               ...
               (__wrap_iter *param_1,__wrap_iter *param_2)
{
  ...
  lVar1 = __wrap_iter<Catch::SectionEndInfo*>::base_abi_ne200100_
                    ((__wrap_iter<Catch::SectionEndInfo*> *)param_1);
  lVar2 = __wrap_iter<Catch::SectionEndInfo*>::base_abi_ne200100_
                    ((__wrap_iter<Catch::SectionEndInfo*> *)param_2);
  return lVar1 == lVar2;
}