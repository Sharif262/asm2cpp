/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<cxxopts::KeyValue>,
   cxxopts::KeyValue*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<cxxopts::KeyValue>,
   cxxopts::KeyValue*> >(std::_AllocatorDestroyRangeReverse<std::allocator<cxxopts::KeyValue>,
   cxxopts::KeyValue*>) */
