...
/* bool 
   std::__all_of[abi:ne200100]<std::__wrap_iter<std::shared_ptr<Catch::TestCaseTracking::ITracker>*>,
   std::__wrap_iter<std::shared_ptr<Catch::TestCaseTracking::ITracker>*>, std::__identity,
   ...
   Catch::TestCaseTracking::TrackerBase::close()::$_0&, std::__identity&) */

bool std::
     __all_of_abi_ne200100_<std::__wrap_iter<std::shared_ptr<Catch::TestCaseTracking::ITracker>*>,std::__wrap_iter<std::shared_ptr<Catch::TestCaseTracking::ITracker>*>,std::__identity,Catch::TestCaseTracking::TrackerBase::close()::__0>
  ...
  while( true ) {
    ...
    psVar2 = (shared_ptr *)
             __invoke_abi_ne200100_<std::__identity&,std::shared_ptr<Catch::TestCaseTracking::ITracker>&>
                       (param_4,psVar2);
    uVar3 = __invoke_abi_ne200100_<Catch::TestCaseTracking::TrackerBase::close()::__0&,std::shared_ptr<Catch::TestCaseTracking::ITracker>&>
                      (param_3,psVar2);
    if ((uVar3 & 1) == 0) break;
