...
/* std::shared_ptr<cxxopts::values::standard_value<std::string > >
   std::allocate_shared[abi:ne200100]<cxxopts::values::standard_value<std::string >,
   std::allocator<cxxopts::values::standard_value<std::string > >, std::string*,
   0>(std::allocator<cxxopts::values::standard_value<std::string > > const&, std::string*&&) */
               ...
               (allocator *param_1,string **param_2)
{
  ...
  *p_Var1;
  ...
  ::__allocation_guard_abi_ne200100_<std::allocator<cxxopts::values::standard_value<std::string>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<cxxopts::values::standard_value<std::string>,std::allocator<cxxopts::values::standard_value<std::string>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<cxxopts::values::standard_value<std::string>,std::allocator<cxxopts::values::standard_value<std::string>>>>>
