...
/* void* 
   std::__libcpp_operator_new[abi:ne200100]<std::__shared_ptr_emplace<Catch::CumulativeReporterBase<Catch::JunitReporter>::Node<Catch::TestRunStats,
