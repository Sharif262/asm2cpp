/* Catch::clara::detail::BasicResult<Catch::clara::detail::ParseResultType>
   ...
   Catch::makeCommandLineParser(Catch::ConfigData&)::$_7>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_7
   const&, std::string const&) */

void __thiscall
Catch::clara::detail::
invokeLambda<std::string,Catch::makeCommandLineParser(Catch::ConfigData&)::__7>
          (detail *this,__7 *param_1,string *param_2)
{
  bool bVar1;
  ...
  if (bVar1) {
    ...
    invoke<Catch::makeCommandLineParser(Catch::ConfigData&)::__7,std::string>
              ((__7 *)local_20,asStack_40);
  }
  else {
