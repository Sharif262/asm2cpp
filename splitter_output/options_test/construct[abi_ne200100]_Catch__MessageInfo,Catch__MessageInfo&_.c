...
{
                    /* WARNING: Could not recover jumptable at 0x00010014d200. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)PTR_construct_abi_ne200100_<Catch::MessageInfo,Catch::MessageInfo&>_1001736a8)();
  return;
}