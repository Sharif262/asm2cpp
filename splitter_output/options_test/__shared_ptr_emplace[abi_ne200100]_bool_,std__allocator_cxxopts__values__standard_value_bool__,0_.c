/* std::allocator<cxxopts::values::standard_value<bool> >
   ...
   std::allocator<cxxopts::values::standard_value<bool> >
   >::__shared_ptr_emplace[abi:ne200100]<bool*, std::allocator<cxxopts::values::standard_value<bool>
   >, 0>(bool*&&) */
           ...
           *this,bool **param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_100178478;
  ...
  construct_abi_ne200100_<cxxopts::values::standard_value<bool>,bool*,0>(aaStack_35,psVar1,local_28)
  ;
  return this;
}