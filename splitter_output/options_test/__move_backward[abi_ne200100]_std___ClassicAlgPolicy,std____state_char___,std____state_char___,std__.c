...
/* std::pair<std::__state<char>**, std::__state<char>**>
   std::__move_backward[abi:ne200100]<std::_ClassicAlgPolicy, std::__state<char>**,
          ...
          (__state **param_1,__state **param_2,__state **param_3)
{
  ...
  auVar1 = __copy_move_unwrap_iters_abi_ne200100_<std::__move_backward_impl<std::_ClassicAlgPolicy>,std::__state<char>**,std::__state<char>**,std::__state<char>**,0>
