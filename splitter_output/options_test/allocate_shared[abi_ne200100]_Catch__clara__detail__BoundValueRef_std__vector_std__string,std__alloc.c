...
/* std::shared_ptr<Catch::clara::detail::BoundValueRef<std::vector<std::string,
   ...
   std::allocate_shared[abi:ne200100]<Catch::clara::detail::BoundValueRef<std::vector<std::string,
   std::allocator<std::string > > >,
               ...
               (allocator *param_1,vector *param_2)
{
  ...
  *p_Var1;
  ...
  __allocation_guard_abi_ne200100_<std::allocator<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>,std::allocator<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>,std::allocator<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>>>>>
  ...
  ::
  __create_with_control_block_abi_ne200100_<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>,std::__shared_ptr_emplace<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>,std::allocator<Catch::clara::detail::BoundValueRef<std::vector<std::string,std::allocator<std::string>>>>>>
