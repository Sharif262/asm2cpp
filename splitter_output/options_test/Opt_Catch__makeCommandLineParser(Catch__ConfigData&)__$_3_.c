/* Catch::clara::detail::Opt::Opt<Catch::makeCommandLineParser(Catch::ConfigData&)::$_3>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_3
   const&, std::string const&) */

Opt * __thiscall
Catch::clara::detail::Opt::Opt<Catch::makeCommandLineParser(Catch::ConfigData&)::__3>
          (Opt *this,__3 *param_1,string *param_2)
{
