/* Catch::clara::detail::BasicResult<Catch::clara::detail::ParseResultType>
   ...
   Catch::makeCommandLineParser(Catch::ConfigData&)::$_5>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_5
   const&, std::string const&) */

void __thiscall
Catch::clara::detail::
invokeLambda<std::string,Catch::makeCommandLineParser(Catch::ConfigData&)::__5>
          (detail *this,__5 *param_1,string *param_2)
{
  bool bVar1;
  ...
  if (bVar1) {
    ...
    invoke<Catch::makeCommandLineParser(Catch::ConfigData&)::__5,std::string>
              ((__5 *)local_20,asStack_40);
  }
  else {
