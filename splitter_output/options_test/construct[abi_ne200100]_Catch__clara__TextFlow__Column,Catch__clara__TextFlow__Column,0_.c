...
{
                    /* WARNING: Could not recover jumptable at 0x00010014b2a4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<Catch::clara::TextFlow::Column,Catch::clara::TextFlow::Column,0>_100172228
  )();
  return;
}