...
{
                    /* WARNING: Could not recover jumptable at 0x00010014aec0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)PTR_construct_abi_ne200100_<Catch::MessageInfo,Catch::MessageInfo,0>_100171f90)();
  return;
}