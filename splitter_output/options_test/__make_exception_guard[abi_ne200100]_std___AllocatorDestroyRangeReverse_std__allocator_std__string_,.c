/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<std::string
   >, std::string*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<std::string
   >, std::string*> >(std::_AllocatorDestroyRangeReverse<std::allocator<std::string >,
   std::string*>) */
