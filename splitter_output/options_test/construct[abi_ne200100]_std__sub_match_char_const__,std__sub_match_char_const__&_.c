...
void std::allocator<std::sub_match<char_const*>>::
     construct_abi_ne200100_<std::sub_match<char_const*>,std::sub_match<char_const*>&>
               (sub_match *param_1,sub_match *param_2)
{
                    /* WARNING: Could not recover jumptable at 0x00010014d89c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<std::sub_match<char_const*>,std::sub_match<char_const*>&>_100173b10)
            ();
  return;
}