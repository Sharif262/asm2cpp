...
{
                    /* WARNING: Could not recover jumptable at 0x00010014d8a8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<std::sub_match<char_const*>,std::sub_match<char_const*>>_100173b18)
            ();
  return;
}