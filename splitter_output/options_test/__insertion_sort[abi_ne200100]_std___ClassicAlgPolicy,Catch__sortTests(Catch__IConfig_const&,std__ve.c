...
/* void std::__insertion_sort[abi:ne200100]<std::_ClassicAlgPolicy, Catch::sortTests(Catch::IConfig
               ...
               (pair_conflict *param_1,pair_conflict *param_2,__0 *param_3)
{
  ...
  ppVar3 = param_1;
  if (param_1 != param_2) {
    while (local_38 = ppVar3, local_30 = local_38 + 0x10, local_30 != local_20) {
      uVar1 = Catch::
              sortTests(Catch::IConfig_const&,std::vector<Catch::TestCase,std::allocator<Catch::TestCase>>const&)
              ::$_0::operator()(local_28,local_30,local_38);
      ppVar3 = local_30;
      if ((uVar1 & 1) != 0) {
        puVar2 = (undefined8 *)
