/* std::allocator<cxxopts::values::standard_value<std::string > >
   ...
   std::allocator<cxxopts::values::standard_value<std::string > >
   >::__shared_ptr_emplace[abi:ne200100]<cxxopts::values::standard_value<std::string > const&,
   std::allocator<cxxopts::values::standard_value<std::string > >,
...
__shared_ptr_emplace<cxxopts::values::standard_value<std::string>,std::allocator<cxxopts::values::standard_value<std::string>>>
::
__shared_ptr_emplace_abi_ne200100_<cxxopts::values::standard_value<std::string>const&,std::allocator<cxxopts::values::standard_value<std::string>>,0>
          (__shared_ptr_emplace<cxxopts::values::standard_value<std::string>,std::allocator<cxxopts::values::standard_value<std::string>>>
           *this,standard_value *param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_100178798;
  ...
  construct_abi_ne200100_<cxxopts::values::standard_value<std::string>,cxxopts::values::standard_value<std::string>const&,0>
