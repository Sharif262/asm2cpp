/* std::allocator<std::vector<double, std::allocator<double> > >
   ...
   >::__allocation_guard[abi:ne200100]<std::allocator<std::vector<double, std::allocator<double> > >
   >(unsigned long) */
           ...
           *this,ulong param_1)
{
  ...
  *(ulong *)(this + 8) = param_1;
  uVar1 = allocator_traits<std::allocator<std::__shared_ptr_emplace<std::vector<double,std::allocator<double>>,std::allocator<std::vector<double,std::allocator<double>>>>>>
