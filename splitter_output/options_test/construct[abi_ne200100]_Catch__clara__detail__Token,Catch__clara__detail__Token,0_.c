...
{
                    /* WARNING: Could not recover jumptable at 0x00010014b238. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<Catch::clara::detail::Token,Catch::clara::detail::Token,0>_1001721e0
  )();
  return;
}