...
/* void 
   std::__uninitialized_allocator_relocate[abi:ne200100]<std::allocator<std::sub_match<std::__wrap_iter<char
...
void std::
     __uninitialized_allocator_relocate_abi_ne200100_<std::allocator<std::sub_match<std::__wrap_iter<char_const*>>>,std::sub_match<std::__wrap_iter<char_const*>>*>
               (allocator *param_1,sub_match *param_2,sub_match *param_3,sub_match *param_4)
{
  ...
  __allocator_destroy_abi_ne200100_<std::allocator<std::sub_match<std::__wrap_iter<char_const*>>>,std::sub_match<std::__wrap_iter<char_const*>>*,std::sub_match<std::__wrap_iter<char_const*>>*>
