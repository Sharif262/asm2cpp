...
{
                    /* WARNING: Could not recover jumptable at 0x00010014be74. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<std::sub_match<char_const*>,std::sub_match<char_const*>,0>_100172a08
  )();
  return;
}