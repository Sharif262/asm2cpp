...
/* std::pair<std::__hash_iterator<std::__hash_node<std::__hash_value_type<unsigned long,
   ...
   >::__emplace_unique_key_args<unsigned long, unsigned long&, cxxopts::OptionValue>(unsigned long
   const&, unsigned long&, cxxopts::OptionValue&&) */
...
void std::
     ...
     ::__emplace_unique_key_args<unsigned_long,unsigned_long&,cxxopts::OptionValue>
               (ulong *param_1,ulong *param_2,OptionValue *param_3)
{
                    /* WARNING: Could not recover jumptable at 0x00010014a9f8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR___emplace_unique_key_args<unsigned_long,unsigned_long&,cxxopts::OptionValue>_100171df0)();
  return;
}