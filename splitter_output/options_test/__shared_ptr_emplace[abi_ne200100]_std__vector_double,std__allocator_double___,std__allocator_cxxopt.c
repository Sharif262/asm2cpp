/* std::allocator<cxxopts::values::standard_value<std::vector<double, std::allocator<double> > > >
   ...
   std::allocator<double> > > > >::__shared_ptr_emplace[abi:ne200100]<std::vector<double,
   std::allocator<double> >*, std::allocator<cxxopts::values::standard_value<std::vector<double,
   std::allocator<double> > > >, 0>(std::vector<double, std::allocator<double> >*&&) */
...
__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>,std::allocator<cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>>>
::
__shared_ptr_emplace_abi_ne200100_<std::vector<double,std::allocator<double>>*,std::allocator<cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>>,0>
          (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>,std::allocator<cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>>>
           *this,vector **param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_10017a0d0;
  ...
  ::
  construct_abi_ne200100_<cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>,std::vector<double,std::allocator<double>>*,0>
