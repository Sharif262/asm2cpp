/* Catch::clara::detail::ParserRefImpl<Catch::clara::detail::Opt>::ParserRefImpl<Catch::makeCommandLineParser(Catch::ConfigData&)::$_10>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_10
   const&, std::string const&) */

ParserRefImpl<Catch::clara::detail::Opt> * __thiscall
Catch::clara::detail::ParserRefImpl<Catch::clara::detail::Opt>::
ParserRefImpl<Catch::makeCommandLineParser(Catch::ConfigData&)::__10>
          (ParserRefImpl<Catch::clara::detail::Opt> *this,__10 *param_1,string *param_2)
{
  ...
  *(undefined4 *)(this + 8) = 0;
  ...
  make_shared_abi_ne200100_<Catch::clara::detail::BoundLambda<Catch::makeCommandLineParser(Catch::ConfigData&)::__10>,Catch::makeCommandLineParser(Catch::ConfigData&)::__10_const&,0>
            (local_20);
  __ZNSt3__110shared_ptrIN5Catch5clara6detail8BoundRefEEC1B8ne200100INS3_11BoundLambdaIZNS1_21makeCommandLineParserERNS1_10ConfigDataEE4__10EELi0EEEONS0_IT_EE
            (this + 0x10);
  std::
