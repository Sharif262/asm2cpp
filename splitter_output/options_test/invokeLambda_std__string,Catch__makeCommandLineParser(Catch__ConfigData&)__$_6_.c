/* Catch::clara::detail::BasicResult<Catch::clara::detail::ParseResultType>
   ...
   Catch::makeCommandLineParser(Catch::ConfigData&)::$_6>(Catch::makeCommandLineParser(Catch::ConfigData&)::$_6
   const&, std::string const&) */

void __thiscall
Catch::clara::detail::
invokeLambda<std::string,Catch::makeCommandLineParser(Catch::ConfigData&)::__6>
          (detail *this,__6 *param_1,string *param_2)
{
  bool bVar1;
  ...
  if (bVar1) {
    ...
    invoke<Catch::makeCommandLineParser(Catch::ConfigData&)::__6,std::string>
              ((__6 *)local_20,asStack_40);
  }
  else {
