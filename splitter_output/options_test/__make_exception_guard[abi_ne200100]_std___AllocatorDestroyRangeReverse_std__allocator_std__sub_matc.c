/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<std::sub_match<std::__wrap_iter<char
   const*> > >, std::sub_match<std::__wrap_iter<char const*> >*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<std::sub_match<std::__wrap_iter<char
   const*> > >, std::sub_match<std::__wrap_iter<char const*> >*>
   >(std::_AllocatorDestroyRangeReverse<std::allocator<std::sub_match<std::__wrap_iter<char const*>
