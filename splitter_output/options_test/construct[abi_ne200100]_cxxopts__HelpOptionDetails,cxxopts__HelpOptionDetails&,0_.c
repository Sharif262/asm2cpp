...
{
                    /* WARNING: Could not recover jumptable at 0x00010014b430. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<cxxopts::HelpOptionDetails,cxxopts::HelpOptionDetails&,0>_100172330)
            ();
  return;
}