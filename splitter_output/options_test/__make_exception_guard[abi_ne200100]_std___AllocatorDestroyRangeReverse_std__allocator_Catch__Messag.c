/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::MessageInfo>,
   Catch::MessageInfo*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::MessageInfo>,
   Catch::MessageInfo*> >(std::_AllocatorDestroyRangeReverse<std::allocator<Catch::MessageInfo>,
   Catch::MessageInfo*>) */
