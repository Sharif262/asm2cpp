/* std::allocator<cxxopts::values::standard_value<double> >
   ...
   std::allocator<cxxopts::values::standard_value<double> >
   >::__shared_ptr_emplace[abi:ne200100]<cxxopts::values::standard_value<double> const&,
   std::allocator<cxxopts::values::standard_value<double> >,
   0>(cxxopts::values::standard_value<double> const&) */
           ...
           *this,standard_value *param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_100179be8;
  ...
  construct_abi_ne200100_<cxxopts::values::standard_value<double>,cxxopts::values::standard_value<double>const&,0>
