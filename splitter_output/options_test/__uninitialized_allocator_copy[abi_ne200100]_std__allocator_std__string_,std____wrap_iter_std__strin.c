...
/* std::string* std::__uninitialized_allocator_copy[abi:ne200100]<std::allocator<std::string >,
   ...
   std::string*>(std::allocator<std::string >&, std::__wrap_iter<std::string*>,
   std::__wrap_iter<std::string*>, std::string*) */

string * std::
         __uninitialized_allocator_copy_abi_ne200100_<std::allocator<std::string>,std::__wrap_iter<std::string*>,std::__wrap_iter<std::string*>,std::string*>
                   (allocator *param_1,undefined8 param_2,undefined8 param_3,string *param_4)
{
  string *psVar1;
  undefined1 auVar2 [16];
  
  auVar2 = __unwrap_range_abi_ne200100_<std::__wrap_iter<std::string*>,std::string*>
                     (param_2,param_3);
  psVar1 = (string *)
