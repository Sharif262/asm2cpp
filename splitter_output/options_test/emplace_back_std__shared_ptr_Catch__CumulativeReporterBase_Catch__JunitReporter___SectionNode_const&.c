...
/* void 
   ...
   > 
   >::emplace_back<std::shared_ptr<Catch::CumulativeReporterBase<Catch::JunitReporter>::SectionNode>
...
void std::
     ...
     ::
     emplace_back<std::shared_ptr<Catch::CumulativeReporterBase<Catch::JunitReporter>::SectionNode>const&>
               (shared_ptr *param_1)
{
                    /* WARNING: Could not recover jumptable at 0x00010014cabc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_emplace_back<std::shared_ptr<Catch::CumulativeReporterBase<Catch::JunitReporter>::SectionNode>const&>_1001731f8
  )();
  return;
}