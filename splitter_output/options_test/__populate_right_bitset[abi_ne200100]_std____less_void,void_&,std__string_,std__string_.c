...
/* void std::__populate_right_bitset[abi:ne200100]<std::__less<void, void>&, std::string*,
   std::string >(std::string*, std::__less<void, void>&, std::string&, unsigned long long&) */

void std::__populate_right_bitset_abi_ne200100_<std::__less<void,void>&,std::string*,std::string>
