...
{
                    /* WARNING: Could not recover jumptable at 0x00010014b3b8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<Catch::TestSpec::Filter,Catch::TestSpec::Filter&,0>_1001722e0)();
  return;
}