...
/* std::sub_match<char const*>*
   std::__uninitialized_allocator_copy_impl[abi:ne200100]<std::allocator<std::sub_match<char const*>
...
sub_match *
std::
__uninitialized_allocator_copy_impl_abi_ne200100_<std::allocator<std::sub_match<char_const*>>,std::sub_match<char_const*>*,std::sub_match<char_const*>*,std::sub_match<char_const*>*>
