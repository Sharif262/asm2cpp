/* std::shared_ptr<cxxopts::values::standard_value<std::vector<unsigned int, std::allocator<unsigned
   int> > > > const&
   std::shared_ptr<cxxopts::Value>::shared_ptr[abi:ne200100]<cxxopts::values::standard_value<std::vector<unsigned
   int, std::allocator<unsigned int> > > >(cxxopts::Value*) */

shared_ptr *
std::shared_ptr<cxxopts::Value>::
shared_ptr_abi_ne200100_<cxxopts::values::standard_value<std::vector<unsigned_int,std::allocator<unsigned_int>>>>
          (Value *param_1)
{
  long in_x1;
  undefined8 in_x2;
