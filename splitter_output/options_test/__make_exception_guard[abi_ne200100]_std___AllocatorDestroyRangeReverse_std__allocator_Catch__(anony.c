/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::(anonymous
   namespace)::ColumnInfo>, Catch::(anonymous namespace)::ColumnInfo*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::(anonymous
   namespace)::ColumnInfo>, Catch::(anonymous namespace)::ColumnInfo*>
   >(std::_AllocatorDestroyRangeReverse<std::allocator<Catch::(anonymous namespace)::ColumnInfo>,
