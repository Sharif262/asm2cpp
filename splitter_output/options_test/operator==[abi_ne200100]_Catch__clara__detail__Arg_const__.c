               ...
               (__wrap_iter *param_1,__wrap_iter *param_2)
{
  ...
  lVar1 = __wrap_iter<Catch::clara::detail::Arg_const*>::base_abi_ne200100_
                    ((__wrap_iter<Catch::clara::detail::Arg_const*> *)param_1);
  lVar2 = __wrap_iter<Catch::clara::detail::Arg_const*>::base_abi_ne200100_
                    ((__wrap_iter<Catch::clara::detail::Arg_const*> *)param_2);
  return lVar1 == lVar2;
}