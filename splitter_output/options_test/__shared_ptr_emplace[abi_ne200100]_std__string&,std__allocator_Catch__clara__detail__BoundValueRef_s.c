/* std::allocator<Catch::clara::detail::BoundValueRef<std::string > >
   ...
   std::allocator<Catch::clara::detail::BoundValueRef<std::string > >, 0>(std::string&) */
           ...
           *this,string *param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_100175b70;
  ...
  std::allocator_traits<std::allocator<Catch::clara::detail::BoundValueRef<std::string>>>::
