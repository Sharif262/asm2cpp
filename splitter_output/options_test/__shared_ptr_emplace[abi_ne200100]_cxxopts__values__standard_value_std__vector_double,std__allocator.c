/* std::allocator<cxxopts::values::standard_value<std::vector<double, std::allocator<double> > > >
   ...
   >::__shared_ptr_emplace[abi:ne200100]<cxxopts::values::standard_value<std::vector<double,
   std::allocator<double> > > const&,
   std::allocator<cxxopts::values::standard_value<std::vector<double, std::allocator<double> > > >,
   0>(cxxopts::values::standard_value<std::vector<double, std::allocator<double> > > const&) */
           ...
           *this,standard_value *param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_10017a0d0;
  ...
  ::
  construct_abi_ne200100_<cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>,cxxopts::values::standard_value<std::vector<double,std::allocator<double>>>const&,0>
