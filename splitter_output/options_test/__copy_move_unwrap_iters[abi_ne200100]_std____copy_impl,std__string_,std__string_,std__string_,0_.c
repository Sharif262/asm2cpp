...
/* std::pair<std::string*, std::string*>
   std::__copy_move_unwrap_iters[abi:ne200100]<std::__copy_impl, std::string*, std::string*,
   std::string*, 0>(std::string*, std::string*, std::string*) */

undefined1  [16]
std::
__copy_move_unwrap_iters_abi_ne200100_<std::__copy_impl,std::string*,std::string*,std::string*,0>
          (string *param_1,string *param_2,string *param_3)
{
  ...
  psVar3 = (string *)
           __unwrap_iter_abi_ne200100_<std::string*,std::__unwrap_iter_impl<std::string*,true>,0>
                     (local_38);
  local_58 = __copy_impl::operator()[abi_ne200100_<std::string*,std::string*,std::string*>
