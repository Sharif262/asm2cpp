/* cxxopts::exceptions::invalid_option_syntax::invalid_option_syntax(std::string const&) */

void __thiscall
cxxopts::exceptions::invalid_option_syntax::invalid_option_syntax
          (invalid_option_syntax *this,string *param_1)
{
  ...
  string *local_20;
  invalid_option_syntax *local_18;
  ...
  std::operator+[abi_ne200100_<char,std::char_traits<char>,std::allocator<char>>
            (asStack_50," starts with a - but has incorrect syntax");
  parsing::parsing((parsing *)this,asStack_38);
  std::string::~string(asStack_38);
  std::string::~string(asStack_50);
  std::string::~string(asStack_68);
  std::string::~string(asStack_80);
  *(undefined ***)this = &PTR__invalid_option_syntax_100178940;
  return;
}