...
__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>
::
__shared_ptr_emplace_abi_ne200100_<std::vector<std::string,std::allocator<std::string>>*,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>,0>
          (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::allocator<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>>>
           *this,vector **param_1)
{
  ...
  *(undefined ***)this = &PTR____shared_ptr_emplace_100178e40;
  ...
  ::
  construct_abi_ne200100_<cxxopts::values::standard_value<std::vector<std::string,std::allocator<std::string>>>,std::vector<std::string,std::allocator<std::string>>*,0>
