...
/* std::shared_ptr<std::vector<double, std::allocator<double> > >
   std::allocate_shared[abi:ne200100]<std::vector<double, std::allocator<double> >,
   std::allocator<std::vector<double, std::allocator<double> > >, ,
   0>(std::allocator<std::vector<double, std::allocator<double> > > const&) */
               ...
               (allocator *param_1)
{
  ...
  *p_Var1;
  ...
  __allocation_guard<std::allocator<std::__shared_ptr_emplace<std::vector<double,std::allocator<double>>,std::allocator<std::vector<double,std::allocator<double>>>>>>
  ::__allocation_guard_abi_ne200100_<std::allocator<std::vector<double,std::allocator<double>>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<std::vector<double,std::allocator<double>>,std::allocator<std::vector<double,std::allocator<double>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<std::vector<double,std::allocator<double>>,std::allocator<std::vector<double,std::allocator<double>>>>>>
  ...
  std::shared_ptr<std::vector<double,std::allocator<double>>>::
  __create_with_control_block_abi_ne200100_<std::vector<double,std::allocator<double>>,std::__shared_ptr_emplace<std::vector<double,std::allocator<double>>,std::allocator<std::vector<double,std::allocator<double>>>>>
