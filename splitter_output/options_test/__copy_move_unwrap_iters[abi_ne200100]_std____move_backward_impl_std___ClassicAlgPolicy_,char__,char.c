...
/* std::pair<char**, char**>
   ...
   char**, char**, char**, 0>(char**, char**, char**) */

undefined1  [16]
std::
__copy_move_unwrap_iters_abi_ne200100_<std::__move_backward_impl<std::_ClassicAlgPolicy>,char**,char**,char**,0>
          (char **param_1,char **param_2,char **param_3)
{
  ...
  join_0x00004008_0x00004000_ =
       std::__move_backward_impl<std::_ClassicAlgPolicy>::operator()[abi_ne200100_<char*,char*,0>
