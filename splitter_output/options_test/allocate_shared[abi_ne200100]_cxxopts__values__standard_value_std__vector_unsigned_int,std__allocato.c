...
/* std::shared_ptr<cxxopts::values::standard_value<std::vector<unsigned int, std::allocator<unsigned
   int> > > >
   std::allocate_shared[abi:ne200100]<cxxopts::values::standard_value<std::vector<unsigned int,
   std::allocator<unsigned int> > >,
   std::allocator<cxxopts::values::standard_value<std::vector<unsigned int, std::allocator<unsigned
   int> > > >, cxxopts::values::standard_value<std::vector<unsigned int, std::allocator<unsigned
   int> > > const&, 0>(std::allocator<cxxopts::values::standard_value<std::vector<unsigned int,
   std::allocator<unsigned int> > > > const&, cxxopts::values::standard_value<std::vector<unsigned
               ...
               (allocator *param_1,standard_value *param_2)
{
  ...
  *p_Var1;
  ...
  __allocation_guard_abi_ne200100_<std::allocator<cxxopts::values::standard_value<std::vector<unsigned_int,std::allocator<unsigned_int>>>>>
            (a_Stack_30,1);
  p_Var1 = (__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<unsigned_int,std::allocator<unsigned_int>>>,std::allocator<cxxopts::values::standard_value<std::vector<unsigned_int,std::allocator<unsigned_int>>>>>
            *)__allocation_guard<std::allocator<std::__shared_ptr_emplace<cxxopts::values::standard_value<std::vector<unsigned_int,std::allocator<unsigned_int>>>,std::allocator<cxxopts::values::standard_value<std::vector<unsigned_int,std::allocator<unsigned_int>>>>>>>
