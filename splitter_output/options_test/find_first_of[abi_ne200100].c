/* std::string::find_first_of[abi:ne200100](char const*, unsigned long) const */

void __thiscall std::string::find_first_of_abi_ne200100_(string *this,char *param_1,ulong param_2)
{
  char *pcVar1;
  ulong uVar2;
  ulong uVar3;
