...
/* bool std::regex_match[abi:ne200100]<std::__wrap_iter<char const*>,
...
bool std::
     regex_match_abi_ne200100_<std::__wrap_iter<char_const*>,std::allocator<std::sub_match<std::__wrap_iter<char_const*>>>,char,std::regex_traits<char>>
               (undefined8 param_1,undefined8 param_2,
               match_results<std::__wrap_iter<char_const*>,std::allocator<std::sub_match<std::__wrap_iter<char_const*>>>>
               *param_3,undefined8 param_4,undefined4 param_5)
{
  undefined8 uVar1;
  long lVar2;
  undefined1 local_35;
  ...
  local_35 = regex_search_abi_ne200100_<char_const*,std::allocator<std::sub_match<std::__wrap_iter<char_const*>>>,char,std::regex_traits<char>>
                       (param_1,param_2,param_3,param_4,uVar1);
  if (local_35) {
    lVar2 = match_results<std::__wrap_iter<char_const*>,std::allocator<std::sub_match<std::__wrap_iter<char_const*>>>>
