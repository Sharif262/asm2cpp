/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::clara::detail::Arg>,
   Catch::clara::detail::Arg*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::clara::detail::Arg>,
   Catch::clara::detail::Arg*>
   >(std::_AllocatorDestroyRangeReverse<std::allocator<Catch::clara::detail::Arg>,
   Catch::clara::detail::Arg*>) */
