/* Catch::clara::detail::Opt::Opt<double>(double&, std::string const&) */

Opt * __thiscall Catch::clara::detail::Opt::Opt<double>(Opt *this,double *param_1,string *param_2)
{
  ParserRefImpl<Catch::clara::detail::Opt>::ParserRefImpl<double>
