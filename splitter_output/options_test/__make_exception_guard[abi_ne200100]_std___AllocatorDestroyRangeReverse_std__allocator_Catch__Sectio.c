/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::SectionInfo>,
   Catch::SectionInfo*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::SectionInfo>,
   Catch::SectionInfo*> >(std::_AllocatorDestroyRangeReverse<std::allocator<Catch::SectionInfo>,
   Catch::SectionInfo*>) */
