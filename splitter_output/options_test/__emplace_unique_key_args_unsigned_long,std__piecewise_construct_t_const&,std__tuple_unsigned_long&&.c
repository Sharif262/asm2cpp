...
/* std::pair<std::__hash_iterator<std::__hash_node<std::__hash_value_type<unsigned long,
   cxxopts::OptionValue>, void*>*>, bool> std::__hash_table<std::__hash_value_type<unsigned long,
   ...
   >::__emplace_unique_key_args<unsigned long, std::piecewise_construct_t const&,
   std::tuple<unsigned long&&>, std::tuple<> >(unsigned long const&, std::piecewise_construct_t
   const&, std::tuple<unsigned long&&>&&, std::tuple<>&&) */
...
void std::
     ...
     ::
     __emplace_unique_key_args<unsigned_long,std::piecewise_construct_t_const&,std::tuple<unsigned_long&&>,std::tuple<>>
               (ulong *param_1,piecewise_construct_t *param_2,tuple *param_3,tuple *param_4)
{
                    /* WARNING: Could not recover jumptable at 0x00010014a9e0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR___emplace_unique_key_args<unsigned_long,std::piecewise_construct_t_const&,std::tuple<unsigned_long&&>,std::tuple<>>_100171de0
  )();
  return;
}