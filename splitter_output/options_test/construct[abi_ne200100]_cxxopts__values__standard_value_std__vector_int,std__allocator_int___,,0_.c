...
{
                    /* WARNING: Could not recover jumptable at 0x00010014b520. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<cxxopts::values::standard_value<std::vector<int,std::allocator<int>>>,,0>_1001723d0
  )();
  return;
}