...
{
                    /* WARNING: Could not recover jumptable at 0x00010014b1f0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)
    PTR_construct_abi_ne200100_<Catch::clara::detail::Opt,Catch::clara::detail::Opt,0>_1001721b0)();
  return;
}