/* std::__exception_guard_exceptions<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::SummaryColumn>,
   Catch::SummaryColumn*> >
   std::__make_exception_guard[abi:ne200100]<std::_AllocatorDestroyRangeReverse<std::allocator<Catch::SummaryColumn>,
   Catch::SummaryColumn*> >(std::_AllocatorDestroyRangeReverse<std::allocator<Catch::SummaryColumn>,
   Catch::SummaryColumn*>) */
