...
undefined1  [16]
std::make_pair_abi_ne200100_<std::string*,std::string*>(__decay *param_1,__decay *param_2)
{
  undefined1 local_20 [16];
  
  pair<std::string*,std::string*>::pair_abi_ne200100_<std::string*,std::string*,0>
            ((string **)local_20);
  return local_20;
}