...
No external API keys needed - Codex does everything natively.
...
When generating C++, Codex should follow these rules:
...
Codex: Decompiling test_program with objdump feedback...
